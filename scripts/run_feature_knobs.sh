...
# Feature knob sweep — each needs re-extraction (~5 min each).
# Uses the new tuned hyperparams: lr=0.05, est=250, depth=14, β=1.25.
...
echo "=== BASELINE (new tuned hyperparams) ==="
run "tuned_baseline"
