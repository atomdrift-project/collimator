# Promote PASS — `7e0ee74f747dddf1` on `filetypes/html`

Generated 2026-05-27T07:11:14Z

full-train holds — PR_AUC 0.6154 -> 0.6154, AUC 0.5000 -> 0.5000, Brier 0.2631 -> 0.2631

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.6154)
...
|---|---|---|---|
| key | `7e0ee74f747dddf1` | `b4c757deb4442986` | `3f71b0f71cf00fec` |
| PR AUC | 0.6154 | 0.6154 | 0.6154 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.7619 | 0.7619 | 0.7619 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-html-7e0ee74f747dddf1
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-html-7e0ee74f747dddf1/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-html-7e0ee74f747dddf1
```
