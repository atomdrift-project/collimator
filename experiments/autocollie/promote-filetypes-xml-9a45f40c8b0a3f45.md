# Promote PASS — `9a45f40c8b0a3f45` on `filetypes/xml`

Generated 2026-05-26T20:10:02Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 1.0000 -> 1.0000, Brier 0.0050 -> 0.0056
...
|---|---|---|---|
| key | `9a45f40c8b0a3f45` | `4b6e4065bc202e77` | `3abc2293cf35cf15` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xml-9a45f40c8b0a3f45
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xml-9a45f40c8b0a3f45/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xml-9a45f40c8b0a3f45
```
