# Promote PASS — `510acf10d215547b` on `filetypes/jar`

Generated 2026-08-24T21:23:47Z

full-train holds — PR_AUC 0.9226 -> 0.9331, AUC 0.9664 -> 0.9731, Brier 0.0277 -> 0.0223

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9226)
...
|---|---|---|---|
| key | `510acf10d215547b` | `238e1a72923cc666` | `6ddd1258f99957c1` |
| PR AUC | 0.9226 | 0.9388 | 0.9331 |
| ROC AUC | 0.9664 | 0.9761 | 0.9731 |
| F1 | 0.8273 | 0.9068 | 0.9023 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-jar-510acf10d215547b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-jar-510acf10d215547b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-jar-510acf10d215547b
```
