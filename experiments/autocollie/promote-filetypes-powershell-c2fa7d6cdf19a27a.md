# Promote PASS — `c2fa7d6cdf19a27a` on `filetypes/powershell`

Generated 2026-05-27T01:09:19Z

full-train holds — PR_AUC 0.9986 -> 0.9989, AUC 0.9964 -> 0.9964, Brier 0.0202 -> 0.0160
...
|---|---|---|---|
| key | `c2fa7d6cdf19a27a` | `79b3115e8973aaad` | `8cc1ae7c4c9d8954` |
| PR AUC | 0.9986 | 0.9988 | 0.9989 |
| ROC AUC | 0.9964 | 0.9961 | 0.9964 |
| F1 | 0.9820 | 0.9887 | 0.9860 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-c2fa7d6cdf19a27a
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-c2fa7d6cdf19a27a/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-c2fa7d6cdf19a27a
```
