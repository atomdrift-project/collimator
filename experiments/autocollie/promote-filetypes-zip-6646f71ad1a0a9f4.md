# Promote REJECTED — `6646f71ad1a0a9f4` on `filetypes/zip`

Generated 2026-06-06T09:35:59Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-06-06T09-31-49_20260606T093148-promote-6646f71ad1a0a9f4_azoth-validate.log; tail:   ~ pdf: pre-existing drift, recall 6.50% → 4.25% (+2.25pp; unimpacted by this promote)
...
1 DEPLOYED-TOLERANCE regression(s) (vs currently-deployed bundle /home/t/.local/share/litmus/models/azoth) — THIS IS WHAT BLOCKS THE DEPLOY:
  - zip: L4 hostile ENSEMBLE recall dropped 3.95pp (31.45% → 27.50%; tolerance 1.70pp; deployed 95% CI lower = 30.64%)

1 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - zip: L4 hostile ENSEMBLE recall dropped 13.11pp BELOW LOW-WATER-MARK (40.61% → 27.50%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `6646f71ad1a0a9f4` | `2da2a85f3f3dec17` | `3ba3c786031c5fc2` |
| PR AUC | 0.9998 | 0.9998 | 0.9998 |
| ROC AUC | 0.9980 | 0.9976 | 0.9976 |
| F1 | 0.9868 | 0.9959 | 0.9958 |
