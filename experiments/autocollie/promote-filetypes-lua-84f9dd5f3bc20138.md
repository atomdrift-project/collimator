# Promote PASS — `84f9dd5f3bc20138` on `filetypes/lua`

Generated 2026-05-27T05:21:23Z

full-train holds — PR_AUC 0.5995 -> 0.7463, AUC 0.7772 -> 0.8478, Brier 0.1190 -> 0.1085

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.5995)
...
|---|---|---|---|
| key | `84f9dd5f3bc20138` | `90ec8d1435351d83` | `8ca5dde1e0c719c8` |
| PR AUC | 0.5995 | 0.7644 | 0.7463 |
| ROC AUC | 0.7772 | 0.8913 | 0.8478 |
| F1 | 0.6667 | 0.7500 | 0.7500 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-lua-84f9dd5f3bc20138
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-lua-84f9dd5f3bc20138/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-lua-84f9dd5f3bc20138
```
