# Promote PASS — `ea83775b3e61c4b8` on `filegroups/scripts`

Generated 2026-06-09T11:05:13Z

full-train holds — PR_AUC 0.9962 -> 0.9984, AUC 0.9953 -> 0.9981, Brier 0.0229 -> 0.0167

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9962)
...
|---|---|---|---|
| key | `ea83775b3e61c4b8` | `6ab67c4240b62e99` | `55ffe90c79e20126` |
| PR AUC | 0.9962 | 0.9984 | 0.9984 |
| ROC AUC | 0.9953 | 0.9981 | 0.9981 |
| F1 | 0.9635 | 0.9823 | 0.9825 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-ea83775b3e61c4b8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-ea83775b3e61c4b8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-ea83775b3e61c4b8
```
