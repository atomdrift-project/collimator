# Promote PASS — `57fbdc33d0f8d38f` on `filetypes/java_class`

Generated 2026-06-09T05:14:51Z

full-train holds — PR_AUC 0.9867 -> 0.9905, AUC 0.9969 -> 0.9983, Brier 0.0117 -> 0.0107
...
|---|---|---|---|
| key | `57fbdc33d0f8d38f` | `e38c9d62da9c7d3d` | `45e07b2a42d401c4` |
| PR AUC | 0.9867 | 0.9903 | 0.9905 |
| ROC AUC | 0.9969 | 0.9983 | 0.9983 |
| F1 | 0.9514 | 0.9536 | 0.9545 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-57fbdc33d0f8d38f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-57fbdc33d0f8d38f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-57fbdc33d0f8d38f
```
