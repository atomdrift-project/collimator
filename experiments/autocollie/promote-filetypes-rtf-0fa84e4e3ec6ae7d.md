# Promote PASS — `0fa84e4e3ec6ae7d` on `filetypes/rtf`

Generated 2026-06-27T22:04:58Z

full-train holds — PR_AUC 0.9998 -> 0.9998, AUC 0.9984 -> 0.9983, Brier 0.0199 -> 0.0199
...
|---|---|---|---|
| key | `0fa84e4e3ec6ae7d` | `eeb7aa90f2c3d6c7` | `696929a19c2a4947` |
| PR AUC | 0.9998 | 0.9998 | 0.9998 |
| ROC AUC | 0.9984 | 0.9983 | 0.9983 |
| F1 | 0.9880 | 0.9926 | 0.9926 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-0fa84e4e3ec6ae7d
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-0fa84e4e3ec6ae7d/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-0fa84e4e3ec6ae7d
```
