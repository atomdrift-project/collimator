# Promote REJECTED — `66fc84b789d1887e` on `filetypes/docx`

Generated 2026-05-27T07:53:23Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-05-27T07-50-11_20260527T075001-promote-66fc84b789d1887e_azoth-validate.log; tail:   png: L3 hostile ensemble recall +4.72pp (4.26% → 8.98%)
...
per-route regressions (informational; does not block deploy):
  docx :: filetypes/docx recall@3FP/M dropped 85.23pp (85.23% → 0.00%)
...
1 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - docx: L3 hostile ENSEMBLE recall dropped 22.73pp BELOW LOW-WATER-MARK (71.59% → 48.86%; LWM tolerance 0.90pp)
...
- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9897)
...
|---|---|---|---|
| key | `66fc84b789d1887e` | `de517a8eb14bc864` | `a599de0f94b33709` |
| PR AUC | 0.9897 | 0.9898 | 0.9898 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.9948 | 0.9949 | 0.9949 |
