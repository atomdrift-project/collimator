# Confirm FAIL — aab28811f9e6cfc5 on `filetypes/pe`

Cycle `20260601T205302-confirm-aab28811f9e6cfc5` — 2026-06-01T20:53:02Z
...
COLLIMATOR_EXPERIMENT_TAG=_pe_feat_symbol_vocab_20k_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea pe_feat_symbol_vocab_20k_confirm_seedsearch_3 --route filetypes/pe  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_pe_feat_symbol_vocab_20k_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1573: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-01T20-53-02_20260601T205302-confirm-aab28811f9e6cfc5_pe_feat_symbol_vocab_20k_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `aab28811f9e6cfc5` | `` |
