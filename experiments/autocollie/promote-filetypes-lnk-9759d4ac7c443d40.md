# Promote PASS — `9759d4ac7c443d40` on `filetypes/lnk`

Generated 2026-06-07T20:53:53Z

full-train holds — PR_AUC 0.9957 -> 0.9964, AUC 0.9808 -> 0.9834, Brier 0.1227 -> 0.1209

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9957)
...
|---|---|---|---|
| key | `9759d4ac7c443d40` | `163cee0b3d17d258` | `7db099b4f7d96e0e` |
| PR AUC | 0.9957 | 0.9964 | 0.9964 |
| ROC AUC | 0.9808 | 0.9831 | 0.9834 |
| F1 | 0.9125 | 0.9834 | 0.9834 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-9759d4ac7c443d40
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-9759d4ac7c443d40/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-9759d4ac7c443d40
```
