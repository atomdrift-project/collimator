# Promote PASS — `c932792bc6560836` on `filetypes/zip`

Generated 2026-05-27T01:45:22Z

full-train holds — PR_AUC 0.9999 -> 0.9998, AUC 0.9971 -> 0.9964, Brier 0.0128 -> 0.0115
...
|---|---|---|---|
| key | `c932792bc6560836` | `615bc550ba60ece6` | `ac64cf7278051c0f` |
| PR AUC | 0.9999 | 0.9998 | 0.9998 |
| ROC AUC | 0.9971 | 0.9959 | 0.9964 |
| F1 | 0.9945 | 0.9954 | 0.9961 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zip-c932792bc6560836
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zip-c932792bc6560836/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zip-c932792bc6560836
```
