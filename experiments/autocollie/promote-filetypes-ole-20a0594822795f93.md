# Promote PASS — `20a0594822795f93` on `filetypes/ole`

Generated 2026-06-28T12:27:04Z

full-train holds — PR_AUC 0.9964 -> 0.9968, AUC 0.9890 -> 0.9897, Brier 0.0446 -> 0.0452
...
|---|---|---|---|
| key | `20a0594822795f93` | `e2fab9071eeade7f` | `0575f4af6f688ea6` |
| PR AUC | 0.9964 | 0.9967 | 0.9968 |
| ROC AUC | 0.9890 | 0.9896 | 0.9897 |
| F1 | 0.9683 | 0.9646 | 0.9666 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-ole-20a0594822795f93
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-ole-20a0594822795f93/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-ole-20a0594822795f93
```
