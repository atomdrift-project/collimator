# Promote PASS — `4c2db4fb55b74289` on `filegroups/config`

Generated 2026-06-17T18:33:48Z

full-train holds — PR_AUC 0.9986 -> 0.9988, AUC 0.9980 -> 0.9983, Brier 0.0080 -> 0.0077
...
|---|---|---|---|
| key | `4c2db4fb55b74289` | `4b5fef256d1f0f76` | `c16ad18c01443ea0` |
| PR AUC | 0.9986 | 0.9988 | 0.9988 |
| ROC AUC | 0.9980 | 0.9985 | 0.9983 |
| F1 | 0.9907 | 0.9919 | 0.9919 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-4c2db4fb55b74289
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-4c2db4fb55b74289/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-4c2db4fb55b74289
```
