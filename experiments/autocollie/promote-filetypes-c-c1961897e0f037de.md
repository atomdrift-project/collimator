# Promote PASS — `c1961897e0f037de` on `filetypes/c`

Generated 2026-07-06T06:08:56Z

full-train holds — PR_AUC 0.9749 -> 0.9764, AUC 0.9914 -> 0.9920, Brier 0.0174 -> 0.0164

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9749)
...
|---|---|---|---|
| key | `c1961897e0f037de` | `c427b1bdaaa8148b` | `6ed7a895ce1687af` |
| PR AUC | 0.9749 | 0.9765 | 0.9764 |
| ROC AUC | 0.9914 | 0.9924 | 0.9920 |
| F1 | 0.9259 | 0.9286 | 0.9270 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-c1961897e0f037de
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-c1961897e0f037de/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-c1961897e0f037de
```
