# Promote PASS — `df39e602555e3bcc` on `filetypes/package.json`

Generated 2026-06-08T02:48:20Z

full-train holds — PR_AUC 0.9987 -> 0.9988, AUC 0.9978 -> 0.9981, Brier 0.0060 -> 0.0059
...
|---|---|---|---|
| key | `df39e602555e3bcc` | `e29c91690210e257` | `d1a1f125c4627fd4` |
| PR AUC | 0.9987 | 0.9989 | 0.9988 |
| ROC AUC | 0.9978 | 0.9983 | 0.9981 |
| F1 | 0.9938 | 0.9949 | 0.9947 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-df39e602555e3bcc
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-df39e602555e3bcc/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-df39e602555e3bcc
```
