# Promote PASS — `ac66725093527fbe` on `filetypes/xml`

Generated 2026-05-26T19:58:35Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 1.0000 -> 1.0000, Brier 0.0056 -> 0.0061
...
|---|---|---|---|
| key | `ac66725093527fbe` | `2da9d3370047ca4d` | `7176d58498862a99` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xml-ac66725093527fbe
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xml-ac66725093527fbe/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xml-ac66725093527fbe
```
