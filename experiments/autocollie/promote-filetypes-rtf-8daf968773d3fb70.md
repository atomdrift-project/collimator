# Promote REJECTED — `8daf968773d3fb70` on `filetypes/rtf`

Generated 2026-05-27T07:18:11Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-05-27T07-14-53_20260527T071445-promote-8daf968773d3fb70_azoth-validate.log; tail:   png: L3 hostile ensemble recall +4.72pp (4.26% → 8.98%)
...
- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9784)
...
|---|---|---|---|
| key | `8daf968773d3fb70` | `99c4f0b9554f2fa9` | `8daf968773d3fb70` |
| PR AUC | 0.9784 | 0.9784 | 0.9784 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.9891 | 0.9891 | 0.9891 |
