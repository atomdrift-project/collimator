# Promote PASS — `ce5daf311bf0b09a` on `filetypes/powershell`

Generated 2026-07-15T19:23:38Z

full-train holds — PR_AUC 0.9985 -> 0.9987, AUC 0.9947 -> 0.9950, Brier 0.0253 -> 0.0246
...
|---|---|---|---|
| key | `ce5daf311bf0b09a` | `10f8821394ee0f9d` | `3a6a4cbcd207121e` |
| PR AUC | 0.9985 | 0.9987 | 0.9987 |
| ROC AUC | 0.9947 | 0.9951 | 0.9950 |
| F1 | 0.9821 | 0.9858 | 0.9858 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-ce5daf311bf0b09a
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-ce5daf311bf0b09a/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-ce5daf311bf0b09a
```
