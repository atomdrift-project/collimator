# Promote PASS — `d1cc8e3a6f587b40` on `filetypes/gz`

Generated 2026-06-14T03:27:57Z

full-train holds — PR_AUC 0.7117 -> 0.7304, AUC 0.8765 -> 0.9008, Brier 0.0211 -> 0.0185

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.7117)
...
|---|---|---|---|
| key | `d1cc8e3a6f587b40` | `ac2c0ec77c8bc740` | `d3825d675b7fa91b` |
| PR AUC | 0.7117 | 0.7314 | 0.7304 |
| ROC AUC | 0.8765 | 0.9000 | 0.9008 |
| F1 | 0.7881 | 0.7749 | 0.7772 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-gz-d1cc8e3a6f587b40
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-gz-d1cc8e3a6f587b40/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-gz-d1cc8e3a6f587b40
```
