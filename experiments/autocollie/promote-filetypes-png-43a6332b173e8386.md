# Promote PASS — `43a6332b173e8386` on `filetypes/png`

Generated 2026-05-27T00:44:25Z

full-train holds — PR_AUC 0.9853 -> 0.9919, AUC 0.9728 -> 0.9863, Brier 0.0531 -> 0.0447

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9853)
...
|---|---|---|---|
| key | `43a6332b173e8386` | `bd7f3415403591c7` | `757e7d39bcae8e3c` |
| PR AUC | 0.9853 | 0.9901 | 0.9919 |
| ROC AUC | 0.9728 | 0.9832 | 0.9863 |
| F1 | 0.8814 | 0.9028 | 0.9220 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-png-43a6332b173e8386
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-png-43a6332b173e8386/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-png-43a6332b173e8386
```
