# Promote PASS — `284d75b298227636` on `filetypes/go`

Generated 2026-07-06T03:55:16Z

full-train holds — PR_AUC 0.9546 -> 0.9535, AUC 0.9770 -> 0.9769, Brier 0.0335 -> 0.0342

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9546)
...
|---|---|---|---|
| key | `284d75b298227636` | `4e2d6be5868f3c30` | `baae696d8633d1c8` |
| PR AUC | 0.9546 | 0.9526 | 0.9535 |
| ROC AUC | 0.9770 | 0.9765 | 0.9769 |
| F1 | 0.8808 | 0.8853 | 0.8892 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-284d75b298227636
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-284d75b298227636/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-284d75b298227636
```
