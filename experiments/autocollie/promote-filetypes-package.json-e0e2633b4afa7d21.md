# Promote PASS — `e0e2633b4afa7d21` on `filetypes/package.json`

Generated 2026-05-26T17:22:09Z

full-train holds — PR_AUC 0.9996 -> 0.9999, AUC 0.9991 -> 0.9997, Brier 0.0049 -> 0.0043
...
|---|---|---|---|
| key | `e0e2633b4afa7d21` | `5ed8e12ca3a0ceb6` | `f6ec1fbb067bab67` |
| PR AUC | 0.9996 | 0.9998 | 0.9999 |
| ROC AUC | 0.9991 | 0.9995 | 0.9997 |
| F1 | 0.9960 | 0.9854 | 0.9827 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-e0e2633b4afa7d21
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-e0e2633b4afa7d21/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-e0e2633b4afa7d21
```
