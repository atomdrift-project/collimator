# Promote PASS — `a9138b83a6eb3968` on `filetypes/package.json`

Generated 2026-07-23T06:19:04Z

full-train holds — PR_AUC 0.9982 -> 0.9980, AUC 0.9984 -> 0.9981, Brier 0.0057 -> 0.0054
...
|---|---|---|---|
| key | `a9138b83a6eb3968` | `8b37986a14f80ede` | `2f5ec04b2248de2c` |
| PR AUC | 0.9982 | 0.9981 | 0.9980 |
| ROC AUC | 0.9984 | 0.9982 | 0.9981 |
| F1 | 0.9913 | 0.9919 | 0.9921 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-a9138b83a6eb3968
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-a9138b83a6eb3968/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-a9138b83a6eb3968
```
