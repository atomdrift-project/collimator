# Confirm FAIL — 6a3094941f9958c7 on `filegroups/source`

Cycle `20260805T114332-confirm-6a3094941f9958c7` — 2026-08-05T11:43:32Z
...
COLLIMATOR_EXPERIMENT_TAG=_source_tiered_trigrams_lowfreq_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea source_tiered_trigrams_lowfreq_confirm_seedsearch_3 --route filegroups/source  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_source_tiered_trigrams_lowfreq_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1913: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-08-05T11-43-32_20260805T114332-confirm-6a3094941f9958c7_source_tiered_trigrams_lowfreq_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `6a3094941f9958c7` | `` |
| PR AUC | 0.9990 | 0.0000 |
| ROC AUC | 0.9982 | 0.0000 |
| Recall@3FPM | — | 0.0000 |
| verdict | — | FAIL |
