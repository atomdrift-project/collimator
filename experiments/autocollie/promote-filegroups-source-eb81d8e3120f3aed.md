# Promote PASS — `eb81d8e3120f3aed` on `filegroups/source`

Generated 2026-07-11T15:36:18Z

full-train holds — PR_AUC 0.9932 -> 0.9952, AUC 0.9953 -> 0.9968, Brier 0.0168 -> 0.0150

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9932)
...
|---|---|---|---|
| key | `eb81d8e3120f3aed` | `5afe1610f4deb4c2` | `f43634fdaf93b85f` |
| PR AUC | 0.9932 | 0.9952 | 0.9952 |
| ROC AUC | 0.9953 | 0.9967 | 0.9968 |
| F1 | 0.9663 | 0.9719 | 0.9711 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-source-eb81d8e3120f3aed
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-source-eb81d8e3120f3aed/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-source-eb81d8e3120f3aed
```
