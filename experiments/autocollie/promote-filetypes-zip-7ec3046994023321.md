# Promote PASS — `7ec3046994023321` on `filetypes/zip`

Generated 2026-07-15T12:42:54Z

full-train holds — PR_AUC 0.9987 -> 0.9989, AUC 0.9944 -> 0.9954, Brier 0.0336 -> 0.0231
...
|---|---|---|---|
| key | `7ec3046994023321` | `5a289bc4eddc7e4c` | `d382e418915834da` |
| PR AUC | 0.9987 | 0.9990 | 0.9989 |
| ROC AUC | 0.9944 | 0.9954 | 0.9954 |
| F1 | 0.9727 | 0.9862 | 0.9863 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zip-7ec3046994023321
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zip-7ec3046994023321/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zip-7ec3046994023321
```
