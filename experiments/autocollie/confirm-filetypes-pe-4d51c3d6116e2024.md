# Confirm FAIL — 4d51c3d6116e2024 on `filetypes/pe`

Cycle `20260601T205303-confirm-4d51c3d6116e2024` — 2026-06-01T20:53:03Z
...
COLLIMATOR_EXPERIMENT_TAG=_pe_seed_search_kv_ensemble_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea pe_seed_search_kv_ensemble_confirm_seedsearch_3 --route filetypes/pe  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_pe_seed_search_kv_ensemble_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1573: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-01T20-53-03_20260601T205303-confirm-4d51c3d6116e2024_pe_seed_search_kv_ensemble_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `4d51c3d6116e2024` | `` |
