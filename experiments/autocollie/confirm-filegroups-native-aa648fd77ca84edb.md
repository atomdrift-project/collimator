# Confirm FAIL — aa648fd77ca84edb on `filegroups/native`

Cycle `20260704T125046-confirm-aa648fd77ca84edb` — 2026-07-04T12:50:46Z
...
COLLIMATOR_EXPERIMENT_TAG=_native_kv_vocab_15k_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea native_kv_vocab_15k_confirm_seedsearch_3 --route filegroups/native  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_native_kv_vocab_15k_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1890: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-07-04T12-50-46_20260704T125046-confirm-aa648fd77ca84edb_native_kv_vocab_15k_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `aa648fd77ca84edb` | `` |
