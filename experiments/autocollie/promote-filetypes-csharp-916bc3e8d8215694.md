# Promote PASS — `916bc3e8d8215694` on `filetypes/csharp`

Generated 2026-05-27T00:37:30Z

full-train holds — PR_AUC 0.9869 -> 0.9856, AUC 0.9927 -> 0.9919, Brier 0.0261 -> 0.0287
...
|---|---|---|---|
| key | `916bc3e8d8215694` | `a9da60b80efd5bfa` | `b3ba108beca3108d` |
| PR AUC | 0.9869 | 0.9842 | 0.9856 |
| ROC AUC | 0.9927 | 0.9909 | 0.9919 |
| F1 | 0.9565 | 0.9437 | 0.9032 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-csharp-916bc3e8d8215694
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-csharp-916bc3e8d8215694/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-csharp-916bc3e8d8215694
```
