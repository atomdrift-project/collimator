# Promote PASS — `fb254c34f1cd2196` on `filegroups/source`

Generated 2026-05-14T18:19:24Z

full-train holds — PR_AUC 0.9983 -> 0.9983, AUC 0.9981 -> 0.9981, Brier 0.0165 -> 0.0163
...
|---|---|---|---|
| key | `fb254c34f1cd2196` | `55b2baf7a6e21f45` | `8e0b851996f106e5` |
| PR AUC | 0.9983 | 0.9983 | 0.9983 |
| ROC AUC | 0.9981 | 0.9981 | 0.9981 |
| F1 | 0.9709 | 0.9696 | 0.9694 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-source-fb254c34f1cd2196
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-source-fb254c34f1cd2196/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-source-fb254c34f1cd2196
```
