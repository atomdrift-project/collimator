# Promote REJECTED — `73fd859820a3b145` on `filetypes/javascript`

Generated 2026-06-06T09:40:01Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-06-06T09-36-01_20260606T093600-promote-73fd859820a3b145_azoth-validate.log; tail:   ~ pdf: pre-existing drift, recall 6.50% → 4.25% (+2.25pp; unimpacted by this promote)
...
1 DEPLOYED-TOLERANCE regression(s) (vs currently-deployed bundle /home/t/.local/share/litmus/models/azoth) — THIS IS WHAT BLOCKS THE DEPLOY:
  - javascript: L4 hostile ENSEMBLE recall dropped 4.57pp (59.50% → 54.93%; tolerance 1.70pp; deployed 95% CI lower = 58.69%)

1 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - javascript: L4 hostile ENSEMBLE recall dropped 11.27pp BELOW LOW-WATER-MARK (66.20% → 54.93%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `73fd859820a3b145` | `10e83ddef817a732` | `3d4985277dc36205` |
| PR AUC | 0.9979 | 0.9994 | 0.9994 |
| ROC AUC | 0.9975 | 0.9991 | 0.9991 |
| F1 | 0.9785 | 0.9894 | 0.9894 |
