# Promote PASS — `d7bed08b3d1f8027` on `filetypes/jar`

Generated 2026-07-23T07:21:09Z

full-train holds — PR_AUC 0.9821 -> 0.9869, AUC 0.9827 -> 0.9871, Brier 0.0535 -> 0.0420

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9821)
...
|---|---|---|---|
| key | `d7bed08b3d1f8027` | `93e6bc1a1b7c8a51` | `be3062532120b11e` |
| PR AUC | 0.9821 | 0.9868 | 0.9869 |
| ROC AUC | 0.9827 | 0.9871 | 0.9871 |
| F1 | 0.9135 | 0.9341 | 0.9392 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-jar-d7bed08b3d1f8027
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-jar-d7bed08b3d1f8027/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-jar-d7bed08b3d1f8027
```
