# Promote PASS — `01daf7467ad32755` on `filetypes/gz`

Generated 2026-06-14T23:39:10Z

full-train holds — PR_AUC 0.7119 -> 0.7254, AUC 0.8869 -> 0.8975, Brier 0.0208 -> 0.0187

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.7119)
...
|---|---|---|---|
| key | `01daf7467ad32755` | `027d0ab6cfa7c998` | `31e11cc657d0978f` |
| PR AUC | 0.7119 | 0.7262 | 0.7254 |
| ROC AUC | 0.8869 | 0.8963 | 0.8975 |
| F1 | 0.7899 | 0.8004 | 0.8004 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-gz-01daf7467ad32755
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-gz-01daf7467ad32755/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-gz-01daf7467ad32755
```
