# Promote PASS — `fb99432f9a4e7a6d` on `filegroups/portable`

Generated 2026-07-06T07:43:02Z

full-train holds — PR_AUC 0.9909 -> 0.9933, AUC 0.9978 -> 0.9984, Brier 0.0103 -> 0.0092
...
|---|---|---|---|
| key | `fb99432f9a4e7a6d` | `7412f27e7dec6e7d` | `b5b547e4a0b7994f` |
| PR AUC | 0.9909 | 0.9933 | 0.9933 |
| ROC AUC | 0.9978 | 0.9983 | 0.9984 |
| F1 | 0.9586 | 0.9624 | 0.9598 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-portable-fb99432f9a4e7a6d
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-portable-fb99432f9a4e7a6d/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-portable-fb99432f9a4e7a6d
```
