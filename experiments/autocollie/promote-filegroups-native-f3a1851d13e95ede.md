# Promote REJECTED — `f3a1851d13e95ede` on `filegroups/native`

Generated 2026-06-06T09:18:17Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-06-06T08-59-16_20260606T084342-promote-f3a1851d13e95ede_azoth-validate.log; tail:   ~ perl: pre-existing drift, recall 69.44% → 83.33% (+13.89pp; unimpacted by this promote)
...
19 low-water-mark improvement(s) (>0.90pp above LWM, informational):
  ...
  + elf: L4 hostile ensemble recall +1.09pp above LWM (92.79% → 93.87%)
...
1 DEPLOYED-TOLERANCE regression(s) (vs currently-deployed bundle /home/t/.local/share/litmus/models/azoth) — THIS IS WHAT BLOCKS THE DEPLOY:
  - elf: L4 hostile ENSEMBLE recall dropped 2.06pp (95.93% → 93.87%; tolerance 1.70pp; deployed 95% CI lower = 95.66%)
...
2 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  ...
  - pe: L4 hostile ENSEMBLE recall dropped 10.22pp BELOW LOW-WATER-MARK (61.96% → 51.74%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `f3a1851d13e95ede` | `77b3ce874439a303` | `de1309253ee7fd98` |
| PR AUC | 0.9994 | 1.0000 | 0.9999 |
| ROC AUC | 0.9994 | 0.9999 | 0.9999 |
| F1 | 0.9905 | 0.9982 | 0.9961 |
