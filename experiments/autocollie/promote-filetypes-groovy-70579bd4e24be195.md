# Promote PASS — `70579bd4e24be195` on `filetypes/groovy`

Generated 2026-05-27T08:07:47Z
...
|---|---|---|---|
| key | `70579bd4e24be195` | `d1fe4a6e7b08cbdc` | `9dc4ff319c7c4897` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-groovy-70579bd4e24be195
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-groovy-70579bd4e24be195/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-groovy-70579bd4e24be195
```
