# Promote PASS — `b5ebf65854cd925c` on `filetypes/ole`

Generated 2026-06-08T09:41:38Z

full-train holds — PR_AUC 0.9966 -> 0.9973, AUC 0.9960 -> 0.9966, Brier 0.0946 -> 0.0945
...
|---|---|---|---|
| key | `b5ebf65854cd925c` | `926c8b9ba18a5cfb` | `4cf1225dac1e35e1` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-ole-b5ebf65854cd925c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-ole-b5ebf65854cd925c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-ole-b5ebf65854cd925c
```
