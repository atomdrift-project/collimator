# Promote PASS — `b1f044b82d2d24c4` on `filetypes/applescript`

Generated 2026-05-27T07:00:45Z

full-train holds — PR_AUC 0.4000 -> 0.4000, AUC 0.5000 -> 0.5000, Brier 0.2544 -> 0.2596

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.4000)
...
|---|---|---|---|
| key | `b1f044b82d2d24c4` | `b341e065daa37e61` | `bb83a7669d2df3ed` |
| PR AUC | 0.4000 | 0.4000 | 0.4000 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.5714 | 0.5714 | 0.5714 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-applescript-b1f044b82d2d24c4
```
...
EXP_FORMAT_HINTS=0
EXP_HARD_NEGATIVE_FRACTION=0.1
EXP_HARD_NEGATIVE_WEIGHT=15
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-applescript-b1f044b82d2d24c4/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-applescript-b1f044b82d2d24c4
```
