# Promote PASS — `820d80f1d82d2ebe` on `filetypes/c`

Generated 2026-06-01T15:12:28Z

full-train holds — PR_AUC 0.9889 -> 0.9862, AUC 0.9940 -> 0.9932, Brier 0.0272 -> 0.0275

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9889)
...
|---|---|---|---|
| key | `820d80f1d82d2ebe` | `00231550e86045cc` | `ad404d6a076bb615` |
| PR AUC | 0.9889 | 0.9853 | 0.9862 |
| ROC AUC | 0.9940 | 0.9926 | 0.9932 |
| F1 | 0.9449 | 0.9343 | 0.9252 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-820d80f1d82d2ebe
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-820d80f1d82d2ebe/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-820d80f1d82d2ebe
```
