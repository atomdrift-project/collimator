# Promote PASS — `251fdd0d7838f8f8` on `filetypes/powershell`

Generated 2026-06-13T01:49:49Z

full-train holds — PR_AUC 0.9989 -> 0.9989, AUC 0.9941 -> 0.9941, Brier 0.0280 -> 0.0271
...
|---|---|---|---|
| key | `251fdd0d7838f8f8` | `ca4dd96a61988b79` | `e837bf95fccbfc4d` |
| PR AUC | 0.9989 | 0.9990 | 0.9989 |
| ROC AUC | 0.9941 | 0.9943 | 0.9941 |
| F1 | 0.9766 | 0.9889 | 0.9889 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-251fdd0d7838f8f8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-251fdd0d7838f8f8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-251fdd0d7838f8f8
```
