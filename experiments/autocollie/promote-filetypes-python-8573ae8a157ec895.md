# Promote PASS — `8573ae8a157ec895` on `filetypes/python`

Generated 2026-05-27T00:22:40Z
...
|---|---|---|---|
| key | `8573ae8a157ec895` | `29d0654bad01c49d` | `168bf921df8f2b7b` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-8573ae8a157ec895
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-8573ae8a157ec895/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-8573ae8a157ec895
```
