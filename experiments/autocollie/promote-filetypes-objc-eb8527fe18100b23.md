# Promote PASS — `eb8527fe18100b23` on `filetypes/objc`

Generated 2026-05-08T09:32:35Z

full-train holds — F1 0.6667 -> 0.6667, AUC 0.5000 -> 0.5000, recall@FP=0 0.0000 -> 0.0000

## Gates

- **Confirm** (different seed, original profile): **PASS** — F1 held across 3 seeds (orig 0.6667)
...
|---|---|---|---|
| key | `eb8527fe18100b23` | `bc3f462eb34e9e15` | `d2694e83300496e8` |
| F1 | 0.6667 | 0.6667 | 0.6667 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| AP | — | — | — |
| recall@3 FP/M (screen) | 0.0000 | 0.0000 | 0.0000 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-objc-eb8527fe18100b23
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-objc-eb8527fe18100b23/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the validated bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-objc-eb8527fe18100b23
```
