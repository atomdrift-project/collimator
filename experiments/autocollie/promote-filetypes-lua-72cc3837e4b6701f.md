# Promote PASS — `72cc3837e4b6701f` on `filetypes/lua`

Generated 2026-05-27T05:28:30Z

full-train holds — PR_AUC 0.5741 -> 0.7500, AUC 0.7065 -> 0.8641, Brier 0.1169 -> 0.1121

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.5741)
...
|---|---|---|---|
| key | `72cc3837e4b6701f` | `1f02ca3220e6802b` | `d80fb2368d85a990` |
| PR AUC | 0.5741 | 0.7589 | 0.7500 |
| ROC AUC | 0.7065 | 0.8859 | 0.8641 |
| F1 | 0.4000 | 0.7500 | 0.7500 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-lua-72cc3837e4b6701f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-lua-72cc3837e4b6701f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-lua-72cc3837e4b6701f
```
