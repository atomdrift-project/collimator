# Promote PASS — `0eb378f5b044e890` on `filetypes/python`

Generated 2026-07-23T10:25:04Z

full-train holds — PR_AUC 0.9737 -> 0.9798, AUC 0.9884 -> 0.9912, Brier 0.0286 -> 0.0237

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9737)
...
|---|---|---|---|
| key | `0eb378f5b044e890` | `8c343dcfe2fbba70` | `327393377691a482` |
| PR AUC | 0.9737 | 0.9796 | 0.9798 |
| ROC AUC | 0.9884 | 0.9911 | 0.9912 |
| F1 | 0.9085 | 0.9288 | 0.9267 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-0eb378f5b044e890
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-0eb378f5b044e890/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-0eb378f5b044e890
```
