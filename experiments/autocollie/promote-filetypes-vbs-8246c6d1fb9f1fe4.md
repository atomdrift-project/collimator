# Promote PASS — `8246c6d1fb9f1fe4` on `filetypes/vbs`

Generated 2026-06-09T04:54:20Z

full-train holds — PR_AUC 0.9968 -> 0.9975, AUC 0.9887 -> 0.9916, Brier 0.0630 -> 0.0624
...
|---|---|---|---|
| key | `8246c6d1fb9f1fe4` | `beef86f69a70a488` | `466c4d1671f10f4e` |
| PR AUC | 0.9968 | 0.9975 | 0.9975 |
| ROC AUC | 0.9887 | 0.9916 | 0.9916 |
| F1 | 0.9548 | 0.9676 | 0.9652 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-8246c6d1fb9f1fe4
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-8246c6d1fb9f1fe4/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-8246c6d1fb9f1fe4
```
