# Promote PASS — `3c7437d2f296c568` on `filetypes/ole`

Generated 2026-06-09T05:18:24Z

full-train holds — PR_AUC 0.9969 -> 0.9971, AUC 0.9963 -> 0.9964, Brier 0.0992 -> 0.0982
...
|---|---|---|---|
| key | `3c7437d2f296c568` | `b45dbb9068c8d12d` | `640b39d12d2e5166` |
| PR AUC | 0.9969 | 0.9972 | 0.9971 |
| ROC AUC | 0.9963 | 0.9965 | 0.9964 |
| F1 | 0.8967 | 0.9806 | 0.9811 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3c7437d2f296c568
```
...
EXP_FORMAT_HINTS=0
EXP_HARD_NEGATIVE_FRACTION=0.015
EXP_HARD_NEGATIVE_WEIGHT=16
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3c7437d2f296c568/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3c7437d2f296c568
```
