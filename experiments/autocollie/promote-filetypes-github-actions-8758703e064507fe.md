# Promote PASS — `8758703e064507fe` on `filetypes/github-actions`

Generated 2026-05-27T06:04:02Z

full-train holds — PR_AUC 0.0089 -> 0.0273, AUC 0.5000 -> 0.5000, Brier 0.0089 -> 0.0270

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.0089)
...
|---|---|---|---|
| key | `8758703e064507fe` | `31e586b2f7cb3444` | `e73f6ccae6bb4255` |
| PR AUC | 0.0089 | 0.0273 | 0.0273 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.0177 | 0.0531 | 0.0531 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-github-actions-8758703e064507fe
```
...
EXP_DISABLE_FEATURE_GROUPS=score,clusters,kv,symbols,textenc
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-github-actions-8758703e064507fe/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-github-actions-8758703e064507fe
```
