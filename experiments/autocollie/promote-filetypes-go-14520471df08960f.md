# Promote PASS — `14520471df08960f` on `filetypes/go`

Generated 2026-07-10T23:22:42Z

full-train holds — PR_AUC 0.9479 -> 0.9497, AUC 0.9727 -> 0.9739, Brier 0.0343 -> 0.0342

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9479)
...
|---|---|---|---|
| key | `14520471df08960f` | `0ab1b381c2e94476` | `8735c0c1b94b1f92` |
| PR AUC | 0.9479 | 0.9510 | 0.9497 |
| ROC AUC | 0.9727 | 0.9749 | 0.9739 |
| F1 | 0.8824 | 0.8933 | 0.8915 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-14520471df08960f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-14520471df08960f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-14520471df08960f
```
