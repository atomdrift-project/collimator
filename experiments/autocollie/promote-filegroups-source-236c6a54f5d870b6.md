# Promote REJECTED — `236c6a54f5d870b6` on `filegroups/source`

Generated 2026-06-06T09:43:25Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-06-06T09-40-03_20260606T094002-promote-236c6a54f5d870b6_azoth-validate.log; tail:   ~ ole: pre-existing drift, recall 82.17% → 50.88% (+31.29pp; unimpacted by this promote)
...
19 low-water-mark improvement(s) (>0.90pp above LWM, informational):
  ...
  + go: L4 hostile ensemble recall +4.03pp above LWM (1.78% → 5.82%)
...
2 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - c: L4 hostile ENSEMBLE recall dropped 3.95pp BELOW LOW-WATER-MARK (10.31% → 6.36%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `236c6a54f5d870b6` | `e4fad6b170282450` | `105da46c6608d8d0` |
| PR AUC | 0.9987 | 0.9988 | 0.9988 |
| ROC AUC | 0.9982 | 0.9984 | 0.9983 |
| F1 | 0.9753 | 0.9820 | 0.9815 |
