# Promote PASS — `65ceec6b9d7d24b5` on `filetypes/package.json`

Generated 2026-05-25T19:37:33Z

full-train holds — PR_AUC 0.9998 -> 0.9999, AUC 0.9997 -> 0.9998, Brier 0.0039 -> 0.0039
...
|---|---|---|---|
| key | `65ceec6b9d7d24b5` | `1fa83793f517d4a6` | `e9e05ca350d49742` |
| PR AUC | 0.9998 | 0.9998 | 0.9999 |
| ROC AUC | 0.9997 | 0.9997 | 0.9998 |
| F1 | 0.9951 | 0.9958 | 0.9969 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-65ceec6b9d7d24b5
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-65ceec6b9d7d24b5/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-65ceec6b9d7d24b5
```
