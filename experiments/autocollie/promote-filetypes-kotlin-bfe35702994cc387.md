# Promote PASS — `bfe35702994cc387` on `filetypes/kotlin`

Generated 2026-07-04T15:38:55Z

full-train holds — PR_AUC 0.9773 -> 0.9790, AUC 0.9835 -> 0.9866, Brier 0.1489 -> 0.1300

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9773)
...
|---|---|---|---|
| key | `bfe35702994cc387` | `15b5f8b4b1b9a6a3` | `62d84c75ac328324` |
| PR AUC | 0.9773 | 0.9800 | 0.9790 |
| ROC AUC | 0.9835 | 0.9874 | 0.9866 |
| F1 | 0.7463 | 0.9421 | 0.9233 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-bfe35702994cc387
```
...
EXP_FORMAT_HINTS=0
EXP_HARD_NEGATIVE_FRACTION=0.01
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-bfe35702994cc387/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-bfe35702994cc387
```
