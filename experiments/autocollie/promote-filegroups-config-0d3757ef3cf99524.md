# Promote PASS — `0d3757ef3cf99524` on `filegroups/config`

Generated 2026-06-28T15:45:40Z

full-train holds — PR_AUC 0.9985 -> 0.9983, AUC 0.9984 -> 0.9985, Brier 0.0083 -> 0.0079
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-0d3757ef3cf99524
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-0d3757ef3cf99524/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-0d3757ef3cf99524
```
