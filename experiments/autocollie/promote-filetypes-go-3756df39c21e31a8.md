# Promote PASS — `3756df39c21e31a8` on `filetypes/go`

Generated 2026-06-02T01:03:01Z

full-train holds — PR_AUC 0.9613 -> 0.9649, AUC 0.9867 -> 0.9900, Brier 0.0382 -> 0.0329

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9613)
...
|---|---|---|---|
| key | `3756df39c21e31a8` | `ae3076975fd524b4` | `6703cf3c80590eb4` |
| PR AUC | 0.9613 | 0.9631 | 0.9649 |
| ROC AUC | 0.9867 | 0.9895 | 0.9900 |
| F1 | 0.9011 | 0.8744 | 0.9067 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-3756df39c21e31a8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-3756df39c21e31a8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-3756df39c21e31a8
```
