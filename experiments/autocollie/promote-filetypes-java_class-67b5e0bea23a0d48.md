# Promote PASS — `67b5e0bea23a0d48` on `filetypes/java_class`

Generated 2026-06-06T14:20:08Z

full-train holds — PR_AUC 0.9955 -> 0.9913, AUC 0.9992 -> 0.9984, Brier 0.0079 -> 0.0103
...
|---|---|---|---|
| key | `67b5e0bea23a0d48` | `de4122ac6c7f75f1` | `16564ca6b0a74321` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-67b5e0bea23a0d48
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-67b5e0bea23a0d48/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-67b5e0bea23a0d48
```
