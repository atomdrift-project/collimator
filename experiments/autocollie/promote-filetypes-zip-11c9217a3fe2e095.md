# Promote PASS — `11c9217a3fe2e095` on `filetypes/zip`

Generated 2026-07-13T07:09:29Z

full-train holds — PR_AUC 0.9986 -> 0.9990, AUC 0.9940 -> 0.9955, Brier 0.0354 -> 0.0229
...
|---|---|---|---|
| key | `11c9217a3fe2e095` | `c002171d54e0623d` | `2323a3d08aeb9981` |
| PR AUC | 0.9986 | 0.9990 | 0.9990 |
| ROC AUC | 0.9940 | 0.9955 | 0.9955 |
| F1 | 0.9741 | 0.9865 | 0.9867 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zip-11c9217a3fe2e095
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zip-11c9217a3fe2e095/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zip-11c9217a3fe2e095
```
