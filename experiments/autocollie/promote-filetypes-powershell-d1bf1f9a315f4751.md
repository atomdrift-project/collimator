# Promote PASS — `d1bf1f9a315f4751` on `filetypes/powershell`

Generated 2026-05-21T07:36:44Z

full-train holds — PR_AUC 0.9984 -> 0.9985, AUC 0.9961 -> 0.9962, Brier 0.0215 -> 0.0213
...
|---|---|---|---|
| key | `d1bf1f9a315f4751` | `d5c1a7e22148e488` | `47713a7fa1ffebaa` |
| PR AUC | 0.9984 | 0.9978 | 0.9985 |
| ROC AUC | 0.9961 | 0.9948 | 0.9962 |
| F1 | 0.9802 | 0.9841 | 0.9802 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-d1bf1f9a315f4751
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-d1bf1f9a315f4751/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-d1bf1f9a315f4751
```
