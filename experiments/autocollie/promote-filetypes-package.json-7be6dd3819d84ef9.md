# Promote PASS — `7be6dd3819d84ef9` on `filetypes/package.json`

Generated 2026-05-08T23:35:35Z

full-train holds — F1 0.9987 -> 0.9981, AUC 0.9999 -> 0.9999, recall@3FPM 0.9562 -> 0.9637, recall@FP=0 0.0000 -> 0.0000, Brier 0.0023 -> 0.0021

## Gates

- **Confirm** (different seed, original profile): **PASS** — F1 held across 3 seeds (orig 0.9987)
...
|---|---|---|---|
| key | `7be6dd3819d84ef9` | `ca4c6ec658d9b572` | `b084b76a839a4c28` |
| F1 | 0.9987 | 0.9987 | 0.9981 |
| ROC AUC | 0.9999 | 0.9999 | 0.9999 |
| AP | — | — | — |
| recall@3 FP/M (screen) | 0.9562 | 0.9594 | 0.9637 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-7be6dd3819d84ef9
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-7be6dd3819d84ef9/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the validated bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-7be6dd3819d84ef9
```
