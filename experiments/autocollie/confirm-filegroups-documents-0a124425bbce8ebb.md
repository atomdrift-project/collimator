# Confirm FAIL — 0a124425bbce8ebb on `filegroups/documents`

Cycle `20260601T163710-confirm-0a124425bbce8ebb` — 2026-06-01T16:37:10Z
...
COLLIMATOR_EXPERIMENT_TAG=_docs_seed_ensemble_text_kv_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea docs_seed_ensemble_text_kv_confirm_seedsearch_3 --route filegroups/documents  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_docs_seed_ensemble_text_kv_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1573: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-01T16-37-10_20260601T163710-confirm-0a124425bbce8ebb_docs_seed_ensemble_text_kv_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `0a124425bbce8ebb` | `` |
