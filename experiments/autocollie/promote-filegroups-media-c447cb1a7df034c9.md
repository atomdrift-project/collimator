# Promote PASS — `c447cb1a7df034c9` on `filegroups/media`

Generated 2026-05-27T00:49:12Z

full-train holds — PR_AUC 0.9952 -> 0.9947, AUC 0.9942 -> 0.9935, Brier 0.0330 -> 0.0390
...
|---|---|---|---|
| key | `c447cb1a7df034c9` | `07126685e449636f` | `34a1fc4c56489659` |
| PR AUC | 0.9952 | 0.9959 | 0.9947 |
| ROC AUC | 0.9942 | 0.9949 | 0.9935 |
| F1 | 0.9540 | 0.9474 | 0.9474 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-media-c447cb1a7df034c9
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-media-c447cb1a7df034c9/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-media-c447cb1a7df034c9
```
