# Promote PASS — `c32b84c607a73447` on `filetypes/python-bytecode`

Generated 2026-07-11T00:37:41Z

full-train holds — PR_AUC 0.9947 -> 0.9948, AUC 0.9974 -> 0.9979, Brier 0.0066 -> 0.0060
...
|---|---|---|---|
| key | `c32b84c607a73447` | `48e87694ffbd64bf` | `ba324750bc537897` |
| PR AUC | 0.9947 | 0.9945 | 0.9948 |
| ROC AUC | 0.9974 | 0.9978 | 0.9979 |
| F1 | 0.0000 | 0.9859 | 0.9828 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-bytecode-c32b84c607a73447
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-bytecode-c32b84c607a73447/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-bytecode-c32b84c607a73447
```
