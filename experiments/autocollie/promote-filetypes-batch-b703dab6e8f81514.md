# Promote PASS — `b703dab6e8f81514` on `filetypes/batch`

Generated 2026-07-10T20:26:27Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 0.9988 -> 0.9988, Brier 0.0139 -> 0.0131
...
|---|---|---|---|
| key | `b703dab6e8f81514` | `5806cfcb59cdcc89` | `977bd993a7de2a7b` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 0.9988 | 0.9988 | 0.9988 |
| F1 | 0.9971 | 0.9972 | 0.9976 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-batch-b703dab6e8f81514
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-batch-b703dab6e8f81514/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-batch-b703dab6e8f81514
```
