# Promote PASS — `e3f2443bce3318a1` on `filetypes/pe`

Generated 2026-06-08T15:10:27Z

full-train holds — PR_AUC 0.9984 -> 0.9998, AUC 0.9986 -> 0.9997, Brier 0.0102 -> 0.0051
...
|---|---|---|---|
| key | `e3f2443bce3318a1` | `c704af735aa64eae` | `04dccdafac436ba1` |
| PR AUC | 0.9984 | 1.0000 | 0.9998 |
| ROC AUC | 0.9986 | 0.9997 | 0.9997 |
| F1 | 0.9858 | 0.9974 | 0.9950 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pe-e3f2443bce3318a1
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pe-e3f2443bce3318a1/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pe-e3f2443bce3318a1
```
