# Promote REJECTED — `ead91cb9bdd4368a` on `filegroups/documents`

Generated 2026-05-26T22:24:23Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-05-26T22-21-02_20260526T222041-promote-ead91cb9bdd4368a_azoth-validate.log; tail: .venv/bin/python scripts/write_azoth_readmes.py --azoth-root /home/t/collimator/out/models/azoth-candidate-filegroups-documents-ead91cb9bdd4368a
staged runtime azoth bundle: /tmp/tmp.2WT65kIP5B
azoth bundle ok: /tmp/tmp.2WT65kIP5B
--source-bundle out/models/azoth: 1 routes changed → 9 filetypes impacted, 57 unimpacted (drift treated as pre-existing)

ensemble improvements (≥0.10pp):
  docx: L3 hostile ensemble recall +2.27pp (71.59% → 73.86%)
...
per-route improvements (≥0.10pp, informational):
  ...
  ole :: filegroups/documents recall@3FP/M +6.06pp (91.70% → 97.77%)
  pdf :: filegroups/documents recall@3FP/M +67.50pp (8.41% → 75.91%)
  rtf :: filegroups/documents recall@3FP/M +0.47pp (96.74% → 97.21%)
...
18 low-water-mark improvement(s) (>0.90pp above LWM, informational):
  ...
  + docx: L3 hostile ensemble recall +2.27pp above LWM (71.59% → 73.86%)
  ...
  + pdf: L3 hostile ensemble recall +1.11pp above LWM (6.41% → 7.52%)
...
|---|---|---|---|
| key | `ead91cb9bdd4368a` | `38c350e24642cc6f` | `f7d872facc3b0730` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 0.9991 | 0.9997 | 0.9997 |
| F1 | 0.9982 | 0.9979 | 0.9979 |
