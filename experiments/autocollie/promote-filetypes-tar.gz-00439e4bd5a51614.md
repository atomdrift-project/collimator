# Promote PASS — `00439e4bd5a51614` on `filetypes/tar.gz`

Generated 2026-05-27T02:20:59Z

full-train holds — PR_AUC 0.9994 -> 0.9994, AUC 0.9988 -> 0.9988, Brier 0.0095 -> 0.0083
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-tar.gz-00439e4bd5a51614
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-tar.gz-00439e4bd5a51614/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-tar.gz-00439e4bd5a51614
```
