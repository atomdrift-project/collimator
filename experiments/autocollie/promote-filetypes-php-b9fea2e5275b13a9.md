# Promote PASS — `b9fea2e5275b13a9` on `filetypes/php`

Generated 2026-07-13T04:58:17Z

full-train holds — PR_AUC 0.9842 -> 0.9846, AUC 0.9957 -> 0.9959, Brier 0.0094 -> 0.0094

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9842)
...
|---|---|---|---|
| key | `b9fea2e5275b13a9` | `87ed664c77561c6b` | `04b71df829ab34c9` |
| PR AUC | 0.9842 | 0.9850 | 0.9846 |
| ROC AUC | 0.9957 | 0.9960 | 0.9959 |
| F1 | 0.9510 | 0.9524 | 0.9537 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-php-b9fea2e5275b13a9
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-php-b9fea2e5275b13a9/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-php-b9fea2e5275b13a9
```
