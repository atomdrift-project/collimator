# Promote PASS — `bbfdac417f933592` on `filetypes/objc`

Generated 2026-05-27T05:43:11Z
...
|---|---|---|---|
| key | `bbfdac417f933592` | `b8c11404f19fc7e6` | `e549d0c7a4b23076` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-objc-bbfdac417f933592
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-objc-bbfdac417f933592/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-objc-bbfdac417f933592
```
