# Promote PASS — `3785a492b14aa82e` on `filetypes/zst`

Generated 2026-05-25T19:50:36Z
...
|---|---|---|---|
| key | `3785a492b14aa82e` | `a40cd2094632acf8` | `24e9d1abdd136ea5` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zst-3785a492b14aa82e
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zst-3785a492b14aa82e/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zst-3785a492b14aa82e
```
