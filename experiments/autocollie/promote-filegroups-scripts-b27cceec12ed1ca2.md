# Promote PASS — `b27cceec12ed1ca2` on `filegroups/scripts`

Generated 2026-07-11T13:18:02Z

full-train holds — PR_AUC 0.9923 -> 0.9955, AUC 0.9906 -> 0.9961, Brier 0.0339 -> 0.0213
...
|---|---|---|---|
| key | `b27cceec12ed1ca2` | `069918e7594954c7` | `5810edbe7740d4ec` |
| PR AUC | 0.9923 | 0.9951 | 0.9955 |
| ROC AUC | 0.9906 | 0.9961 | 0.9961 |
| F1 | 0.9544 | 0.9681 | 0.9698 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-b27cceec12ed1ca2
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-b27cceec12ed1ca2/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-b27cceec12ed1ca2
```
