# Promote PASS — `cc774fe31cf482ee` on `filetypes/csharp`

Generated 2026-06-16T10:00:54Z

full-train holds — PR_AUC 0.9841 -> 0.9891, AUC 0.9910 -> 0.9939, Brier 0.0320 -> 0.0306

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9841)
...
|---|---|---|---|
| key | `cc774fe31cf482ee` | `b13a91b40b09ecf4` | `d96304b416eb7441` |
| PR AUC | 0.9841 | 0.9911 | 0.9891 |
| ROC AUC | 0.9910 | 0.9948 | 0.9939 |
| F1 | 0.9224 | 0.9655 | 0.9623 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-csharp-cc774fe31cf482ee
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-csharp-cc774fe31cf482ee/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-csharp-cc774fe31cf482ee
```
