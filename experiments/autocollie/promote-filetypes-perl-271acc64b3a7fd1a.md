# Promote PASS — `271acc64b3a7fd1a` on `filetypes/perl`

Generated 2026-05-25T19:54:54Z

full-train holds — PR_AUC 1.0000 -> 0.9959, AUC 1.0000 -> 0.9996, Brier 0.0083 -> 0.0075
...
|---|---|---|---|
| key | `271acc64b3a7fd1a` | `e16b518d59c52227` | `0e549622f944ad2e` |
| PR AUC | 1.0000 | 0.9978 | 0.9959 |
| ROC AUC | 1.0000 | 0.9998 | 0.9996 |
| F1 | 0.8947 | 0.9767 | 0.9545 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-perl-271acc64b3a7fd1a
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-perl-271acc64b3a7fd1a/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-perl-271acc64b3a7fd1a
```
