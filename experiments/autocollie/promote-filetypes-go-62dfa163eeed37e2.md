# Promote PASS — `62dfa163eeed37e2` on `filetypes/go`

Generated 2026-06-16T09:54:37Z

full-train holds — PR_AUC 0.9404 -> 0.9417, AUC 0.9872 -> 0.9874, Brier 0.0313 -> 0.0303

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9404)
...
|---|---|---|---|
| key | `62dfa163eeed37e2` | `6c24c776d26e937d` | `165a7cb2663b9225` |
| PR AUC | 0.9404 | 0.9410 | 0.9417 |
| ROC AUC | 0.9872 | 0.9868 | 0.9874 |
| F1 | 0.8377 | 0.8713 | 0.8613 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-62dfa163eeed37e2
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-62dfa163eeed37e2/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-62dfa163eeed37e2
```
