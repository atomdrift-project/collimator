# Promote PASS — `8d38ee455fc8f155` on `filetypes/go`

Generated 2026-05-26T07:58:51Z

full-train holds — PR_AUC 0.9588 -> 0.9679, AUC 0.9858 -> 0.9894, Brier 0.0437 -> 0.0367

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9588)
...
|---|---|---|---|
| key | `8d38ee455fc8f155` | `f5c8d9f1bc9ecbae` | `2afe620dd93abe79` |
| PR AUC | 0.9588 | 0.9678 | 0.9679 |
| ROC AUC | 0.9858 | 0.9893 | 0.9894 |
| F1 | 0.8851 | 0.8973 | 0.9066 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-8d38ee455fc8f155
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-8d38ee455fc8f155/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-8d38ee455fc8f155
```
