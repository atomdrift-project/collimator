# Promote PASS — `777c99e1705ab45b` on `filetypes/crx`

Generated 2026-07-02T23:56:20Z

full-train holds — PR_AUC 0.9966 -> 0.9960, AUC 0.9966 -> 0.9962, Brier 0.0246 -> 0.0258
...
|---|---|---|---|
| key | `777c99e1705ab45b` | `263aacfba8ef4813` | `0382ae055d82f8d0` |
| PR AUC | 0.9966 | 0.9954 | 0.9960 |
| ROC AUC | 0.9966 | 0.9956 | 0.9962 |
| F1 | 0.9091 | 0.9518 | 0.9634 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-crx-777c99e1705ab45b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-crx-777c99e1705ab45b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-crx-777c99e1705ab45b
```
