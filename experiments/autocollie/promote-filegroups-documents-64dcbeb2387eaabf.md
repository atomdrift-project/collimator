# Promote PASS — `64dcbeb2387eaabf` on `filegroups/documents`

Generated 2026-07-23T09:01:30Z

full-train holds — PR_AUC 0.9999 -> 1.0000, AUC 0.9991 -> 0.9991, Brier 0.0100 -> 0.0079
...
|---|---|---|---|
| key | `64dcbeb2387eaabf` | `30ee12637364b16c` | `0c175abee2e9bc5a` |
| PR AUC | 0.9999 | 1.0000 | 1.0000 |
| ROC AUC | 0.9991 | 0.9991 | 0.9991 |
| F1 | 0.9931 | 0.9977 | 0.9976 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-documents-64dcbeb2387eaabf
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-documents-64dcbeb2387eaabf/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-documents-64dcbeb2387eaabf
```
