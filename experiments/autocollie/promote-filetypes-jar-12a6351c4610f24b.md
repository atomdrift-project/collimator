# Promote PASS — `12a6351c4610f24b` on `filetypes/jar`

Generated 2026-06-28T02:24:06Z

full-train holds — PR_AUC 0.9832 -> 0.9876, AUC 0.9712 -> 0.9795, Brier 0.0711 -> 0.0679

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9832)
...
|---|---|---|---|
| key | `12a6351c4610f24b` | `1466a314914264a0` | `c868e96a69868a42` |
| PR AUC | 0.9832 | 0.9849 | 0.9876 |
| ROC AUC | 0.9712 | 0.9743 | 0.9795 |
| F1 | 0.9284 | 0.9274 | 0.9362 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-jar-12a6351c4610f24b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-jar-12a6351c4610f24b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-jar-12a6351c4610f24b
```
