# Confirm FAIL — f456740ccb2f2b53 on `filetypes/gz`

Cycle `20260628T140541-confirm-f456740ccb2f2b53` — 2026-06-28T14:05:41Z
...
COLLIMATOR_EXPERIMENT_TAG=_gz_textmetrics_kv_vocab_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea gz_textmetrics_kv_vocab_confirm_seedsearch_3 --route filetypes/gz  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_gz_textmetrics_kv_vocab_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1890: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-28T14-05-41_20260628T140541-confirm-f456740ccb2f2b53_gz_textmetrics_kv_vocab_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `f456740ccb2f2b53` | `` |
| PR AUC | 0.7218 | 0.0000 |
| ROC AUC | 0.8913 | 0.0000 |
| Recall@3FPM | — | 0.0000 |
| verdict | — | FAIL |
