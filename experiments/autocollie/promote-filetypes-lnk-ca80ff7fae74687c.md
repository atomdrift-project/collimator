# Promote PASS — `ca80ff7fae74687c` on `filetypes/lnk`

Generated 2026-06-08T08:18:52Z

full-train holds — PR_AUC 0.9961 -> 0.9965, AUC 0.9824 -> 0.9836, Brier 0.1234 -> 0.1224
...
|---|---|---|---|
| key | `ca80ff7fae74687c` | `3a190741c1bf45a8` | `7e994d368abd65df` |
| PR AUC | 0.9961 | 0.9962 | 0.9965 |
| ROC AUC | 0.9824 | 0.9829 | 0.9836 |
| F1 | 0.9094 | 0.9809 | 0.9825 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-ca80ff7fae74687c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-ca80ff7fae74687c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-ca80ff7fae74687c
```
