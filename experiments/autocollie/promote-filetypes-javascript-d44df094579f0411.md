# Promote PASS — `d44df094579f0411` on `filetypes/javascript`

Generated 2026-07-11T16:48:16Z

full-train holds — PR_AUC 0.9950 -> 0.9965, AUC 0.9941 -> 0.9971, Brier 0.0273 -> 0.0171

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9950)
...
|---|---|---|---|
| key | `d44df094579f0411` | `fbcf8096f3cfeee0` | `6fcc74c6825a2bff` |
| PR AUC | 0.9950 | 0.9965 | 0.9965 |
| ROC AUC | 0.9941 | 0.9971 | 0.9971 |
| F1 | 0.9654 | 0.9739 | 0.9751 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-d44df094579f0411
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-d44df094579f0411/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-d44df094579f0411
```
