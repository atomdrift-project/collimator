# Promote PASS — `292544d0153a5132` on `filegroups/native`

Generated 2026-07-11T08:28:49Z

full-train holds — PR_AUC 0.9991 -> 0.9998, AUC 0.9991 -> 0.9999, Brier 0.0091 -> 0.0040
...
|---|---|---|---|
| key | `292544d0153a5132` | `375a408f33abd4f4` | `168eccf4d8bce36f` |
| PR AUC | 0.9991 | 1.0000 | 0.9998 |
| ROC AUC | 0.9991 | 0.9999 | 0.9999 |
| F1 | 0.9891 | 0.9977 | 0.9954 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-native-292544d0153a5132
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-native-292544d0153a5132/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-native-292544d0153a5132
```
