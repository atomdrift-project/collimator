# Promote PASS — `b82c5799fe251638` on `filetypes/tar`

Generated 2026-05-26T21:37:23Z

full-train holds — PR_AUC 1.0000 -> 0.9999, AUC 1.0000 -> 0.9993, Brier 0.0565 -> 0.0572
...
|---|---|---|---|
| key | `b82c5799fe251638` | `5587649d2d4e2904` | `71eda74ac06a7596` |
| PR AUC | 1.0000 | 0.9999 | 0.9999 |
| ROC AUC | 1.0000 | 0.9993 | 0.9993 |
| F1 | 1.0000 | 0.9934 | 0.9934 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-tar-b82c5799fe251638
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-tar-b82c5799fe251638/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-tar-b82c5799fe251638
```
