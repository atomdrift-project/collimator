# Promote PASS — `9fb752d78a1de0b9` on `filegroups/config`

Generated 2026-07-15T10:34:30Z

full-train holds — PR_AUC 0.9976 -> 0.9981, AUC 0.9979 -> 0.9985, Brier 0.0068 -> 0.0061
...
|---|---|---|---|
| key | `9fb752d78a1de0b9` | `374fc231e3db9bad` | `46ff0d1aba5cabfb` |
| PR AUC | 0.9976 | 0.9981 | 0.9981 |
| ROC AUC | 0.9979 | 0.9985 | 0.9985 |
| F1 | 0.9890 | 0.9908 | 0.9910 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-9fb752d78a1de0b9
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-9fb752d78a1de0b9/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-9fb752d78a1de0b9
```
