# Promote PASS — `0e3f60c275a946e9` on `filetypes/shell`

Generated 2026-05-28T12:44:58Z

full-train holds — PR_AUC 0.9962 -> 0.9968, AUC 0.9975 -> 0.9979, Brier 0.0188 -> 0.0173
...
|---|---|---|---|
| key | `0e3f60c275a946e9` | `9ae91121fcc0438e` | `7a39ffa546c7ec0c` |
| PR AUC | 0.9962 | 0.9968 | 0.9968 |
| ROC AUC | 0.9975 | 0.9979 | 0.9979 |
| F1 | 0.9614 | 0.9634 | 0.9618 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-shell-0e3f60c275a946e9
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-shell-0e3f60c275a946e9/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-shell-0e3f60c275a946e9
```
