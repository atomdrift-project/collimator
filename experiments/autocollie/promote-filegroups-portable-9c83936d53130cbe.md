# Promote PASS — `9c83936d53130cbe` on `filegroups/portable`

Generated 2026-05-25T21:20:46Z
...
|---|---|---|---|
| key | `9c83936d53130cbe` | `a24e8feacfcf1609` | `d21546fee050fd05` |
| PR AUC | 0.9967 | 0.9962 | 0.9962 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-portable-9c83936d53130cbe
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-portable-9c83936d53130cbe/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-portable-9c83936d53130cbe
```
