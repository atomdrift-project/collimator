# Promote PASS — `46ec55278912862b` on `filegroups/config`

Generated 2026-06-09T05:45:02Z

full-train holds — PR_AUC 0.9987 -> 0.9988, AUC 0.9982 -> 0.9983, Brier 0.0071 -> 0.0068
...
|---|---|---|---|
| key | `46ec55278912862b` | `e632aa2f77843031` | `f233d4b1bb863e03` |
| PR AUC | 0.9987 | 0.9988 | 0.9988 |
| ROC AUC | 0.9982 | 0.9984 | 0.9983 |
| F1 | 0.9929 | 0.9938 | 0.9938 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-46ec55278912862b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-46ec55278912862b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-46ec55278912862b
```
