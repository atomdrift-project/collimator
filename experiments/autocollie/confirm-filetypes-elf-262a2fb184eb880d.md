# Confirm FAIL — 262a2fb184eb880d on `filetypes/elf`

Cycle `20260607T031042-confirm-262a2fb184eb880d` — 2026-06-07T03:10:42Z
...
COLLIMATOR_SYMBOL_TRIGRAMS=1 \
COLLIMATOR_SYMBOL_TRIGRAM_MAX=5000 \
...
COLLIMATOR_EXPERIMENT_TAG=_elf_trigram_seed_avg_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea elf_trigram_seed_avg_confirm_seedsearch_3 --route filetypes/elf  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_elf_trigram_seed_avg_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1839: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-07T03-10-42_20260607T031042-confirm-262a2fb184eb880d_elf_trigram_seed_avg_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `262a2fb184eb880d` | `` |
