# Promote PASS — `53bd56856c78331d` on `filetypes/zip`

Generated 2026-06-06T16:06:49Z

full-train holds — PR_AUC 0.9997 -> 0.9996, AUC 0.9961 -> 0.9963, Brier 0.0149 -> 0.0113
...
|---|---|---|---|
| key | `53bd56856c78331d` | `95f25403ec7b41cb` | `8704eb93e633836e` |
| PR AUC | 0.9997 | 0.9996 | 0.9996 |
| ROC AUC | 0.9961 | 0.9960 | 0.9963 |
| F1 | 0.9935 | 0.9924 | 0.9929 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zip-53bd56856c78331d
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zip-53bd56856c78331d/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zip-53bd56856c78331d
```
