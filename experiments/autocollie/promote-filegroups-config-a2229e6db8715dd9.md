# Promote PASS — `a2229e6db8715dd9` on `filegroups/config`

Generated 2026-05-08T15:13:28Z

full-train holds — F1 0.9971 -> 0.9965, AUC 0.9996 -> 0.9997, recall@FP=0 0.0000 -> 0.0000

## Gates

- **Confirm** (different seed, original profile): **PASS** — F1 held across 3 seeds (orig 0.9971)
...
|---|---|---|---|
| key | `a2229e6db8715dd9` | `3a5594a92a207e20` | `b434cb54d5896afb` |
| F1 | 0.9971 | 0.9968 | 0.9965 |
| ROC AUC | 0.9996 | 0.9996 | 0.9997 |
| AP | — | — | — |
| recall@3 FP/M (screen) | 0.9065 | 0.8358 | 0.8959 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-a2229e6db8715dd9
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-a2229e6db8715dd9/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the validated bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-a2229e6db8715dd9
```
