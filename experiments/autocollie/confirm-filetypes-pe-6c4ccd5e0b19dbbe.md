# Confirm FAIL — 6c4ccd5e0b19dbbe on `filetypes/pe`

Cycle `20260606T144246-confirm-6c4ccd5e0b19dbbe` — 2026-06-06T14:42:46Z
...
COLLIMATOR_EXPERIMENT_TAG=_pe_transfer_lowbigram_hardneg_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea pe_transfer_lowbigram_hardneg_confirm_seedsearch_3 --route filetypes/pe  \
	...
	--beta 2 --threshold-mode fbeta \
	 \
	--hard-negative-fraction 0.05 --hard-negative-weight 10 \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_pe_transfer_lowbigram_hardneg_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1826: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-06T14-42-46_20260606T144246-confirm-6c4ccd5e0b19dbbe_pe_transfer_lowbigram_hardneg_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `6c4ccd5e0b19dbbe` | `` |
