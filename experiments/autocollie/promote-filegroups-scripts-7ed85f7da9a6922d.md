# Promote PASS — `7ed85f7da9a6922d` on `filegroups/scripts`

Generated 2026-07-13T08:52:18Z

full-train holds — PR_AUC 0.9935 -> 0.9955, AUC 0.9921 -> 0.9961, Brier 0.0307 -> 0.0211
...
|---|---|---|---|
| key | `7ed85f7da9a6922d` | `66497eec6ab1115d` | `3e662f0483da49d6` |
| PR AUC | 0.9935 | 0.9951 | 0.9955 |
| ROC AUC | 0.9921 | 0.9961 | 0.9961 |
| F1 | 0.9603 | 0.9691 | 0.9695 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-7ed85f7da9a6922d
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-7ed85f7da9a6922d/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-scripts-7ed85f7da9a6922d
```
