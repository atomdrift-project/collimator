# Promote PASS — `c8957a8822499c7c` on `filegroups/media`

Generated 2026-05-14T19:16:48Z

full-train holds — PR_AUC 0.9946 -> 0.9946, AUC 0.9935 -> 0.9937, Brier 0.0354 -> 0.0368
...
|---|---|---|---|
| key | `c8957a8822499c7c` | `e311ec319fad3dfa` | `d53d736ad0774763` |
| PR AUC | 0.9946 | 0.9939 | 0.9946 |
| ROC AUC | 0.9935 | 0.9929 | 0.9937 |
| F1 | 0.9419 | 0.9560 | 0.9560 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-media-c8957a8822499c7c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-media-c8957a8822499c7c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-media-c8957a8822499c7c
```
