# Promote PASS — `0054fd216f8f4c02` on `filegroups/portable`

Generated 2026-07-11T19:12:17Z

full-train holds — PR_AUC 0.9924 -> 0.9937, AUC 0.9981 -> 0.9982, Brier 0.0090 -> 0.0085

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9924)
...
|---|---|---|---|
| key | `0054fd216f8f4c02` | `3d770df032fac4b6` | `acb9a4ed67e927de` |
| PR AUC | 0.9924 | 0.9935 | 0.9937 |
| ROC AUC | 0.9981 | 0.9982 | 0.9982 |
| F1 | 0.9601 | 0.9653 | 0.9680 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-portable-0054fd216f8f4c02
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-portable-0054fd216f8f4c02/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-portable-0054fd216f8f4c02
```
