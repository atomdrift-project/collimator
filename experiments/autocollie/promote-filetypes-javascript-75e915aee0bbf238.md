# Promote PASS — `75e915aee0bbf238` on `filetypes/javascript`

Generated 2026-06-13T02:23:17Z

full-train holds — PR_AUC 0.9968 -> 0.9988, AUC 0.9961 -> 0.9983, Brier 0.0217 -> 0.0165
...
|---|---|---|---|
| key | `75e915aee0bbf238` | `44716a7fb30adba4` | `fb6c95c8dcf59c8b` |
| PR AUC | 0.9968 | 0.9988 | 0.9988 |
| ROC AUC | 0.9961 | 0.9983 | 0.9983 |
| F1 | 0.9654 | 0.9826 | 0.9832 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-75e915aee0bbf238
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-75e915aee0bbf238/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-75e915aee0bbf238
```
