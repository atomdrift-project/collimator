# Promote PASS — `3aadf463e8d350b6` on `filetypes/rtf`

Generated 2026-06-09T05:40:40Z

full-train holds — PR_AUC 0.9996 -> 0.9997, AUC 0.9969 -> 0.9978, Brier 0.0204 -> 0.0204
...
|---|---|---|---|
| key | `3aadf463e8d350b6` | `12e00a09a0b1f7cd` | `c1fef64e0b6a0b8c` |
| PR AUC | 0.9996 | 0.9998 | 0.9997 |
| ROC AUC | 0.9969 | 0.9984 | 0.9978 |
| F1 | 0.9880 | 0.9909 | 0.9928 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-3aadf463e8d350b6
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-3aadf463e8d350b6/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-3aadf463e8d350b6
```
