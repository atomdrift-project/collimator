# Promote PASS — `c1c7df3b75d52010` on `filetypes/c`

Generated 2026-06-14T02:17:11Z

full-train holds — PR_AUC 0.9862 -> 0.9844, AUC 0.9939 -> 0.9930, Brier 0.0243 -> 0.0225
...
|---|---|---|---|
| key | `c1c7df3b75d52010` | `fc2368a04386633a` | `cebbf46b0eb9d816` |
| PR AUC | 0.9862 | 0.9847 | 0.9844 |
| ROC AUC | 0.9939 | 0.9932 | 0.9930 |
| F1 | 0.9437 | 0.9468 | 0.9419 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-c1c7df3b75d52010
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-c1c7df3b75d52010/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-c1c7df3b75d52010
```
