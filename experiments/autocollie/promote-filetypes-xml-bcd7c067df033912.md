# Promote PASS — `bcd7c067df033912` on `filetypes/xml`

Generated 2026-05-25T20:04:12Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 1.0000 -> 1.0000, Brier 0.0044 -> 0.0028
...
|---|---|---|---|
| key | `bcd7c067df033912` | `4a19b793967cb797` | `cd9fc069bb08e67f` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xml-bcd7c067df033912
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xml-bcd7c067df033912/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xml-bcd7c067df033912
```
