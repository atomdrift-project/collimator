# Promote PASS — `957aa8ef34525b95` on `filetypes/powershell`

Generated 2026-06-09T09:54:09Z

full-train holds — PR_AUC 0.9994 -> 0.9993, AUC 0.9968 -> 0.9960, Brier 0.0179 -> 0.0194
...
|---|---|---|---|
| key | `957aa8ef34525b95` | `e43dd677b2121f05` | `d4ea9f5390096459` |
| PR AUC | 0.9994 | 0.9993 | 0.9993 |
| ROC AUC | 0.9968 | 0.9961 | 0.9960 |
| F1 | 0.9868 | 0.9892 | 0.9885 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-957aa8ef34525b95
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-957aa8ef34525b95/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-957aa8ef34525b95
```
