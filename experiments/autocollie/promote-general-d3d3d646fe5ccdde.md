# Promote PASS — `d3d3d646fe5ccdde` on `general`

Generated 2026-06-16T07:37:42Z

full-train holds — PR_AUC 0.9979 -> 0.9994, AUC 0.9977 -> 0.9993, Brier 0.0151 -> 0.0097
...
|---|---|---|---|
| key | `d3d3d646fe5ccdde` | `8a9002927faf8c81` | `1b46af3391105118` |
| PR AUC | 0.9979 | 0.9998 | 0.9994 |
| ROC AUC | 0.9977 | 0.9993 | 0.9993 |
| F1 | 0.9662 | 0.9942 | 0.9899 |
...
```
/home/t/collimator/out/models/azoth-candidate-general-d3d3d646fe5ccdde
```
...
Read `/home/t/collimator/out/models/azoth-candidate-general-d3d3d646fe5ccdde/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-general-d3d3d646fe5ccdde
```
