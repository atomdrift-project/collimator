# Promote PASS — `5fc200517285320f` on `filetypes/c`

Generated 2026-05-26T04:26:55Z

full-train holds — PR_AUC 0.9915 -> 0.9929, AUC 0.9955 -> 0.9963, Brier 0.0239 -> 0.0221

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9915)
...
|---|---|---|---|
| key | `5fc200517285320f` | `5cb491cb1b771cda` | `eadb44888b386e72` |
| PR AUC | 0.9915 | 0.9932 | 0.9929 |
| ROC AUC | 0.9955 | 0.9964 | 0.9963 |
| F1 | 0.9493 | 0.9484 | 0.9496 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-5fc200517285320f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-5fc200517285320f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-5fc200517285320f
```
