# Promote REJECTED — `68fae179959c68c4` on `filetypes/python`

Generated 2026-06-01T21:50:04Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-06-01T21-46-04_20260601T214550-promote-68fae179959c68c4_azoth-validate.log; tail: 2026-06-01 17:49:56,256 INFO exported LightGBM ONNX to /home/t/collimator/out/models/azoth-candidate-filetypes-python-68fae179959c68c4/filetypes/python/models/seed_43.onnx
2026-06-01 17:49:56,278 INFO DB-backed feature extraction: 200 rows, 4 workers, batch_size=1024
2026-06-01 17:49:57,042 INFO filetypes/python/models/seed_43.txt -> seed_43.onnx OK (delta=9.24e-08 on 200 rows, 1174 ms)
2026-06-01 17:49:57,461 INFO exported LightGBM ONNX to /home/t/collimator/out/models/azoth-candidate-filetypes-python-68fae179959c68c4/filetypes/python/models/seed_44.onnx
2026-06-01 17:49:57,484 INFO DB-backed feature extraction: 200 rows, 4 workers, batch_size=1024
2026-06-01 17:49:58,262 INFO filetypes/python/models/seed_44.txt -> seed_44.onnx OK (delta=8.93e-08 on 200 rows, 1220 ms)

converted 3/3 files (0 intentionally skipped, 0 failed)
staged runtime azoth bundle: /tmp/tmp.H67j8sSX91
azoth bundle ok: /tmp/tmp.H67j8sSX91
--source-bundle out/models/azoth: 1 routes changed → 1 filetypes impacted, 78 unimpacted (drift treated as pre-existing)

per-route improvements (≥0.10pp, informational):
  python :: filetypes/python recall@1FP-on-slice +4.52pp (63.37% → 67.89%)
...
1 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - python: L4 hostile ENSEMBLE recall dropped 20.65pp BELOW LOW-WATER-MARK (64.28% → 43.62%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `68fae179959c68c4` | `664f16a3a4c95074` | `d7e99f7be8dfddee` |
| PR AUC | 0.9990 | 0.9974 | 0.9976 |
| ROC AUC | 0.9991 | 0.9982 | 0.9982 |
| F1 | 0.9814 | 0.9743 | 0.9734 |
