# Promote PASS — `d3c72f4ec4a969ec` on `filetypes/text`

Generated 2026-05-27T01:52:30Z

full-train holds — PR_AUC 0.9691 -> 0.9652, AUC 0.9851 -> 0.9844, Brier 0.0502 -> 0.0530
...
|---|---|---|---|
| key | `d3c72f4ec4a969ec` | `11c286aa40fc20dc` | `bba7aa32a4b70e4a` |
| PR AUC | 0.9691 | 0.9758 | 0.9652 |
| ROC AUC | 0.9851 | 0.9890 | 0.9844 |
| F1 | 0.8980 | 0.9130 | 0.9130 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-text-d3c72f4ec4a969ec
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-text-d3c72f4ec4a969ec/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-text-d3c72f4ec4a969ec
```
