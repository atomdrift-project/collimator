# Promote PASS — `c03265c61008fd04` on `filegroups/source`

Generated 2026-06-14T20:19:50Z

full-train holds — PR_AUC 0.9991 -> 0.9978, AUC 0.9983 -> 0.9976, Brier 0.0180 -> 0.0196
...
|---|---|---|---|
| key | `c03265c61008fd04` | `a42cb9796a825a68` | `024f28f21058005b` |
| PR AUC | 0.9991 | 0.9978 | 0.9978 |
| ROC AUC | 0.9983 | 0.9975 | 0.9976 |
| F1 | 0.9821 | 0.9784 | 0.9789 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-source-c03265c61008fd04
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-source-c03265c61008fd04/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-source-c03265c61008fd04
```
