# Promote PASS — `1220cf5a115771ed` on `filegroups/documents`

Generated 2026-06-01T13:45:03Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 0.9998 -> 0.9992, Brier 0.0046 -> 0.0065
...
|---|---|---|---|
| key | `1220cf5a115771ed` | `adee597e6826de40` | `508f452990d8374f` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 0.9998 | 0.9992 | 0.9992 |
| F1 | 0.9975 | 0.9975 | 0.9975 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-documents-1220cf5a115771ed
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-documents-1220cf5a115771ed/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-documents-1220cf5a115771ed
```
