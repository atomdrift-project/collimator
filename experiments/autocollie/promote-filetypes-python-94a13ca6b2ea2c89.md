# Promote PASS — `94a13ca6b2ea2c89` on `filetypes/python`

Generated 2026-05-27T00:26:50Z

full-train holds — PR_AUC 0.9990 -> 0.9985, AUC 0.9991 -> 0.9987, Brier 0.0114 -> 0.0129
...
|---|---|---|---|
| key | `94a13ca6b2ea2c89` | `3a46fd52b4464b1f` | `2063bc50c84382ac` |
| PR AUC | 0.9990 | 0.9985 | 0.9985 |
| ROC AUC | 0.9991 | 0.9986 | 0.9987 |
| F1 | 0.9803 | 0.9777 | 0.9802 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-94a13ca6b2ea2c89
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-94a13ca6b2ea2c89/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-94a13ca6b2ea2c89
```
