# Promote PASS — `ff5849e4edde6851` on `filetypes/makefile`

Generated 2026-06-07T20:50:35Z

full-train holds — PR_AUC 0.5111 -> 0.5111, AUC 0.9219 -> 0.9219, Brier 0.1523 -> 0.1506

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.5111)
...
|---|---|---|---|
| key | `ff5849e4edde6851` | `c3f1403daeb15cfa` | `7f7d06f8b46c4762` |
| PR AUC | 0.5111 | 0.5111 | 0.5111 |
| ROC AUC | 0.9219 | 0.9219 | 0.9219 |
| F1 | 0.5455 | 0.6667 | 0.6667 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-ff5849e4edde6851
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-ff5849e4edde6851/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-ff5849e4edde6851
```
