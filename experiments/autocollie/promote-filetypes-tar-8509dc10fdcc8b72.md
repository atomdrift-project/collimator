# Promote PASS — `8509dc10fdcc8b72` on `filetypes/tar`

Generated 2026-05-26T21:27:35Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 1.0000 -> 1.0000, Brier 0.0589 -> 0.0647
...
|---|---|---|---|
| key | `8509dc10fdcc8b72` | `6536f4c61ea1474f` | `a6a6e5bec8bbe8fe` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 1.0000 | 1.0000 | 1.0000 |
| F1 | 0.9895 | 1.0000 | 1.0000 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-tar-8509dc10fdcc8b72
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-tar-8509dc10fdcc8b72/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-tar-8509dc10fdcc8b72
```
