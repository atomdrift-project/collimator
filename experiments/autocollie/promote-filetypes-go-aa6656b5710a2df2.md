# Promote PASS — `aa6656b5710a2df2` on `filetypes/go`

Generated 2026-06-02T00:28:18Z

full-train holds — PR_AUC 0.9595 -> 0.9568, AUC 0.9852 -> 0.9873, Brier 0.0425 -> 0.0381

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9595)
...
|---|---|---|---|
| key | `aa6656b5710a2df2` | `3cc49154b488066b` | `8a2822d73105450f` |
| PR AUC | 0.9595 | 0.9577 | 0.9568 |
| ROC AUC | 0.9852 | 0.9876 | 0.9873 |
| F1 | 0.8809 | 0.8333 | 0.8779 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-aa6656b5710a2df2
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-aa6656b5710a2df2/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-aa6656b5710a2df2
```
