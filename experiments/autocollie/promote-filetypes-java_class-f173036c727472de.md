# Promote PASS — `f173036c727472de` on `filetypes/java_class`

Generated 2026-06-15T05:59:21Z

full-train holds — PR_AUC 0.9883 -> 0.9888, AUC 0.9979 -> 0.9979, Brier 0.0131 -> 0.0127
...
|---|---|---|---|
| key | `f173036c727472de` | `dafa4e0048daeebe` | `d384e3904ea9e1b3` |
| PR AUC | 0.9883 | 0.9885 | 0.9888 |
| ROC AUC | 0.9979 | 0.9979 | 0.9979 |
| F1 | 0.9406 | 0.9406 | 0.9409 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-f173036c727472de
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-f173036c727472de/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-f173036c727472de
```
