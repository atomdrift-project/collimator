# Promote PASS — `1db5975dd22d3071` on `filetypes/pkg-info`

Generated 2026-05-27T06:36:09Z

full-train holds — PR_AUC 0.9767 -> 0.9941, AUC 0.5000 -> 0.5000, Brier 0.0228 -> 0.0059

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9767)
...
|---|---|---|---|
| key | `1db5975dd22d3071` | `e966a856d186d8ff` | `f8b0bfe1c5e4a935` |
| PR AUC | 0.9767 | 0.9941 | 0.9941 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.9882 | 0.9971 | 0.9971 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pkg-info-1db5975dd22d3071
```
...
EXP_FORMAT_HINTS=0
EXP_HARD_NEGATIVE_FRACTION=0.3
EXP_HARD_NEGATIVE_WEIGHT=2
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pkg-info-1db5975dd22d3071/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pkg-info-1db5975dd22d3071
```
