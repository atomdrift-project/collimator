# Promote PASS — `13f08847aeaf0594` on `filetypes/jpeg`

Generated 2026-07-06T04:12:01Z

full-train holds — PR_AUC 0.9684 -> 0.9761, AUC 0.9690 -> 0.9769, Brier 0.0569 -> 0.0558

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9684)
...
|---|---|---|---|
| key | `13f08847aeaf0594` | `1aedfe3255060081` | `7e182290e0a0d90f` |
| PR AUC | 0.9684 | 0.9784 | 0.9761 |
| ROC AUC | 0.9690 | 0.9812 | 0.9769 |
| F1 | 0.9111 | 0.9535 | 0.9535 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-jpeg-13f08847aeaf0594
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-jpeg-13f08847aeaf0594/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-jpeg-13f08847aeaf0594
```
