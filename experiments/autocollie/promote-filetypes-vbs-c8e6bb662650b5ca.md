# Promote PASS — `c8e6bb662650b5ca` on `filetypes/vbs`

Generated 2026-06-28T11:00:44Z

full-train holds — PR_AUC 0.9964 -> 0.9965, AUC 0.9865 -> 0.9873, Brier 0.0619 -> 0.0611
...
|---|---|---|---|
| key | `c8e6bb662650b5ca` | `72fb119d3fba440b` | `08e70e0ca92d09ac` |
| PR AUC | 0.9964 | 0.9965 | 0.9965 |
| ROC AUC | 0.9865 | 0.9873 | 0.9873 |
| F1 | 0.9576 | 0.9538 | 0.9614 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-c8e6bb662650b5ca
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-c8e6bb662650b5ca/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-c8e6bb662650b5ca
```
