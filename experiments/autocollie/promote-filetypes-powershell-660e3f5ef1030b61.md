# Promote PASS — `660e3f5ef1030b61` on `filetypes/powershell`

Generated 2026-05-27T01:16:45Z

full-train holds — PR_AUC 0.9986 -> 0.9990, AUC 0.9966 -> 0.9967, Brier 0.0222 -> 0.0158
...
|---|---|---|---|
| key | `660e3f5ef1030b61` | `5e06992ff8a4959e` | `e23406412fa9953e` |
| PR AUC | 0.9986 | 0.9988 | 0.9990 |
| ROC AUC | 0.9966 | 0.9959 | 0.9967 |
| F1 | 0.9801 | 0.9887 | 0.9873 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-660e3f5ef1030b61
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-660e3f5ef1030b61/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-660e3f5ef1030b61
```
