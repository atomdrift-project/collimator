# Promote PASS — `bcd794ceeaae38bf` on `filetypes/plist`

Generated 2026-05-27T02:06:40Z

full-train holds — PR_AUC 0.8909 -> 0.9250, AUC 0.9400 -> 0.9700, Brier 0.1197 -> 0.0943

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.8909)
...
|---|---|---|---|
| key | `bcd794ceeaae38bf` | `f10b4ca8b01f77cb` | `041149829e392cec` |
| PR AUC | 0.8909 | 0.9250 | 0.9250 |
| ROC AUC | 0.9400 | 0.9700 | 0.9700 |
| F1 | 0.8000 | 0.7692 | 0.7692 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-plist-bcd794ceeaae38bf
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-plist-bcd794ceeaae38bf/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-plist-bcd794ceeaae38bf
```
