# Promote PASS — `644535c539b18a3c` on `filetypes/pe`

Generated 2026-06-09T10:23:12Z

full-train holds — PR_AUC 0.9991 -> 0.9999, AUC 0.9992 -> 0.9998, Brier 0.0083 -> 0.0041
...
|---|---|---|---|
| key | `644535c539b18a3c` | `95547008e7c79faf` | `f71d0ecd61c3a89f` |
| PR AUC | 0.9991 | 1.0000 | 0.9999 |
| ROC AUC | 0.9992 | 0.9998 | 0.9998 |
| F1 | 0.9896 | 0.9987 | 0.9966 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pe-644535c539b18a3c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pe-644535c539b18a3c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pe-644535c539b18a3c
```
