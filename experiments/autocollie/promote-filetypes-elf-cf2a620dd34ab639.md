# Promote PASS — `cf2a620dd34ab639` on `filetypes/elf`

Generated 2026-05-26T16:17:55Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 1.0000 -> 1.0000, Brier 0.0014 -> 0.0007
...
|---|---|---|---|
| key | `cf2a620dd34ab639` | `0492b2214b18eabc` | `5e5756c6a42ade29` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 1.0000 | 1.0000 | 1.0000 |
| F1 | 0.9979 | 0.9986 | 0.9990 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-elf-cf2a620dd34ab639
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-elf-cf2a620dd34ab639/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-elf-cf2a620dd34ab639
```
