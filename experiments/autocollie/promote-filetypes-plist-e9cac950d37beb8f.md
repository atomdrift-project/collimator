# Promote PASS — `e9cac950d37beb8f` on `filetypes/plist`

Generated 2026-05-27T06:32:25Z

full-train holds — PR_AUC 0.2000 -> 0.2000, AUC 0.5000 -> 0.5000, Brier 0.1825 -> 0.1806

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.2000)
...
|---|---|---|---|
| key | `e9cac950d37beb8f` | `b61be3df21f9d2d5` | `0ff08278e129e8b5` |
| PR AUC | 0.2000 | 0.2000 | 0.2000 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.3333 | 0.3333 | 0.3333 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-plist-e9cac950d37beb8f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-plist-e9cac950d37beb8f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-plist-e9cac950d37beb8f
```
