...
## Cycle `20260627T204056-filetypes-xml` — 2026-06-27T20:40:56Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `076145546b051bf2` | inherit_from_filetypes_gem_06bdacaa | ok | 0.9995 | 0.9999 | 0.9767 | 33 | [log](out/autocollie/runs/2026-06-27T20-49-45_20260627T204056-filetypes-xml_inherit_from_filetypes_gem_06bdacaa.log) |
| `a249db3c92d734ca` | xml_control_train_v2 | ok | 0.1995 | 0.6730 | 0.1764 | 51 | [log](out/autocollie/runs/2026-06-27T20-50-43_20260627T204056-filetypes-xml_xml_control_train_v2.log) |
| `9b348c1c316b8d01` | xml_text_metrics_full_vocab | ok | 0.2086 | 0.7105 | 0.1653 | 19 | [log](out/autocollie/runs/2026-06-27T20-51-40_20260627T204056-filetypes-xml_xml_text_metrics_full_vocab.log) |
| `3268d062d9496a12` | xml_kv_vocab_tiered_bigrams | ok | 0.2069 | 0.7136 | 0.1764 | 22 | [log](out/autocollie/runs/2026-06-27T20-52-02_20260627T204056-filetypes-xml_xml_kv_vocab_tiered_bigrams.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_gem_06bdacaa`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/gem (key=06bdacaa9d08b7d4, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_v2`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 EXP_CRIT_CATEGORY_NGRAMS=1 EXP_ESTIMATORS=300 …` — Replicate best feature_env to establish baseline; tweak num_leaves and reg_lambda to improve PR_AUC by reducing overfitting on rare XML patterns.
- **`xml_text_metrics_full_vocab`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_BIGRAM_MIN_FREQ=200 EXP_BLINDFOLD=1 EXP_CRIT_CATEGORY_NGRAMS=1 EXP_ESTIMATORS=300 EXP_LEARNING_RATE=0.05 …` — Enable text_metrics_full to capture XML structural obfuscation signals; aims to boost recall@3FPM by identifying malicious payload density in tag/attribute layouts.
- **`xml_kv_vocab_tiered_bigrams`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_BLINDFOLD=1 EXP_CRIT_CATEGORY_NGRAMS=1 EXP_ESTIMATORS=300 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=10000 …` — Enable kv_vocab to parse XML attributes as key-value pairs; aims to improve PR_AUC by isolating malicious attribute combinations from benign markup noise.

</details>

## Cycle `20260628T042429-filetypes-xml` — 2026-06-28T04:24:29Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `076145546b051bf2` | inherit_from_filetypes_gem_06bdacaa | dup | 0.9995 | 0.9999 | 0.9767 | 1 | [log](out/autocollie/runs/2026-06-28T04-31-48_20260628T042429-filetypes-xml_inherit_from_filetypes_gem_06bdacaa.log) |
| `567ba07f72019905` | xml_control_train_v3 | ok | 0.1722 | 0.6063 | 0.1621 | 3 | [log](out/autocollie/runs/2026-06-28T04-31-55_20260628T042429-filetypes-xml_xml_control_train_v3.log) |
| `7a5bacbb2f346463` | xml_text_metrics_full_vocab | ok | 0.1948 | 0.6669 | 0.1653 | 12 | [log](out/autocollie/runs/2026-06-28T04-32-02_20260628T042429-filetypes-xml_xml_text_metrics_full_vocab.log) |
| `1bfdbf5da4cb21d1` | xml_kv_textenc_vocab | ok | 0.1942 | 0.6679 | 0.1764 | 18 | [log](out/autocollie/runs/2026-06-28T04-32-15_20260628T042429-filetypes-xml_xml_kv_textenc_vocab.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_gem_06bdacaa`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/gem (key=06bdacaa9d08b7d4, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_v3`** `EXP_ESTIMATORS=300 EXP_LEARNING_RATE=0.03 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_TRAIN_SAMPLES=30000` — Control baseline replicating best feature_env; increases estimators and lowers LR to stabilize tail recall@3 FP/M while keeping PR_AUC flat via matrix cache hit.
- **`xml_text_metrics_full_vocab`** `EXP_ESTIMATORS=250 EXP_LEARNING_RATE=0.05 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Enables text_metrics_full to capture XML structural anomalies and obfuscation, targeting PR_AUC improvement by adding discriminative text-level features.
- **`xml_kv_textenc_vocab`** `EXP_ESTIMATORS=250 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=5000 EXP_LEARNING_RATE=0.05 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_ENCODING_FEATURES=1 EXP_TRAIN_SAMPLES=30000` — Activates kv_vocab and text_encoding to extract attribute/value patterns and encoding artifacts, aiming to boost recall@3 FP/M by surfacing hidden malicious payloads.

</details>

## Cycle `20260628T055608-filetypes-xml` — 2026-06-28T05:56:08Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `076145546b051bf2` | inherit_from_filetypes_gem_06bdacaa | dup | 0.9995 | 0.9999 | 0.9767 | 1 | [log](out/autocollie/runs/2026-06-28T06-02-35_20260628T055608-filetypes-xml_inherit_from_filetypes_gem_06bdacaa.log) |
| `375721c2f721d137` | xml_control_train_v4 | ok | 0.1855 | 0.6902 | 0.1764 | 2 | [log](out/autocollie/runs/2026-06-28T06-02-39_20260628T055608-filetypes-xml_xml_control_train_v4.log) |
| `2676a4aae0142452` | xml_kv_textmetrics_vocab | ok | 0.1948 | 0.6669 | 0.1653 | 8 | [log](out/autocollie/runs/2026-06-28T06-02-44_20260628T055608-filetypes-xml_xml_kv_textmetrics_vocab.log) |
| `339d7e7b14805a0b` | xml_textenc_no_clusters | ok | 0.1942 | 0.6679 | 0.1764 | 8 | [log](out/autocollie/runs/2026-06-28T06-02-53_20260628T055608-filetypes-xml_xml_textenc_no_clusters.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_gem_06bdacaa`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/gem (key=06bdacaa9d08b7d4, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_v4`** `EXP_ESTIMATORS=300 EXP_MAX_TEST_SAMPLES=20000 EXP_MIN_CHILD_SAMPLES=150 EXP_NUM_LEAVES=128 EXP_REG_LAMBDA=1.5 EXP_TRAIN_SAMPLES=30000` — Replicates best recent feature set to establish a training-only baseline; aims to stabilize PR_AUC while tuning regularization to reduce overfitting.
- **`xml_kv_textmetrics_vocab`** `EXP_ESTIMATORS=300 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=5000 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Enables kv_vocab and text_metrics_full to capture XML attribute patterns and structural text signals; aims to boost PR_AUC by adding discriminative features for malicious payloads.
- **`xml_textenc_no_clusters`** `EXP_DISABLE_FEATURE_GROUPS=clusters EXP_ESTIMATORS=300 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_ENCODING_FEATURES=1 EXP_TRAIN_SAMPLES=30000` — Disables noisy clusters group and enables text_encoding to focus on payload encoding patterns; aims to improve recall@3FPM by reducing false positives from benign cluster overlaps.

</details>

## Cycle `20260628T063319-filetypes-xml` — 2026-06-28T06:33:19Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `076145546b051bf2` | inherit_from_filetypes_gem_06bdacaa | dup | 0.9995 | 0.9999 | 0.9767 | 2 | [log](out/autocollie/runs/2026-06-28T06-42-27_20260628T063319-filetypes-xml_inherit_from_filetypes_gem_06bdacaa.log) |
| `a249db3c92d734ca` | xml_control_train_v5 | dup | 0.1995 | 0.6730 | 0.1764 | 2 | [log](out/autocollie/runs/2026-06-28T06-42-34_20260628T063319-filetypes-xml_xml_control_train_v5.log) |
| `eb9ce6ea6fa62f65` | xml_textenc_metrics_kv | ok | 0.1948 | 0.6669 | 0.1653 | 66 | [log](out/autocollie/runs/2026-06-28T06-42-41_20260628T063319-filetypes-xml_xml_textenc_metrics_kv.log) |
| `e9fb402dcea3c541` | xml_bigram_kv_tuning | ok | 0.1942 | 0.6679 | 0.1764 | 22 | [log](out/autocollie/runs/2026-06-28T06-43-50_20260628T063319-filetypes-xml_xml_bigram_kv_tuning.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_gem_06bdacaa`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/gem (key=06bdacaa9d08b7d4, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_v5`** `EXP_ESTIMATORS=300 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_REG_LAMBDA=1.5 EXP_TRAIN_SAMPLES=30000` — Aims to improve PR_AUC by increasing tree capacity and regularization to better rank tail malware without overfitting, using the best recent feature set for a cache hit.
- **`xml_textenc_metrics_kv`** `EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=15000 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_ENCODING_FEATURES=1 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Aims to boost recall@3FPM by enabling text_encoding and text_metrics_full to capture XML obfuscation patterns, alongside expanded kv_vocab for rare malicious attributes.
- **`xml_bigram_kv_tuning`** `EXP_BIGRAM_MIN_FREQ=250 EXP_KV_MIN_FREQ=5 EXP_MAX_TEST_SAMPLES=20000 EXP_OBJECTIVE_TRIGRAMS=1 EXP_TRAIN_SAMPLES=30000` — Aims to improve PR_AUC by lowering bigram_min_freq and kv_min_freq to capture rarer malicious XML structures that are currently filtered out.

</details>

## Cycle `20260628T102950-filetypes-xml` — 2026-06-28T10:29:50Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `076145546b051bf2` | inherit_from_filetypes_gem_06bdacaa | dup | 0.9995 | 0.9999 | 0.9767 | 2 | [log](out/autocollie/runs/2026-06-28T10-37-11_20260628T102950-filetypes-xml_inherit_from_filetypes_gem_06bdacaa.log) |
| `567ba07f72019905` | xml_control_train_v5 | dup | 0.1722 | 0.6063 | 0.1621 | 1 | [log](out/autocollie/runs/2026-06-28T10-37-16_20260628T102950-filetypes-xml_xml_control_train_v5.log) |
| `6da542bed6dcddbb` | xml_textmetrics_kv_vocab | ok | 0.1949 | 0.6669 | 0.1653 | 10 | [log](out/autocollie/runs/2026-06-28T10-37-19_20260628T102950-filetypes-xml_xml_textmetrics_kv_vocab.log) |
| `49efe85d430f6de5` | xml_severity_fractions_no_clusters | ok | 0.1942 | 0.6679 | 0.1764 | 12 | [log](out/autocollie/runs/2026-06-28T10-37-30_20260628T102950-filetypes-xml_xml_severity_fractions_no_clusters.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_gem_06bdacaa`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/gem (key=06bdacaa9d08b7d4, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_v5`** `EXP_ESTIMATORS=300 EXP_LEARNING_RATE=0.03 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_REG_LAMBDA=1 EXP_TRAIN_SAMPLES=30000` — Control spec replicating best recent feature_env to test if increasing num_leaves and lowering learning_rate improves PR_AUC by reducing underfitting on tail malware.
- **`xml_textmetrics_kv_vocab`** `EXP_BIGRAM_MIN_FREQ=500 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=15000 EXP_LEARNING_RATE=0.05 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Enables text_metrics_full and kv_vocab to capture structural document obfuscation and key-value patterns, aiming to boost PR_AUC by adding discriminative signal for XML malware.
- **`xml_severity_fractions_no_clusters`** `EXP_BIGRAM_MIN_FREQ=250 EXP_DISABLE_FEATURE_GROUPS=clusters EXP_LEARNING_RATE=0.05 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=96 EXP_SEVERITY_FRACTION_FEATURES=1 EXP_TRAIN_SAMPLES=30000` — Toggles severity_fractions and disables clusters to emphasize critical-tier finding ratios while dropping noisy aggregates, targeting recall@3FPM by sharpening the model's focus on high-severity XML payloads.
...
## Cycle `20260703T005740-filetypes-xml` — 2026-07-03T00:57:40Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `2c02037b2dd7a561` | inherit_from_filetypes_registry_1ffaf151 | ok | 0.1937 | 0.6714 | 0.1764 | 2 | [log](out/autocollie/runs/2026-07-03T01-04-52_20260703T005740-filetypes-xml_inherit_from_filetypes_registry_1ffaf151.log) |
| `067ffa69373bbf8f` | xml_control_hardneg_tune | ok | 0.2407 | 0.5997 | 0.1774 | 8 | [log](out/autocollie/runs/2026-07-03T01-05-19_20260703T005740-filetypes-xml_xml_control_hardneg_tune.log) |
| `85e57678fbfdaaae` | xml_textenc_kv_expand | ok | 0.2189 | 0.6462 | 0.1653 | 7 | [log](out/autocollie/runs/2026-07-03T01-05-29_20260703T005740-filetypes-xml_xml_textenc_kv_expand.log) |
| `8527abe9dc00b30f` | xml_tiered_trigrams_low_freq | ok | 0.2158 | 0.6475 | 0.1690 | 8 | [log](out/autocollie/runs/2026-07-03T01-05-36_20260703T005740-filetypes-xml_xml_tiered_trigrams_low_freq.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_registry_1ffaf151`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=2 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/registry (key=1ffaf15111dff4bb, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_hardneg_tune`** `EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=250 EXP_ESTIMATORS=300 EXP_HARD_NEGATIVE_FRACTION=0.1 EXP_HARD_NEGATIVE_WEIGHT=10 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=12000 EXP_MAX_TEST_SAMPLES=20000 …` — Replicates the top recent feature surface to ensure matrix cache hits; tests hard-negative upweighting to improve PR_AUC by better separating borderline benign XML from malware.
- **`xml_textenc_kv_expand`** `EXP_BIGRAM_MAX=8000 EXP_BIGRAM_MIN_FREQ=100 EXP_ESTIMATORS=300 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=20000 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_TEXT_ENCODING_FEATURES=1 …` — Enables text_encoding and expands kv_vocab to capture richer XML attribute/value patterns, aiming to boost PR_AUC and recall@3FPM by adding discriminative lexical signal.
- **`xml_tiered_trigrams_low_freq`** `EXP_ESTIMATORS=350 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=15000 EXP_LEARNING_RATE=0.03 EXP_MAX_TEST_SAMPLES=20000 EXP_TIERED_TRIGRAM_MAX=5000 EXP_TIERED_TRIGRAM_MIN_FREQ=1 EXP_TRAIN_SAMPLES=30000` — Lowers tiered trigram frequency floor to capture rare XML structural patterns, targeting recall@3FPM gains while keeping PR_AUC stable via conservative learning rate.
...
## Cycle `20260704T185704-filetypes-xml` — 2026-07-04T18:57:04Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `2c02037b2dd7a561` | inherit_from_filetypes_registry_1ffaf151 | dup | 0.1937 | 0.6714 | 0.1764 | 3 | [log](out/autocollie/runs/2026-07-04T19-05-02_20260704T185704-filetypes-xml_inherit_from_filetypes_registry_1ffaf151.log) |
| `02e6147b7f7a8287` | xml_control_hardneg_lr_tune | ok | 0.2214 | 0.7021 | 0.1764 | 2 | [log](out/autocollie/runs/2026-07-04T19-05-08_20260704T185704-filetypes-xml_xml_control_hardneg_lr_tune.log) |
| `8ce5f5f6d8fb97ba` | xml_text_metrics_kv_vocab | ok | 0.1948 | 0.6669 | 0.1653 | 3 | [log](out/autocollie/runs/2026-07-04T19-05-11_20260704T185704-filetypes-xml_xml_text_metrics_kv_vocab.log) |
| `b0864f6cdb10761c` | xml_textenc_low_freq_ngrams | ok | 0.2046 | 0.6192 | 0.1616 | 11 | [log](out/autocollie/runs/2026-07-04T19-05-16_20260704T185704-filetypes-xml_xml_textenc_low_freq_ngrams.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_registry_1ffaf151`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=2 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/registry (key=1ffaf15111dff4bb, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_hardneg_lr_tune`** `EXP_ESTIMATORS=300 EXP_HARD_NEGATIVE_FRACTION=0.1 EXP_HARD_NEGATIVE_WEIGHT=12 EXP_LEARNING_RATE=0.03 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_TRAIN_SAMPLES=30000` — Control spec replicating recent feature surface; tunes hard_negative_weight and learning_rate to improve PR_AUC by sharpening decision boundaries on difficult benign/malware overlaps.
- **`xml_text_metrics_kv_vocab`** `EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=5000 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Enables text_metrics_full and kv_vocab to capture XML structural anomalies and attribute patterns, aiming to boost PR_AUC by adding discriminative signal for obfuscated payloads.
- **`xml_textenc_low_freq_ngrams`** `EXP_BIGRAM_MIN_FREQ=50 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_ENCODING_FEATURES=1 EXP_TIERED_TRIGRAM_MIN_FREQ=10 EXP_TRAIN_SAMPLES=30000` — Lowers bigram_min_freq and tiered_trigram_min_freq while enabling text_encoding to capture rare XML tag sequences and encoding artifacts, targeting recall@3FPM by surfacing low-prevalence malicious patterns.
...
## Cycle `20260709T105859-filetypes-xml` — 2026-07-09T10:58:59Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `ab8b9d0de594d77d` | inherit_from_filetypes_gem_06bdacaa | ok | 0.9995 | 0.9999 | 0.9639 | 27 | [log](out/autocollie/runs/2026-07-09T11-07-32_20260709T105859-filetypes-xml_inherit_from_filetypes_gem_06bdacaa.log) |
| `1bcd3372248202ad` | xml_control_train_tune | ok | 0.2160 | 0.6886 | 0.1626 | 18 | [log](out/autocollie/runs/2026-07-09T11-08-16_20260709T105859-filetypes-xml_xml_control_train_tune.log) |
| `51fcbc03ab2ea333` | xml_text_metrics_kv_vocab | ok | 0.2111 | 0.6780 | 0.1629 | 11 | [log](out/autocollie/runs/2026-07-09T11-08-38_20260709T105859-filetypes-xml_xml_text_metrics_kv_vocab.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_gem_06bdacaa`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/gem (key=06bdacaa9d08b7d4, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_tune`** `EXP_ESTIMATORS=300 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_REG_LAMBDA=1.5 EXP_TRAIN_SAMPLES=30000` — Replicates best feature_env to hit matrix cache; tunes num_leaves and reg_lambda to improve PR_AUC and recall@3FPM without changing features.
- **`xml_text_metrics_kv_vocab`** `EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=10000 EXP_MAX_TEST_SAMPLES=20000 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Enables text_metrics_full and kv_vocab to capture XML structural and key-value patterns, aiming to boost PR_AUC and recall@3FPM.

</details>

## Cycle `20260712T105621-filetypes-xml` — 2026-07-12T10:56:21Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `e6070d18232d42d5` | inherit_from_filetypes_gem_06bdacaa | ok | 1.0000 | 1.0000 | 0.9639 | 56 | [log](out/autocollie/runs/2026-07-12T11-06-44_20260712T105621-filetypes-xml_inherit_from_filetypes_gem_06bdacaa.log) |
| `0c834976e08d4d6d` | xml_control_train_tune_textenc | ok | 0.1141 | 0.5460 | 0.1556 | 34 | [log](out/autocollie/runs/2026-07-12T11-08-21_20260712T105621-filetypes-xml_xml_control_train_tune_textenc.log) |
| `a925a499eff8e8b1` | xml_kv_vocab_hardneg_tail | ok | 0.1597 | 0.5607 | 0.1592 | 7 | [log](out/autocollie/runs/2026-07-12T11-09-01_20260712T105621-filetypes-xml_xml_kv_vocab_hardneg_tail.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_gem_06bdacaa`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/gem (key=06bdacaa9d08b7d4, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_tune_textenc`** `EXP_ESTIMATORS=300 EXP_LEARNING_RATE=0.03 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_TEXT_ENCODING_FEATURES=1 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Control feature set augmented with text_metrics_full to capture XML structural noise; training tweaks (num_leaves, learning_rate) aim to stabilize PR_AUC ranking.
- **`xml_kv_vocab_hardneg_tail`** `EXP_HARD_NEGATIVE_FRACTION=0.1 EXP_HARD_NEGATIVE_WEIGHT=12 EXP_KV_MIN_FREQ=5 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=5000 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=112 EXP_TRAIN_SAMPLES=30000` — Enables kv_vocab to capture XML attribute patterns and uses hard negatives to push recall@3 FP/M by focusing on borderline malicious configs.

</details>

## Cycle `20260713T214411-filetypes-xml` — 2026-07-13T21:44:11Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `c100969c6084ce6e` | inherit_from_filetypes_plist_8b54303f | ok | 1.0000 | 1.0000 | 1.0000 | 23 | [log](out/autocollie/runs/2026-07-13T21-52-57_20260713T214411-filetypes-xml_inherit_from_filetypes_plist_8b54303f.log) |
| `cbce1833d41a6601` | xml_control_train_tune | ok | 0.2292 | 0.6921 | 0.1513 | 12 | [log](out/autocollie/runs/2026-07-13T21-53-21_20260713T214411-filetypes-xml_xml_control_train_tune.log) |
| `26e1a906e5c34901` | xml_text_metrics_kv_vocab | ok | 0.2258 | 0.6835 | 0.1551 | 5 | [log](out/autocollie/runs/2026-07-13T21-53-34_20260713T214411-filetypes-xml_xml_text_metrics_kv_vocab.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_plist_8b54303f`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/plist (key=8b54303f1c4f4c1d, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_control_train_tune`** `EXP_ESTIMATORS=300 EXP_LEARNING_RATE=0.05 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_TRAIN_SAMPLES=30000` — Replicate best feature_env and tune training capacity to stabilize PR_AUC and improve recall@3FPM at the strict-FP tail.
- **`xml_text_metrics_kv_vocab`** `EXP_BIGRAM_MIN_FREQ=500 EXP_ESTIMATORS=300 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=5000 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_TEXT_ENCODING_FEATURES=1 EXP_TEXT_METRICS_FULL=1 …` — Enable text_metrics_full and kv_vocab to capture XML structural obfuscation and key-value patterns, aiming to boost recall@3FPM by surfacing hidden malicious signals.

</details>

## Cycle `20260715T025135-filetypes-xml` — 2026-07-15T02:51:35Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `59606d768307469f` | inherit_from_filetypes_plist_8b54303f | ok | 1.0000 | 1.0000 | 0.9882 | 60 | [log](out/autocollie/runs/2026-07-15T03-00-28_20260715T025135-filetypes-xml_inherit_from_filetypes_plist_8b54303f.log) |
| `c7346a6072d546dc` | xml_text_metrics_kv_vocab_control | ok | 0.0900 | 0.5430 | 0.1541 | 58 | [log](out/autocollie/runs/2026-07-15T03-02-37_20260715T025135-filetypes-xml_xml_text_metrics_kv_vocab_control.log) |
| `8e253f33573f65f7` | xml_text_encoding_kv_split_tail | ok | 0.1737 | 0.6070 | 0.1629 | 21 | [log](out/autocollie/runs/2026-07-15T03-03-45_20260715T025135-filetypes-xml_xml_text_encoding_kv_split_tail.log) |

<details><summary>Spec details</summary>

- **`inherit_from_filetypes_plist_8b54303f`** `EXP_AIR_GAP_SIGNAL=1 EXP_ATTACK_CODE_NGRAMS=1 EXP_ATTACK_FEATURES=1 EXP_ATTACK_NGRAMS=0 EXP_BETA=1.25 EXP_BIGRAM_MAX=5000 EXP_BIGRAM_MIN_FREQ=1000 EXP_BLINDFOLD=1 …` — Sister-route inheritance from filetypes/plist (key=8b54303f1c4f4c1d, recall_at_50_per_100M=1.0000). Tries a known-working config from a related route before letting the LLM propose novel knob combinations.
- **`xml_text_metrics_kv_vocab_control`** `EXP_ESTIMATORS=300 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=5000 EXP_MAX_TEST_SAMPLES=20000 EXP_NUM_LEAVES=128 EXP_REG_LAMBDA=2 EXP_TEXT_METRICS_FULL=1 EXP_TRAIN_SAMPLES=30000` — Replicates recent feature surface but enables text_metrics_full and kv_vocab to capture XML structural patterns, aiming to lift PR_AUC by adding discriminative signal for malformed payloads while keeping ROC_AUC flat via L2 regularization.
- **`xml_text_encoding_kv_split_tail`** `EXP_ESTIMATORS=350 EXP_KV_VALUE_SPLIT=1 EXP_KV_VOCAB=1 EXP_KV_VOCAB_MAX=8000 EXP_LEARNING_RATE=0.03 EXP_MAX_TEST_SAMPLES=20000 EXP_MIN_CHILD_SAMPLES=50 EXP_TEXT_ENCODING_FEATURES=1 …` — Activates text_encoding and kv_value_split to parse XML namespaces and attribute values, targeting recall@3 FP/M by isolating malicious encoding patterns without bloating the feature matrix.
...
## Cycle `20260821T123926-filetypes-xml` — 2026-08-21T12:39:26Z

| spec key | idea | status | PR AUC | ROC AUC | F1 | wall_s | log |
|----------|------|--------|--------|---------|----|--------|-----|
| `5e6126cf62aa1cee` | inherit_from_filetypes_plist_8b54303f | ok | 0.2599 | 0.6650 | 0.2713 | 54 | [log](out/autocollie/runs/2026-08-21T12-55-26_20260821T123926-filetypes-xml_inherit_from_filetypes_plist_8b54303f.log) |

Rejected before run:

- `xml_text_metrics_only_tail` — features.repetition_penalty_features: unknown knob (not in allowlist)
