# Promote PASS — `c0d6529324310b84` on `filegroups/portable`

Generated 2026-06-28T12:08:12Z

full-train holds — PR_AUC 0.9856 -> 0.9924, AUC 0.9973 -> 0.9983, Brier 0.0149 -> 0.0133

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9856)
...
|---|---|---|---|
| key | `c0d6529324310b84` | `c51f4d7c951be066` | `b2d2dc7fcdb66e52` |
| PR AUC | 0.9856 | 0.9927 | 0.9924 |
| ROC AUC | 0.9973 | 0.9984 | 0.9983 |
| F1 | 0.9378 | 0.9571 | 0.9557 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-portable-c0d6529324310b84
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-portable-c0d6529324310b84/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-portable-c0d6529324310b84
```
