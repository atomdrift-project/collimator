# Promote PASS — `70383d155a63bb3e` on `filetypes/xlsx`

Generated 2026-08-25T20:46:44Z

full-train holds — PR_AUC 0.9874 -> 0.9899, AUC 0.7689 -> 0.8189, Brier 0.6192 -> 0.6180

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9874)
...
|---|---|---|---|
| key | `70383d155a63bb3e` | `29236a1348dee332` | `2836d5c980d6a9c7` |
| PR AUC | 0.9874 | 0.9858 | 0.9899 |
| ROC AUC | 0.7689 | 0.7328 | 0.8189 |
| F1 | 0.3813 | 0.4606 | 0.4626 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xlsx-70383d155a63bb3e
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xlsx-70383d155a63bb3e/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xlsx-70383d155a63bb3e
```
