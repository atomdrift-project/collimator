# Promote PASS — `c48b5d7ee0d7a742` on `filetypes/go`

Generated 2026-06-18T02:21:39Z

full-train holds — PR_AUC 0.9247 -> 0.9323, AUC 0.9763 -> 0.9788, Brier 0.0426 -> 0.0406
...
|---|---|---|---|
| key | `c48b5d7ee0d7a742` | `5a9ed107e738da2c` | `11a0af2f5da3d4b2` |
| PR AUC | 0.9247 | 0.9338 | 0.9323 |
| ROC AUC | 0.9763 | 0.9795 | 0.9788 |
| F1 | 0.8364 | 0.8707 | 0.8626 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-c48b5d7ee0d7a742
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-c48b5d7ee0d7a742/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-c48b5d7ee0d7a742
```
