# Promote PASS — `d3970b1e564dfe6c` on `filetypes/rtf`

Generated 2026-07-23T03:58:44Z

full-train holds — PR_AUC 0.9993 -> 0.9994, AUC 0.9962 -> 0.9958, Brier 0.0193 -> 0.0193
...
|---|---|---|---|
| key | `d3970b1e564dfe6c` | `a4fd148f0a64b76a` | `59ae420f68f40993` |
| PR AUC | 0.9993 | 0.9993 | 0.9994 |
| ROC AUC | 0.9962 | 0.9957 | 0.9958 |
| F1 | 0.9861 | 0.9774 | 0.9763 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-d3970b1e564dfe6c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-d3970b1e564dfe6c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-d3970b1e564dfe6c
```
