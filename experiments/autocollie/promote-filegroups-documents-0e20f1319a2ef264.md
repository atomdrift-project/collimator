# Promote PASS — `0e20f1319a2ef264` on `filegroups/documents`

Generated 2026-06-01T14:35:20Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 0.9998 -> 0.9993, Brier 0.0044 -> 0.0063
...
|---|---|---|---|
| key | `0e20f1319a2ef264` | `4c4d9705e236940b` | `746a0449ced06cab` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 0.9998 | 0.9992 | 0.9993 |
| F1 | 0.9968 | 0.9974 | 0.9975 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-documents-0e20f1319a2ef264
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-documents-0e20f1319a2ef264/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-documents-0e20f1319a2ef264
```
