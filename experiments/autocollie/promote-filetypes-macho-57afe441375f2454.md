# Promote PASS — `57afe441375f2454` on `filetypes/macho`

Generated 2026-06-13T01:58:48Z

full-train holds — PR_AUC 0.9968 -> 0.9971, AUC 0.9993 -> 0.9994, Brier 0.0074 -> 0.0072
...
|---|---|---|---|
| key | `57afe441375f2454` | `3a43262b8e43504e` | `bce42247c1da49e3` |
| PR AUC | 0.9968 | 0.9968 | 0.9971 |
| ROC AUC | 0.9993 | 0.9993 | 0.9994 |
| F1 | 0.9723 | 0.9672 | 0.9672 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-macho-57afe441375f2454
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-macho-57afe441375f2454/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-macho-57afe441375f2454
```
