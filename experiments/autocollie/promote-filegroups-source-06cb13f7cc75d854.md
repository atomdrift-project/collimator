# Promote REJECTED — `06cb13f7cc75d854` on `filegroups/source`

Generated 2026-05-26T03:05:34Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-05-26T02-59-37_20260526T025831-promote-06cb13f7cc75d854_azoth-validate.log; tail: 	--partition test \
	--output-md /home/t/collimator/out/models/azoth-candidate-filegroups-source-06cb13f7cc75d854/route_policy_eval_oof.md \
	--output-json /home/t/collimator/out/models/azoth-candidate-filegroups-source-06cb13f7cc75d854/route_policy_eval_oof.json
wrote /home/t/collimator/out/models/azoth-candidate-filegroups-source-06cb13f7cc75d854/route_policy_eval_oof.json
wrote /home/t/collimator/out/models/azoth-candidate-filegroups-source-06cb13f7cc75d854/route_policy_eval_oof.md
.venv/bin/python scripts/write_azoth_readmes.py --azoth-root /home/t/collimator/out/models/azoth-candidate-filegroups-source-06cb13f7cc75d854
staged runtime azoth bundle: /tmp/tmp.t3CHoyvPxy
azoth bundle ok: /tmp/tmp.t3CHoyvPxy
--source-bundle out/models/azoth: 1 routes changed → 7 filetypes impacted, 59 unimpacted (drift treated as pre-existing)

ensemble improvements (≥0.10pp):
  c: L3 hostile ensemble recall +1.02pp (11.33% → 12.34%)
  csharp: L3 hostile ensemble recall +0.43pp (25.21% → 25.64%)
  go: L3 hostile ensemble recall +0.17pp (1.27% → 1.44%)
  kotlin: L3 hostile ensemble recall +4.58pp (52.67% → 57.25%)
  rust: L3 hostile ensemble recall +0.61pp (1.22% → 1.83%)

per-route improvements (≥0.10pp, informational):
  c :: filegroups/source recall@3FP/M +0.28pp (13.36% → 13.65%)
  go :: filegroups/source recall@3FP/M +0.34pp (2.29% → 2.63%)

per-route regressions (informational; does not block deploy):
  csharp :: filegroups/source recall@3FP/M dropped 2.14pp (32.05% → 29.91%)
  kotlin :: filegroups/source recall@3FP/M dropped 8.06pp (72.06% → 64.00%)

14 low-water-mark improvement(s) (>0.90pp above LWM, informational):
  + c: L3 hostile ensemble recall +2.32pp above LWM (10.02% → 12.34%)
  ...
  + kotlin: L3 hostile ensemble recall +4.58pp above LWM (52.67% → 57.25%)
...
|---|---|---|---|
| key | `06cb13f7cc75d854` | `e406720f7530bb26` | `e296c1657e604937` |
| PR AUC | 0.9988 | 0.9992 | 0.9993 |
| ROC AUC | 0.9981 | 0.9985 | 0.9987 |
| F1 | 0.9809 | 0.9815 | 0.9846 |
