# Promote PASS — `e45a3b19a1666a00` on `filetypes/python`

Generated 2026-05-21T09:15:37Z

full-train holds — PR_AUC 0.9984 -> 0.9987, AUC 0.9986 -> 0.9989, Brier 0.0155 -> 0.0145
...
|---|---|---|---|
| key | `e45a3b19a1666a00` | `af9163dbb4d0e7ea` | `e30e2677dfb7575e` |
| PR AUC | 0.9984 | 0.9986 | 0.9987 |
| ROC AUC | 0.9986 | 0.9988 | 0.9989 |
| F1 | 0.9792 | 0.9779 | 0.9797 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-e45a3b19a1666a00
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-e45a3b19a1666a00/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-e45a3b19a1666a00
```
