# Promote PASS — `0b2bcff1f826411e` on `filetypes/java_class`

Generated 2026-05-21T07:32:18Z

full-train holds — PR_AUC 0.9967 -> 0.9966, AUC 0.9992 -> 0.9992, Brier 0.0092 -> 0.0089
...
|---|---|---|---|
| key | `0b2bcff1f826411e` | `5a48045d5eee70b7` | `3233f81a8e0421c4` |
| PR AUC | 0.9967 | 0.9966 | 0.9966 |
| ROC AUC | 0.9992 | 0.9992 | 0.9992 |
| F1 | 0.9585 | 0.9740 | 0.9740 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-0b2bcff1f826411e
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-0b2bcff1f826411e/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-0b2bcff1f826411e
```
