# Promote PASS — `a1631fc7b720c45a` on `filetypes/powershell`

Generated 2026-05-26T23:04:35Z

full-train holds — PR_AUC 0.9972 -> 0.9992, AUC 0.9990 -> 0.9988, Brier 0.0130 -> 0.0122
...
|---|---|---|---|
| key | `a1631fc7b720c45a` | `7001795e80db74d0` | `4dfaff55204e652b` |
| PR AUC | 0.9972 | 0.9985 | 0.9992 |
| ROC AUC | 0.9990 | 0.9980 | 0.9988 |
| F1 | 0.9720 | 0.9850 | 0.9864 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-a1631fc7b720c45a
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-a1631fc7b720c45a/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-a1631fc7b720c45a
```
