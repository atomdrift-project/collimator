# Confirm FAIL — f72e5260424e8ac3 on `filegroups/native`

Cycle `20260704T125047-confirm-f72e5260424e8ac3` — 2026-07-04T12:50:47Z
...
COLLIMATOR_EXPERIMENT_TAG=_native_control_tail_threshold_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea native_control_tail_threshold_confirm_seedsearch_3 --route filegroups/native  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_native_control_tail_threshold_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1890: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-07-04T12-50-47_20260704T125047-confirm-f72e5260424e8ac3_native_control_tail_threshold_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `f72e5260424e8ac3` | `` |
