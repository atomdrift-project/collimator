# Promote PASS — `12503da28d9e3536` on `filegroups/portable`

Generated 2026-07-16T04:16:10Z

full-train holds — PR_AUC 0.9920 -> 0.9935, AUC 0.9976 -> 0.9983, Brier 0.0080 -> 0.0077
...
|---|---|---|---|
| key | `12503da28d9e3536` | `ec9b93e3c7f21bbe` | `274d79f29c6e3745` |
| PR AUC | 0.9920 | 0.9934 | 0.9935 |
| ROC AUC | 0.9976 | 0.9983 | 0.9983 |
| F1 | 0.9574 | 0.9639 | 0.9716 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-portable-12503da28d9e3536
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-portable-12503da28d9e3536/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-portable-12503da28d9e3536
```
