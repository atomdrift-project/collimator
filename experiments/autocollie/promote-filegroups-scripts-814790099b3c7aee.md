# Promote REJECTED — `814790099b3c7aee` on `filegroups/scripts`

Generated 2026-05-26T06:10:16Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-05-26T06-01-56_20260526T055259-promote-814790099b3c7aee_azoth-validate.log; tail: wrote /home/t/collimator/out/models/azoth-candidate-filegroups-scripts-814790099b3c7aee/route_policy_eval_oof.json
wrote /home/t/collimator/out/models/azoth-candidate-filegroups-scripts-814790099b3c7aee/route_policy_eval_oof.md
.venv/bin/python scripts/write_azoth_readmes.py --azoth-root /home/t/collimator/out/models/azoth-candidate-filegroups-scripts-814790099b3c7aee
staged runtime azoth bundle: /tmp/tmp.6EmeSCZO5c
azoth bundle ok: /tmp/tmp.6EmeSCZO5c
...
ensemble improvements (≥0.10pp):
  ...
  javascript: L3 hostile ensemble recall +2.67pp (72.12% → 74.79%)
  powershell: L3 hostile ensemble recall +4.23pp (31.15% → 35.38%)
  python: L3 hostile ensemble recall +0.26pp (66.33% → 66.59%)
  shell: L3 hostile ensemble recall +0.12pp (82.78% → 82.91%)
...
per-route improvements (≥0.10pp, informational):
  ...
  python :: filegroups/scripts recall@3FP/M +1.04pp (63.42% → 64.46%)
...
13 low-water-mark improvement(s) (>0.90pp above LWM, informational):
  ...
  + javascript: L3 hostile ensemble recall +8.59pp above LWM (66.20% → 74.79%)
  ...
  + powershell: L3 hostile ensemble recall +5.77pp above LWM (29.62% → 35.38%)
  + pptx: L3 hostile ensemble recall +9.09pp above LWM (9.09% → 18.18%)
  + python: L3 hostile ensemble recall +2.32pp above LWM (64.28% → 66.59%)
...
2 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - batch: L3 hostile ENSEMBLE recall dropped 4.87pp BELOW LOW-WATER-MARK (98.83% → 93.96%; LWM tolerance 0.90pp)
  - php: L3 hostile ENSEMBLE recall dropped 10.74pp BELOW LOW-WATER-MARK (62.11% → 51.37%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `814790099b3c7aee` | `c6c8cb7e7803392d` | `b0a9a86a1ec34692` |
| PR AUC | 0.9979 | 0.9993 | 0.9994 |
| ROC AUC | 0.9977 | 0.9991 | 0.9992 |
| F1 | 0.9774 | 0.9803 | 0.9835 |
