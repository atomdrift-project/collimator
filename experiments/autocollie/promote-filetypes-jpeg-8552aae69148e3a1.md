# Promote PASS — `8552aae69148e3a1` on `filetypes/jpeg`

Generated 2026-06-28T10:29:50Z

full-train holds — PR_AUC 0.9822 -> 0.9888, AUC 0.9888 -> 0.9938, Brier 0.0578 -> 0.0439
...
|---|---|---|---|
| key | `8552aae69148e3a1` | `8afe35b99f1e2d56` | `5490d57a627086b4` |
| PR AUC | 0.9822 | 0.9897 | 0.9888 |
| ROC AUC | 0.9888 | 0.9945 | 0.9938 |
| F1 | 0.9195 | 0.9756 | 0.9756 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-jpeg-8552aae69148e3a1
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-jpeg-8552aae69148e3a1/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-jpeg-8552aae69148e3a1
```
