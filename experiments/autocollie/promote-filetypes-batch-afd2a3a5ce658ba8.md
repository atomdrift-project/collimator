...
|---|---|---|---|
| key | `afd2a3a5ce658ba8` | `85d99936d6bc0aba` | `116d45b78a9f4dbc` |
| PR AUC | 0.9999 | 0.9999 | 0.9999 |
| ROC AUC | 0.9981 | 0.9980 | 0.9979 |
| F1 | 0.9876 | 0.9961 | 0.9959 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-batch-afd2a3a5ce658ba8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-batch-afd2a3a5ce658ba8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-batch-afd2a3a5ce658ba8
```
