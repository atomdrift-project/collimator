# Promote PASS — `54d60f755f1a200c` on `filetypes/go`

Generated 2026-06-01T15:39:25Z

full-train holds — PR_AUC 0.9604 -> 0.9582, AUC 0.9850 -> 0.9879, Brier 0.0415 -> 0.0380

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9604)
...
|---|---|---|---|
| key | `54d60f755f1a200c` | `cdc768b2a51731e8` | `d46743a09e3aa643` |
| PR AUC | 0.9604 | 0.9575 | 0.9582 |
| ROC AUC | 0.9850 | 0.9877 | 0.9879 |
| F1 | 0.8731 | 0.8828 | 0.8811 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-54d60f755f1a200c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-54d60f755f1a200c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-54d60f755f1a200c
```
