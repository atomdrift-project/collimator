# Promote PASS — `d4370388038ba6e8` on `filegroups/config`

Generated 2026-05-25T19:20:54Z

full-train holds — PR_AUC 0.9997 -> 0.9998, AUC 0.9995 -> 0.9995, Brier 0.0054 -> 0.0053
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-d4370388038ba6e8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-d4370388038ba6e8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-d4370388038ba6e8
```
