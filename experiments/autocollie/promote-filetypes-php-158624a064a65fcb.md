# Promote PASS — `158624a064a65fcb` on `filetypes/php`

Generated 2026-05-08T20:27:39Z

full-train holds — F1 1.0000 -> 1.0000, AUC 1.0000 -> 1.0000, recall@FP=0 0.0000 -> 0.0000

## Gates

- **Confirm** (different seed, original profile): **PASS** — F1 held across 3 seeds (orig 1.0000)
...
|---|---|---|---|
| key | `158624a064a65fcb` | `acf757f53ad896f2` | `991208419b26c8d4` |
| F1 | 1.0000 | 0.9971 | 1.0000 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-php-158624a064a65fcb
```
...
EXP_DISABLE_FEATURE_GROUPS=present,maxcrit,clusters,kv,symbols,textenc
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-php-158624a064a65fcb/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the validated bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-php-158624a064a65fcb
```
