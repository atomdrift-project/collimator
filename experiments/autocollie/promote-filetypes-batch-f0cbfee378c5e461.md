# Promote PASS — `f0cbfee378c5e461` on `filetypes/batch`

Generated 2026-06-08T11:19:32Z

full-train holds — PR_AUC 0.9997 -> 0.9997, AUC 0.9973 -> 0.9974, Brier 0.0194 -> 0.0199
...
|---|---|---|---|
| key | `f0cbfee378c5e461` | `d7a0aa8715b1987c` | `596046071f79e1a2` |
| PR AUC | 0.9997 | 0.9997 | 0.9997 |
| ROC AUC | 0.9973 | 0.9972 | 0.9974 |
| F1 | 0.9916 | 0.9930 | 0.9937 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-batch-f0cbfee378c5e461
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-batch-f0cbfee378c5e461/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-batch-f0cbfee378c5e461
```
