# Promote PASS — `3a98aab9cf8d7233` on `filetypes/shell`

Generated 2026-07-10T22:50:32Z

full-train holds — PR_AUC 0.9903 -> 0.9923, AUC 0.9942 -> 0.9952, Brier 0.0201 -> 0.0183
...
|---|---|---|---|
| key | `3a98aab9cf8d7233` | `b1853891d501e035` | `d5cbbe5b8b0b4fb0` |
| PR AUC | 0.9903 | 0.9924 | 0.9923 |
| ROC AUC | 0.9942 | 0.9953 | 0.9952 |
| F1 | 0.9527 | 0.9624 | 0.9622 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-shell-3a98aab9cf8d7233
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-shell-3a98aab9cf8d7233/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-shell-3a98aab9cf8d7233
```
