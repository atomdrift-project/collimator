# Promote PASS — `7ce144367af156b0` on `filetypes/powershell`

Generated 2026-05-21T05:51:56Z

full-train holds — PR_AUC 0.9979 -> 0.9979, AUC 0.9950 -> 0.9951, Brier 0.0233 -> 0.0230
...
|---|---|---|---|
| key | `7ce144367af156b0` | `c47039f0a0ac3cac` | `c313a5d7cf6c9bfb` |
| PR AUC | 0.9979 | 0.9978 | 0.9979 |
| ROC AUC | 0.9950 | 0.9947 | 0.9951 |
| F1 | 0.9841 | 0.9841 | 0.9841 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-7ce144367af156b0
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-7ce144367af156b0/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-7ce144367af156b0
```
