# Promote PASS — `f8d001ce7e89fd43` on `filetypes/powershell`

Generated 2026-07-13T09:19:02Z

full-train holds — PR_AUC 0.9985 -> 0.9987, AUC 0.9948 -> 0.9954, Brier 0.0241 -> 0.0227
...
|---|---|---|---|
| key | `f8d001ce7e89fd43` | `5fe122a2a0680bf9` | `70030371782c48e6` |
| PR AUC | 0.9985 | 0.9988 | 0.9987 |
| ROC AUC | 0.9948 | 0.9956 | 0.9954 |
| F1 | 0.9797 | 0.9851 | 0.9844 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f8d001ce7e89fd43
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f8d001ce7e89fd43/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f8d001ce7e89fd43
```
