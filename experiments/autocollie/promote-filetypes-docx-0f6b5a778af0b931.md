# Promote REJECTED — `0f6b5a778af0b931` on `filetypes/docx`

Generated 2026-05-27T05:17:52Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-05-27T05-14-39_20260527T051433-promote-0f6b5a778af0b931_azoth-validate.log; tail: azoth bundle ok: /tmp/tmp.EKfDn1wRCB
--source-bundle out/models/azoth: 1 routes changed → 1 filetypes impacted, 65 unimpacted (drift treated as pre-existing)

ensemble improvements (≥0.10pp):
  csharp: L3 hostile ensemble recall +8.12pp (25.21% → 33.33%)
  png: L3 hostile ensemble recall +4.72pp (4.26% → 8.98%)
  powershell: L3 hostile ensemble recall +1.15pp (31.15% → 32.31%)
  rust: L3 hostile ensemble recall +3.05pp (1.22% → 4.27%)
...
per-route improvements (≥0.10pp, informational):
  ...
  rust :: filetypes/rust recall@3FP/M +3.66pp (3.05% → 6.71%)
...
17 low-water-mark improvement(s) (>0.90pp above LWM, informational):
  ...
  + rust: L3 hostile ensemble recall +3.05pp above LWM (1.22% → 4.27%)
...
1 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - docx: L3 hostile ENSEMBLE recall dropped 15.34pp BELOW LOW-WATER-MARK (71.59% → 56.25%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `0f6b5a778af0b931` | `4550c9ce8caf699b` | `0f6b5a778af0b931` |
| PR AUC | 0.9970 | 0.9971 | 0.9970 |
| ROC AUC | 0.9830 | 0.9833 | 0.9830 |
| F1 | 0.9956 | 0.9956 | 0.9956 |
