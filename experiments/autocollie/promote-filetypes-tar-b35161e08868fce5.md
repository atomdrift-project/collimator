# Promote PASS — `b35161e08868fce5` on `filetypes/tar`

Generated 2026-05-26T21:42:34Z

full-train holds — PR_AUC 1.0000 -> 0.9999, AUC 1.0000 -> 0.9993, Brier 0.0263 -> 0.0522
...
|---|---|---|---|
| key | `b35161e08868fce5` | `d26bfd023174a69b` | `c9e64700b2909126` |
| PR AUC | 1.0000 | 0.9999 | 0.9999 |
| ROC AUC | 1.0000 | 0.9993 | 0.9993 |
| F1 | 0.9406 | 0.9967 | 0.9967 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-tar-b35161e08868fce5
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-tar-b35161e08868fce5/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-tar-b35161e08868fce5
```
