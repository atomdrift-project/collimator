# Promote PASS — `179877f6350b2515` on `filetypes/lnk`

Generated 2026-06-08T02:25:08Z

full-train holds — PR_AUC 0.9952 -> 0.9958, AUC 0.9792 -> 0.9805, Brier 0.1235 -> 0.1222

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9952)
...
|---|---|---|---|
| key | `179877f6350b2515` | `4854f3f4401bcf35` | `747b9e9282e26253` |
| PR AUC | 0.9952 | 0.9957 | 0.9958 |
| ROC AUC | 0.9792 | 0.9806 | 0.9805 |
| F1 | 0.9115 | 0.9834 | 0.9817 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-179877f6350b2515
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-179877f6350b2515/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-179877f6350b2515
```
