# Promote PASS — `8f875a32c7cf0244` on `filetypes/go`

Generated 2026-06-01T15:26:44Z

full-train holds — PR_AUC 0.9646 -> 0.9649, AUC 0.9872 -> 0.9900, Brier 0.0391 -> 0.0329

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9646)
...
|---|---|---|---|
| key | `8f875a32c7cf0244` | `bca9b456090b193c` | `f84ee6bec7b60a18` |
| PR AUC | 0.9646 | 0.9631 | 0.9649 |
| ROC AUC | 0.9872 | 0.9895 | 0.9900 |
| F1 | 0.8835 | 0.8744 | 0.9067 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-8f875a32c7cf0244
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-8f875a32c7cf0244/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-8f875a32c7cf0244
```
