# Promote PASS — `06286cbe76e7018a` on `filetypes/php`

Generated 2026-07-06T08:55:39Z

full-train holds — PR_AUC 0.9836 -> 0.9863, AUC 0.9959 -> 0.9965, Brier 0.0102 -> 0.0094

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9836)
...
|---|---|---|---|
| key | `06286cbe76e7018a` | `125e51db04aebdae` | `0cec0c3982c5a9fe` |
| PR AUC | 0.9836 | 0.9870 | 0.9863 |
| ROC AUC | 0.9959 | 0.9967 | 0.9965 |
| F1 | 0.9505 | 0.9549 | 0.9562 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-php-06286cbe76e7018a
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-php-06286cbe76e7018a/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-php-06286cbe76e7018a
```
