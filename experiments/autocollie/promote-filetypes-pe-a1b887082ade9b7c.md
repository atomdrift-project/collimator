# Promote PASS — `a1b887082ade9b7c` on `filetypes/pe`

Generated 2026-07-12T21:48:15Z

full-train holds — PR_AUC 0.9989 -> 0.9999, AUC 0.9989 -> 0.9998, Brier 0.0109 -> 0.0051
...
|---|---|---|---|
| key | `a1b887082ade9b7c` | `c620cc7dc2051b2c` | `e43f63f5961849b1` |
| PR AUC | 0.9989 | 1.0000 | 0.9999 |
| ROC AUC | 0.9989 | 0.9998 | 0.9998 |
| F1 | 0.9859 | 0.9981 | 0.9957 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pe-a1b887082ade9b7c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pe-a1b887082ade9b7c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pe-a1b887082ade9b7c
```
