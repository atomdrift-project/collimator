# Promote PASS — `7b4e830487cd47b3` on `filetypes/makefile`

Generated 2026-05-27T05:39:27Z

full-train holds — PR_AUC 0.2084 -> 0.9501, AUC 0.9078 -> 0.9996, Brier 0.0062 -> 0.0015

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.2084)
...
|---|---|---|---|
| key | `7b4e830487cd47b3` | `c1ec303e156eed55` | `8cdedfd52f49dc78` |
| PR AUC | 0.2084 | 0.9167 | 0.9501 |
| ROC AUC | 0.9078 | 0.9994 | 0.9996 |
| F1 | 0.1250 | 0.9091 | 0.9091 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-7b4e830487cd47b3
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-7b4e830487cd47b3/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-7b4e830487cd47b3
```
