# Promote PASS — `47c470ac2d8eabe3` on `filetypes/c`

Generated 2026-05-26T04:01:49Z

full-train holds — PR_AUC 0.9917 -> 0.9925, AUC 0.9955 -> 0.9959, Brier 0.0241 -> 0.0225

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9917)
...
|---|---|---|---|
| key | `47c470ac2d8eabe3` | `a4475c2a6d4169c2` | `f1d8b95e3d3fe2bb` |
| PR AUC | 0.9917 | 0.9925 | 0.9925 |
| ROC AUC | 0.9955 | 0.9959 | 0.9959 |
| F1 | 0.9542 | 0.9566 | 0.9545 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-47c470ac2d8eabe3
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-47c470ac2d8eabe3/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-47c470ac2d8eabe3
```
