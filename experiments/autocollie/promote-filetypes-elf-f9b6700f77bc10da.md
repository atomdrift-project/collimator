# Promote PASS — `f9b6700f77bc10da` on `filetypes/elf`

Generated 2026-06-13T02:35:31Z

full-train holds — PR_AUC 0.9999 -> 1.0000, AUC 0.9998 -> 1.0000, Brier 0.0037 -> 0.0020
...
|---|---|---|---|
| key | `f9b6700f77bc10da` | `40a481de87a5f924` | `98db35a4248cc7cb` |
| PR AUC | 0.9999 | 1.0000 | 1.0000 |
| ROC AUC | 0.9998 | 1.0000 | 1.0000 |
| F1 | 0.9957 | 0.9979 | 0.9978 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-elf-f9b6700f77bc10da
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-elf-f9b6700f77bc10da/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-elf-f9b6700f77bc10da
```
