# Promote PASS — `9cf44f8590ec25dc` on `filetypes/package.json`

Generated 2026-05-26T18:35:57Z

full-train holds — PR_AUC 0.9998 -> 0.9999, AUC 0.9995 -> 0.9997, Brier 0.0045 -> 0.0042
...
|---|---|---|---|
| key | `9cf44f8590ec25dc` | `ddacf34629937b8a` | `5f551b6177f314ff` |
| PR AUC | 0.9998 | 0.9998 | 0.9999 |
| ROC AUC | 0.9995 | 0.9995 | 0.9997 |
| F1 | 0.9962 | 0.9960 | 0.9965 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-9cf44f8590ec25dc
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-9cf44f8590ec25dc/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-9cf44f8590ec25dc
```
