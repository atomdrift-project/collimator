# Promote PASS — `c09cff946dc8778b` on `filetypes/rust`

Generated 2026-06-17T18:27:12Z

full-train holds — PR_AUC 0.9073 -> 0.9099, AUC 0.9908 -> 0.9925, Brier 0.0143 -> 0.0146

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9073)
...
|---|---|---|---|
| key | `c09cff946dc8778b` | `3702d061e44644e4` | `d16827b429d61da7` |
| PR AUC | 0.9073 | 0.9169 | 0.9099 |
| ROC AUC | 0.9908 | 0.9934 | 0.9925 |
| F1 | 0.8636 | 0.8333 | 0.8261 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-rust-c09cff946dc8778b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-rust-c09cff946dc8778b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-rust-c09cff946dc8778b
```
