# Promote PASS — `99dea27e96a2e219` on `filetypes/c`

Generated 2026-06-06T14:07:04Z

full-train holds — PR_AUC 0.9888 -> 0.9890, AUC 0.9954 -> 0.9953, Brier 0.0213 -> 0.0210

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9888)
...
|---|---|---|---|
| key | `99dea27e96a2e219` | `39b8f3f53b882790` | `dbaaac4fa24f8645` |
| PR AUC | 0.9888 | 0.9889 | 0.9890 |
| ROC AUC | 0.9954 | 0.9951 | 0.9953 |
| F1 | 0.9467 | 0.9474 | 0.9476 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-99dea27e96a2e219
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-99dea27e96a2e219/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-99dea27e96a2e219
```
