# Promote PASS — `309e881381696cb6` on `filetypes/go`

Generated 2026-06-01T15:43:40Z

full-train holds — PR_AUC 0.9625 -> 0.9671, AUC 0.9858 -> 0.9901, Brier 0.0385 -> 0.0337

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9625)
...
|---|---|---|---|
| key | `309e881381696cb6` | `af41bcc881482014` | `a8ca73b3b6017547` |
| PR AUC | 0.9625 | 0.9648 | 0.9671 |
| ROC AUC | 0.9858 | 0.9897 | 0.9901 |
| F1 | 0.8765 | 0.8895 | 0.8866 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-309e881381696cb6
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-309e881381696cb6/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-309e881381696cb6
```
