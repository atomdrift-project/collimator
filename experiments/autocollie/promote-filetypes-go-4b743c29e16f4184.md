...
- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9431)
...
|---|---|---|---|
| key | `4b743c29e16f4184` | `b097a5fafd9a79cf` | `82dde713884d9c73` |
| PR AUC | 0.9431 | 0.9461 | 0.9446 |
| ROC AUC | 0.9849 | 0.9857 | 0.9849 |
| F1 | 0.8578 | 0.8789 | 0.8868 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-4b743c29e16f4184
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-4b743c29e16f4184/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-4b743c29e16f4184
```
