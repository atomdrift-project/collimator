# Promote PASS — `cffc66349f493b55` on `filetypes/powershell`

Generated 2026-07-23T05:04:30Z

full-train holds — PR_AUC 0.9986 -> 0.9988, AUC 0.9948 -> 0.9955, Brier 0.0214 -> 0.0209
...
|---|---|---|---|
| key | `cffc66349f493b55` | `9d6f1d90a035bce1` | `28cf6f164e1e1192` |
| PR AUC | 0.9986 | 0.9989 | 0.9988 |
| ROC AUC | 0.9948 | 0.9956 | 0.9955 |
| F1 | 0.9857 | 0.9865 | 0.9886 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-cffc66349f493b55
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-cffc66349f493b55/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-cffc66349f493b55
```
