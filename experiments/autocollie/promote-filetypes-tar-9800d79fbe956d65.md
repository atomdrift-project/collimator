# Promote PASS — `9800d79fbe956d65` on `filetypes/tar`

Generated 2026-05-25T20:18:15Z
...
|---|---|---|---|
| key | `9800d79fbe956d65` | `e413690766a95833` | `5718aeec829240a8` |
| PR AUC | 1.0000 | 0.9999 | 0.9999 |
| ROC AUC | 1.0000 | 0.9993 | 0.9993 |
| F1 | 1.0000 | 0.9967 | 0.9967 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-tar-9800d79fbe956d65
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-tar-9800d79fbe956d65/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-tar-9800d79fbe956d65
```
