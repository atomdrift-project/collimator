# Promote PASS — `515db4011d4c89d5` on `filetypes/c`

Generated 2026-06-01T15:03:00Z

full-train holds — PR_AUC 0.9909 -> 0.9900, AUC 0.9950 -> 0.9952, Brier 0.0254 -> 0.0249
...
|---|---|---|---|
| key | `515db4011d4c89d5` | `734f56e86c6d78f0` | `cb9f05edcb9522c1` |
| PR AUC | 0.9909 | 0.9898 | 0.9900 |
| ROC AUC | 0.9950 | 0.9950 | 0.9952 |
| F1 | 0.9488 | 0.9389 | 0.9457 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-515db4011d4c89d5
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-515db4011d4c89d5/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-515db4011d4c89d5
```
