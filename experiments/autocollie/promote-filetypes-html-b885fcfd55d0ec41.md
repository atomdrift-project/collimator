# Promote PASS — `b885fcfd55d0ec41` on `filetypes/html`

Generated 2026-05-25T21:42:54Z
...
|---|---|---|---|
| key | `b885fcfd55d0ec41` | `8593ac3c5f66426f` | `88f5d1add504684c` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-html-b885fcfd55d0ec41
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-html-b885fcfd55d0ec41/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-html-b885fcfd55d0ec41
```
