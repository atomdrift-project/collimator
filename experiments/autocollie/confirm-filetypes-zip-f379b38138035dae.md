# Confirm FAIL — f379b38138035dae on `filetypes/zip`

Cycle `20260615T015128-confirm-f379b38138035dae` — 2026-06-15T01:51:28Z
...
COLLIMATOR_EXPERIMENT_TAG=_zip_textmetrics_encoding_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea zip_textmetrics_encoding_confirm_seedsearch_3 --route filetypes/zip  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_zip_textmetrics_encoding_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1851: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-15T01-51-28_20260615T015128-confirm-f379b38138035dae_zip_textmetrics_encoding_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `f379b38138035dae` | `` |
