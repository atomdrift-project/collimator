# Confirm FAIL — 518a5a9843bcaf21 on `filetypes/pe`

Cycle `20260606T163023-confirm-518a5a9843bcaf21` — 2026-06-06T16:30:23Z
...
COLLIMATOR_EXPERIMENT_TAG=_pe_train_reg_lambda3_depth10_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_pe_train_reg_lambda3_depth10_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1826: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-06T16-30-23_20260606T163023-confirm-518a5a9843bcaf21_pe_train_reg_lambda3_depth10_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `518a5a9843bcaf21` | `` |
