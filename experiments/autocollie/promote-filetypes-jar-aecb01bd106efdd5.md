# Promote PASS — `aecb01bd106efdd5` on `filetypes/jar`

Generated 2026-07-11T14:41:52Z

full-train holds — PR_AUC 0.9844 -> 0.9871, AUC 0.9818 -> 0.9851, Brier 0.0543 -> 0.0485

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9844)
...
|---|---|---|---|
| key | `aecb01bd106efdd5` | `9388f031b7766db3` | `4f22c9a5fb3afb4d` |
| PR AUC | 0.9844 | 0.9862 | 0.9871 |
| ROC AUC | 0.9818 | 0.9842 | 0.9851 |
| F1 | 0.9285 | 0.9389 | 0.9475 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-jar-aecb01bd106efdd5
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-jar-aecb01bd106efdd5/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-jar-aecb01bd106efdd5
```
