# Promote PASS — `f1a86ac2e2b98d7c` on `filegroups/source`

Generated 2026-06-14T01:20:02Z

full-train holds — PR_AUC 0.9990 -> 0.9975, AUC 0.9982 -> 0.9972, Brier 0.0161 -> 0.0183
...
|---|---|---|---|
| key | `f1a86ac2e2b98d7c` | `cc4ff294540b726f` | `a64d373bfca66632` |
| PR AUC | 0.9990 | 0.9974 | 0.9975 |
| ROC AUC | 0.9982 | 0.9971 | 0.9972 |
| F1 | 0.9822 | 0.9690 | 0.9712 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-source-f1a86ac2e2b98d7c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-source-f1a86ac2e2b98d7c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-source-f1a86ac2e2b98d7c
```
