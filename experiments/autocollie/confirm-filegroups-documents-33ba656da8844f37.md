# Confirm FAIL — 33ba656da8844f37 on `filegroups/documents`

Cycle `20260601T163643-confirm-33ba656da8844f37` — 2026-06-01T16:36:43Z
...
COLLIMATOR_DOCUMENT_OBFUSCATION_FEATURES=1 \
COLLIMATOR_TIERED_BIGRAM_BRANCH_MIN_CRIT= \
COLLIMATOR_EXPERIMENT_TAG=_docs_obfuscation_line_buckets_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea docs_obfuscation_line_buckets_confirm_seedsearch_3 --route filegroups/documents  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_docs_obfuscation_line_buckets_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1573: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-01T16-36-43_20260601T163643-confirm-33ba656da8844f37_docs_obfuscation_line_buckets_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `33ba656da8844f37` | `` |
