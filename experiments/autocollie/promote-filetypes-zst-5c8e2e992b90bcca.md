# Promote PASS — `5c8e2e992b90bcca` on `filetypes/zst`

Generated 2026-05-26T19:04:59Z
...
|---|---|---|---|
| key | `5c8e2e992b90bcca` | `cf1fb4fc8b10016c` | `bf69264d30ab4378` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zst-5c8e2e992b90bcca
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zst-5c8e2e992b90bcca/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zst-5c8e2e992b90bcca
```
