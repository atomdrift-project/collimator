# Promote PASS — `f16563158733e06f` on `filetypes/powershell`

Generated 2026-06-14T21:25:34Z

full-train holds — PR_AUC 0.9953 -> 0.9957, AUC 0.9883 -> 0.9895, Brier 0.0529 -> 0.0532
...
|---|---|---|---|
| key | `f16563158733e06f` | `8241f915d8ef99f8` | `9ef2ab88ae2e715e` |
| PR AUC | 0.9953 | 0.9954 | 0.9957 |
| ROC AUC | 0.9883 | 0.9888 | 0.9895 |
| F1 | 0.9643 | 0.9378 | 0.9463 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f16563158733e06f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f16563158733e06f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f16563158733e06f
```
