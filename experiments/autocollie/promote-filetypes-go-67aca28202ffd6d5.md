# Promote PASS — `67aca28202ffd6d5` on `filetypes/go`

Generated 2026-07-13T02:31:06Z

full-train holds — PR_AUC 0.9480 -> 0.9502, AUC 0.9748 -> 0.9771, Brier 0.0352 -> 0.0354

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9480)
...
|---|---|---|---|
| key | `67aca28202ffd6d5` | `c87b084ef1b1d7da` | `30f70ca56f4afa49` |
| PR AUC | 0.9480 | 0.9490 | 0.9502 |
| ROC AUC | 0.9748 | 0.9762 | 0.9771 |
| F1 | 0.8805 | 0.8889 | 0.8892 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-67aca28202ffd6d5
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-67aca28202ffd6d5/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-67aca28202ffd6d5
```
