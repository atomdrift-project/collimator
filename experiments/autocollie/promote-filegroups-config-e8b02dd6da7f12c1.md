# Promote PASS — `e8b02dd6da7f12c1` on `filegroups/config`

Generated 2026-05-15T06:13:19Z

full-train holds — PR_AUC 0.9999 -> 0.9999, AUC 0.9997 -> 0.9998, Brier 0.0056 -> 0.0053
...
|---|---|---|---|
| key | `e8b02dd6da7f12c1` | `ffbbb934ef2b7bad` | `99d6c30a25ae9277` |
| PR AUC | 0.9999 | 0.9999 | 0.9999 |
| ROC AUC | 0.9997 | 0.9997 | 0.9998 |
| F1 | 0.9936 | 0.9954 | 0.9951 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-e8b02dd6da7f12c1
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-e8b02dd6da7f12c1/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-e8b02dd6da7f12c1
```
