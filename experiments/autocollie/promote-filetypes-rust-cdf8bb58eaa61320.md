# Promote PASS — `cdf8bb58eaa61320` on `filetypes/rust`

Generated 2026-05-27T05:35:34Z

full-train holds — PR_AUC 0.8923 -> 0.8929, AUC 0.9862 -> 0.9881, Brier 0.0348 -> 0.0296

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.8923)
...
|---|---|---|---|
| key | `cdf8bb58eaa61320` | `8a22ad28dcea0930` | `84b3e37edb1a9147` |
| PR AUC | 0.8923 | 0.8908 | 0.8929 |
| ROC AUC | 0.9862 | 0.9874 | 0.9881 |
| F1 | 0.7500 | 0.7879 | 0.8387 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-rust-cdf8bb58eaa61320
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-rust-cdf8bb58eaa61320/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-rust-cdf8bb58eaa61320
```
