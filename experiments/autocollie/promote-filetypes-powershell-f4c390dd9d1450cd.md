# Promote PASS — `f4c390dd9d1450cd` on `filetypes/powershell`

Generated 2026-08-04T22:19:35Z

full-train holds — PR_AUC 0.9936 -> 0.9940, AUC 0.9903 -> 0.9910, Brier 0.0419 -> 0.0407

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9936)
...
|---|---|---|---|
| key | `f4c390dd9d1450cd` | `96252e58859a8504` | `cf17262b74be001b` |
| PR AUC | 0.9936 | 0.9940 | 0.9940 |
| ROC AUC | 0.9903 | 0.9908 | 0.9910 |
| F1 | 0.9481 | 0.9650 | 0.9624 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f4c390dd9d1450cd
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f4c390dd9d1450cd/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-f4c390dd9d1450cd
```
