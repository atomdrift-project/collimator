# Promote PASS — `cea25fee1d916b0b` on `filetypes/package.json`

Generated 2026-05-25T18:22:37Z

full-train holds — PR_AUC 0.9998 -> 0.9998, AUC 0.9996 -> 0.9997, Brier 0.0043 -> 0.0041
...
|---|---|---|---|
| key | `cea25fee1d916b0b` | `f03bdb386f32aee5` | `dec24962b1a54f1a` |
| PR AUC | 0.9998 | 0.9997 | 0.9998 |
| ROC AUC | 0.9996 | 0.9994 | 0.9997 |
| F1 | 0.0000 | 0.9947 | 0.9952 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-cea25fee1d916b0b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-cea25fee1d916b0b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-cea25fee1d916b0b
```
