# Promote PASS — `fef3a5f7bf54badd` on `filetypes/pe`

Generated 2026-07-03T06:12:19Z
...
|---|---|---|---|
| key | `fef3a5f7bf54badd` | `055c6f444bbbf55f` | `cfd89c242cf76a3c` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pe-fef3a5f7bf54badd
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pe-fef3a5f7bf54badd/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pe-fef3a5f7bf54badd
```
