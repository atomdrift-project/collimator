# Confirm FAIL — 3d35f5a56cfb6b08 on `filetypes/javascript`

Cycle `20260615T015129-confirm-3d35f5a56cfb6b08` — 2026-06-15T01:51:29Z
...
COLLIMATOR_EXPERIMENT_TAG=_inherit_from_filetypes_json_eb5cd709_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea inherit_from_filetypes_json_eb5cd709_confirm_seedsearch_3 --route filetypes/javascript  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_inherit_from_filetypes_json_eb5cd709_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1851: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-15T01-51-29_20260615T015129-confirm-3d35f5a56cfb6b08_inherit_from_filetypes_json_eb5cd709_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `3d35f5a56cfb6b08` | `` |
| PR AUC | 0.9971 | 0.0000 |
| ROC AUC | 0.9964 | 0.0000 |
| Recall@3FPM | — | 0.0000 |
| verdict | — | FAIL |
