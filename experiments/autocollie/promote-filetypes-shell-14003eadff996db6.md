# Promote PASS — `14003eadff996db6` on `filetypes/shell`

Generated 2026-06-18T01:56:00Z

full-train holds — PR_AUC 0.9973 -> 0.9975, AUC 0.9974 -> 0.9975, Brier 0.0179 -> 0.0173

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9973)
...
|---|---|---|---|
| key | `14003eadff996db6` | `36fd72f6bc4de2e3` | `731698b713926390` |
| PR AUC | 0.9973 | 0.9975 | 0.9975 |
| ROC AUC | 0.9974 | 0.9976 | 0.9975 |
| F1 | 0.9747 | 0.9773 | 0.9750 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-shell-14003eadff996db6
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-shell-14003eadff996db6/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-shell-14003eadff996db6
```
