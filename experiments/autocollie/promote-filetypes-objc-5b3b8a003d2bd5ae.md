# Promote PASS — `5b3b8a003d2bd5ae` on `filetypes/objc`

Generated 2026-05-25T21:31:48Z

full-train holds — PR_AUC 0.0000 -> 0.0000, AUC 0.0000 -> 0.0000, Brier 0.0000 -> 0.0000

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.0000)
...
|---|---|---|---|
| key | `5b3b8a003d2bd5ae` | `b8c11404f19fc7e6` | `e549d0c7a4b23076` |
| PR AUC | 0.0000 | 0.0000 | 0.0000 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-objc-5b3b8a003d2bd5ae
```
...
EXP_TIERED_TRIGRAM_PATH_DEPTH=6
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-objc-5b3b8a003d2bd5ae/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-objc-5b3b8a003d2bd5ae
```
