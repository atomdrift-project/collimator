# Promote PASS — `9c76652f270f3fb3` on `filetypes/perl`

Generated 2026-05-21T02:34:37Z

full-train holds — PR_AUC 0.9978 -> 0.9940, AUC 0.9998 -> 0.9994, Brier 0.0096 -> 0.0096
...
|---|---|---|---|
| key | `9c76652f270f3fb3` | `d65f0ce1ea65da7f` | `ed1c500ab13545a5` |
| PR AUC | 0.9978 | 0.9940 | 0.9940 |
| ROC AUC | 0.9998 | 0.9994 | 0.9994 |
| F1 | 0.9231 | 0.9333 | 0.9333 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-perl-9c76652f270f3fb3
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-perl-9c76652f270f3fb3/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-perl-9c76652f270f3fb3
```
