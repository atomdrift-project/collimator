# Promote PASS — `1859f5dae78c85ea` on `filetypes/pdf`

Generated 2026-05-26T18:50:30Z
...
|---|---|---|---|
| key | `1859f5dae78c85ea` | `243ef4e7f888dff1` | `08fd43faeb57edfe` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-1859f5dae78c85ea
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-1859f5dae78c85ea/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-1859f5dae78c85ea
```
