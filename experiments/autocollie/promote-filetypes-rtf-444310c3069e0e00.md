# Promote PASS — `444310c3069e0e00` on `filetypes/rtf`

Generated 2026-07-11T09:34:44Z

full-train holds — PR_AUC 0.9995 -> 0.9995, AUC 0.9977 -> 0.9976, Brier 0.0202 -> 0.0203
...
|---|---|---|---|
| key | `444310c3069e0e00` | `2d0d707812ddb78c` | `3e8ac416d74c7c12` |
| PR AUC | 0.9995 | 0.9997 | 0.9995 |
| ROC AUC | 0.9977 | 0.9985 | 0.9976 |
| F1 | 0.9861 | 0.9944 | 0.9865 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-444310c3069e0e00
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-444310c3069e0e00/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-rtf-444310c3069e0e00
```
