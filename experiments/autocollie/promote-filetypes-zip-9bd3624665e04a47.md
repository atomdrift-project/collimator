# Promote PASS — `9bd3624665e04a47` on `filetypes/zip`

Generated 2026-06-14T04:16:29Z

full-train holds — PR_AUC 0.9997 -> 0.9996, AUC 0.9962 -> 0.9967, Brier 0.0147 -> 0.0101
...
|---|---|---|---|
| key | `9bd3624665e04a47` | `752565af38dd0934` | `771b0a1d0608ffab` |
| PR AUC | 0.9997 | 0.9996 | 0.9996 |
| ROC AUC | 0.9962 | 0.9965 | 0.9967 |
| F1 | 0.9937 | 0.9939 | 0.9941 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zip-9bd3624665e04a47
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zip-9bd3624665e04a47/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zip-9bd3624665e04a47
```
