# Promote PASS — `fcb2e28d1f892bf8` on `filetypes/chrome-manifest`

Generated 2026-05-27T01:59:38Z

full-train holds — PR_AUC 0.8588 -> 0.8588, AUC 0.9385 -> 0.9385, Brier 0.0573 -> 0.0573

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.8588)
...
|---|---|---|---|
| key | `fcb2e28d1f892bf8` | `4f3ba94b130b75db` | `fcb2e28d1f892bf8` |
| PR AUC | 0.8588 | 0.8833 | 0.8588 |
| ROC AUC | 0.9385 | 0.9641 | 0.9385 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-chrome-manifest-fcb2e28d1f892bf8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-chrome-manifest-fcb2e28d1f892bf8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-chrome-manifest-fcb2e28d1f892bf8
```
