# Promote PASS — `8433988f4abefff8` on `filetypes/package.json`

Generated 2026-05-26T17:27:58Z

full-train holds — PR_AUC 0.9998 -> 0.9998, AUC 0.9996 -> 0.9997, Brier 0.0042 -> 0.0041
...
|---|---|---|---|
| key | `8433988f4abefff8` | `116ab1d39ef4e9a8` | `dec24962b1a54f1a` |
| PR AUC | 0.9998 | 0.9998 | 0.9998 |
| ROC AUC | 0.9996 | 0.9995 | 0.9997 |
| F1 | 0.9962 | 0.9949 | 0.9952 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-8433988f4abefff8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-8433988f4abefff8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-8433988f4abefff8
```
