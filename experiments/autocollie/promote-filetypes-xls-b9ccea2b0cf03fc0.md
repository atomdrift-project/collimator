# Promote PASS — `b9ccea2b0cf03fc0` on `filetypes/xls`

Generated 2026-05-26T17:48:42Z

full-train holds — PR_AUC 0.9999 -> 0.9999, AUC 0.9996 -> 0.9996, Brier 0.0063 -> 0.0069
...
|---|---|---|---|
| key | `b9ccea2b0cf03fc0` | `3fd51891edff5254` | `10a598cec26f8162` |
| PR AUC | 0.9999 | 0.9999 | 0.9999 |
| ROC AUC | 0.9996 | 0.9996 | 0.9996 |
| F1 | 0.9947 | 0.9932 | 0.9925 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xls-b9ccea2b0cf03fc0
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xls-b9ccea2b0cf03fc0/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xls-b9ccea2b0cf03fc0
```
