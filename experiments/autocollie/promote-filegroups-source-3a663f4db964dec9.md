# Promote PASS — `3a663f4db964dec9` on `filegroups/source`

Generated 2026-06-01T14:46:05Z

full-train holds — PR_AUC 0.9991 -> 0.9990, AUC 0.9983 -> 0.9984, Brier 0.0206 -> 0.0189
...
|---|---|---|---|
| key | `3a663f4db964dec9` | `d26f630cb0296c50` | `b614ed327a051653` |
| PR AUC | 0.9991 | 0.9989 | 0.9990 |
| ROC AUC | 0.9983 | 0.9982 | 0.9984 |
| F1 | 0.9838 | 0.9789 | 0.9780 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-source-3a663f4db964dec9
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-source-3a663f4db964dec9/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-source-3a663f4db964dec9
```
