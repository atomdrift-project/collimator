# Promote PASS — `3e0026f75c6b06cc` on `filetypes/ole`

Generated 2026-06-08T00:47:53Z

full-train holds — PR_AUC 0.9966 -> 0.9973, AUC 0.9960 -> 0.9966, Brier 0.0948 -> 0.0945
...
|---|---|---|---|
| key | `3e0026f75c6b06cc` | `23461c3e6b7c0e05` | `6d5d308c49003fc7` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3e0026f75c6b06cc
```
...
EXP_DISABLE_FEATURE_GROUPS=clusters,symbols
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3e0026f75c6b06cc/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3e0026f75c6b06cc
```
