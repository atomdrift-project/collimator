# Promote PASS — `a2fe1f641a4aa12d` on `filetypes/java`

Generated 2026-06-13T02:44:23Z

full-train holds — PR_AUC 0.9581 -> 0.9698, AUC 0.9594 -> 0.9663, Brier 0.0482 -> 0.0411

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9581)
...
|---|---|---|---|
| key | `a2fe1f641a4aa12d` | `cf47478680c84ac1` | `d01c91d689e6001b` |
| PR AUC | 0.9581 | 0.9721 | 0.9698 |
| ROC AUC | 0.9594 | 0.9683 | 0.9663 |
| F1 | 0.8493 | 0.9552 | 0.9552 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java-a2fe1f641a4aa12d
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java-a2fe1f641a4aa12d/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java-a2fe1f641a4aa12d
```
