# Promote PASS — `9ffb481f93a4149b` on `filegroups/native`

Generated 2026-07-13T14:47:42Z

full-train holds — PR_AUC 0.9992 -> 0.9999, AUC 0.9992 -> 0.9999, Brier 0.0087 -> 0.0038
...
|---|---|---|---|
| key | `9ffb481f93a4149b` | `b2c1ded8ebe044e6` | `e7c3e56627fce435` |
| PR AUC | 0.9992 | 1.0000 | 0.9999 |
| ROC AUC | 0.9992 | 0.9999 | 0.9999 |
| F1 | 0.9894 | 0.9977 | 0.9955 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-native-9ffb481f93a4149b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-native-9ffb481f93a4149b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-native-9ffb481f93a4149b
```
