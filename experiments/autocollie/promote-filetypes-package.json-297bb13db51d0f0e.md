# Promote PASS — `297bb13db51d0f0e` on `filetypes/package.json`

Generated 2026-05-26T18:23:31Z
...
|---|---|---|---|
| key | `297bb13db51d0f0e` | `db2344c42fb69f33` | `78224b4ef716fe70` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-297bb13db51d0f0e
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-297bb13db51d0f0e/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-297bb13db51d0f0e
```
