# Promote PASS — `c90f8346d185009d` on `filegroups/config`

Generated 2026-05-25T18:07:34Z

full-train holds — PR_AUC 0.9998 -> 0.9997, AUC 0.9995 -> 0.9995, Brier 0.0053 -> 0.0051
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-c90f8346d185009d
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-c90f8346d185009d/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-c90f8346d185009d
```
