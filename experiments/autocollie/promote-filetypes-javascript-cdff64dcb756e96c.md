# Promote PASS — `cdff64dcb756e96c` on `filetypes/javascript`

Generated 2026-05-26T07:27:51Z

full-train holds — PR_AUC 0.9993 -> 0.9996, AUC 0.9988 -> 0.9995, Brier 0.0128 -> 0.0082
...
|---|---|---|---|
| key | `cdff64dcb756e96c` | `adb0f9bbb971863d` | `e27d0809d9d43719` |
| PR AUC | 0.9993 | 0.9996 | 0.9996 |
| ROC AUC | 0.9988 | 0.9994 | 0.9995 |
| F1 | 0.9865 | 0.9858 | 0.9879 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-cdff64dcb756e96c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-cdff64dcb756e96c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-javascript-cdff64dcb756e96c
```
