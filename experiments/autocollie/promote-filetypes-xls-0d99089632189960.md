# Promote PASS — `0d99089632189960` on `filetypes/xls`

Generated 2026-06-07T20:57:32Z

full-train holds — PR_AUC 0.9998 -> 0.9998, AUC 0.9980 -> 0.9979, Brier 0.0130 -> 0.0135
...
|---|---|---|---|
| key | `0d99089632189960` | `b098fb6d82670210` | `c2562bc449a2c9ad` |
| PR AUC | 0.9998 | 0.9998 | 0.9998 |
| ROC AUC | 0.9980 | 0.9980 | 0.9979 |
| F1 | 0.9877 | 0.9946 | 0.9946 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xls-0d99089632189960
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xls-0d99089632189960/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xls-0d99089632189960
```
