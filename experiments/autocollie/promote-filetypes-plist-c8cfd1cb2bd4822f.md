# Promote PASS — `c8cfd1cb2bd4822f` on `filetypes/plist`

Generated 2026-08-25T20:22:07Z

full-train holds — PR_AUC 0.1506 -> 0.1637, AUC 0.7603 -> 0.7733, Brier 0.0080 -> 0.0122

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.1506)
...
|---|---|---|---|
| key | `c8cfd1cb2bd4822f` | `8c96ed1be4740ee1` | `a362ef6c6f40a877` |
| PR AUC | 0.1506 | 0.1672 | 0.1637 |
| ROC AUC | 0.7603 | 0.7682 | 0.7733 |
| F1 | 0.2367 | 0.3025 | 0.2880 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-plist-c8cfd1cb2bd4822f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-plist-c8cfd1cb2bd4822f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-plist-c8cfd1cb2bd4822f
```
