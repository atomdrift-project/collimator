# Promote PASS — `58fffcf3474fe8f8` on `filetypes/package.json`

Generated 2026-07-11T18:16:47Z

full-train holds — PR_AUC 0.9977 -> 0.9978, AUC 0.9980 -> 0.9981, Brier 0.0072 -> 0.0062
...
|---|---|---|---|
| key | `58fffcf3474fe8f8` | `be235feffce8a6a8` | `0a55c140f11ad470` |
| PR AUC | 0.9977 | 0.9978 | 0.9978 |
| ROC AUC | 0.9980 | 0.9981 | 0.9981 |
| F1 | 0.9883 | 0.9903 | 0.9905 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-58fffcf3474fe8f8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-58fffcf3474fe8f8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-package.json-58fffcf3474fe8f8
```
