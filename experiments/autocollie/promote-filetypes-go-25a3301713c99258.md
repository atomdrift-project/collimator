# Promote PASS — `25a3301713c99258` on `filetypes/go`

Generated 2026-05-26T08:03:28Z

full-train holds — PR_AUC 0.9601 -> 0.9699, AUC 0.9871 -> 0.9906, Brier 0.0394 -> 0.0334

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9601)
...
|---|---|---|---|
| key | `25a3301713c99258` | `2223fd93c0e73dd4` | `d0ecb304ac6e9a05` |
| PR AUC | 0.9601 | 0.9715 | 0.9699 |
| ROC AUC | 0.9871 | 0.9909 | 0.9906 |
| F1 | 0.9029 | 0.9167 | 0.9071 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-25a3301713c99258
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-25a3301713c99258/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-25a3301713c99258
```
