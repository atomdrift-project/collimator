# Promote PASS — `f6f53fb9cedf444a` on `filetypes/makefile`

Generated 2026-05-27T06:18:17Z
...
|---|---|---|---|
| key | `f6f53fb9cedf444a` | `8fd0d3a6d0d550ce` | `7e2d354a141a9fd7` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-f6f53fb9cedf444a
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-f6f53fb9cedf444a/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-makefile-f6f53fb9cedf444a
```
