# Promote PASS — `96b9ab2fb3ee43cf` on `filetypes/powershell`

Generated 2026-06-14T21:37:12Z

full-train holds — PR_AUC 0.9934 -> 0.9931, AUC 0.9838 -> 0.9832, Brier 0.0543 -> 0.0551

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9934)
...
|---|---|---|---|
| key | `96b9ab2fb3ee43cf` | `815ed80ba3f32371` | `698250c20cae4c1b` |
| PR AUC | 0.9934 | 0.9930 | 0.9931 |
| ROC AUC | 0.9838 | 0.9829 | 0.9832 |
| F1 | 0.9526 | 0.9383 | 0.9402 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-96b9ab2fb3ee43cf
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-96b9ab2fb3ee43cf/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-96b9ab2fb3ee43cf
```
