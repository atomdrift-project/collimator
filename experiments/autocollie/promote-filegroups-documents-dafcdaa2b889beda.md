# Promote PASS — `dafcdaa2b889beda` on `filegroups/documents`

Generated 2026-06-16T09:00:07Z

full-train holds — PR_AUC 0.9999 -> 1.0000, AUC 0.9989 -> 0.9992, Brier 0.0092 -> 0.0083
...
|---|---|---|---|
| key | `dafcdaa2b889beda` | `54ae88ce204ffb76` | `0de56701f3b62f5e` |
| PR AUC | 0.9999 | 1.0000 | 1.0000 |
| ROC AUC | 0.9989 | 0.9992 | 0.9992 |
| F1 | 0.9957 | 0.9977 | 0.9978 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-documents-dafcdaa2b889beda
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-documents-dafcdaa2b889beda/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-documents-dafcdaa2b889beda
```
