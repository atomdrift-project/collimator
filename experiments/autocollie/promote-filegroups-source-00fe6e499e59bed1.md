# Promote PASS — `00fe6e499e59bed1` on `filegroups/source`

Generated 2026-07-13T03:24:41Z

full-train holds — PR_AUC 0.9931 -> 0.9950, AUC 0.9953 -> 0.9966, Brier 0.0176 -> 0.0149
...
|---|---|---|---|
| key | `00fe6e499e59bed1` | `481d4debf05d5d20` | `f6abebf963befc38` |
| PR AUC | 0.9931 | 0.9950 | 0.9950 |
| ROC AUC | 0.9953 | 0.9965 | 0.9966 |
| F1 | 0.9631 | 0.9720 | 0.9740 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-source-00fe6e499e59bed1
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-source-00fe6e499e59bed1/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-source-00fe6e499e59bed1
```
