# Promote PASS — `2e2040e9ed3e0932` on `filetypes/powershell`

Generated 2026-07-05T17:00:46Z

full-train holds — PR_AUC 0.9902 -> 0.9904, AUC 0.9837 -> 0.9841, Brier 0.0504 -> 0.0492
...
|---|---|---|---|
| key | `2e2040e9ed3e0932` | `3efc865c683e1e07` | `465889035ce9bc12` |
| PR AUC | 0.9902 | 0.9905 | 0.9904 |
| ROC AUC | 0.9837 | 0.9841 | 0.9841 |
| F1 | 0.9545 | 0.9373 | 0.9356 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-2e2040e9ed3e0932
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-2e2040e9ed3e0932/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-powershell-2e2040e9ed3e0932
```
