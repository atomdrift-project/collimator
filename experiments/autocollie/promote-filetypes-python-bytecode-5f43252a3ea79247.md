# Promote PASS — `5f43252a3ea79247` on `filetypes/python-bytecode`

Generated 2026-06-28T05:04:50Z

full-train holds — PR_AUC 0.9961 -> 0.9966, AUC 0.9977 -> 0.9987, Brier 0.0091 -> 0.0127
...
|---|---|---|---|
| key | `5f43252a3ea79247` | `e79bed7631f86927` | `8d307a183b6f6f63` |
| PR AUC | 0.9961 | 0.9963 | 0.9966 |
| ROC AUC | 0.9977 | 0.9986 | 0.9987 |
| F1 | 0.9839 | 0.9739 | 0.9726 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-bytecode-5f43252a3ea79247
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-bytecode-5f43252a3ea79247/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-bytecode-5f43252a3ea79247
```
