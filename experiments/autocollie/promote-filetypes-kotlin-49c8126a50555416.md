# Promote PASS — `49c8126a50555416` on `filetypes/kotlin`

Generated 2026-08-25T19:43:59Z

full-train holds — PR_AUC 0.9778 -> 0.9765, AUC 0.9849 -> 0.9842, Brier 0.0398 -> 0.0400

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9778)
...
|---|---|---|---|
| key | `49c8126a50555416` | `485b3d2877962745` | `3e5f794b751f9f00` |
| PR AUC | 0.9778 | 0.9762 | 0.9765 |
| ROC AUC | 0.9849 | 0.9839 | 0.9842 |
| F1 | 0.9092 | 0.9113 | 0.9134 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-49c8126a50555416
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-49c8126a50555416/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-49c8126a50555416
```
