# Confirm FAIL — 0fae7138a5f67d6a on `filetypes/vbs`

Cycle `20260615T015129-confirm-0fae7138a5f67d6a` — 2026-06-15T01:51:29Z
...
COLLIMATOR_EXPERIMENT_TAG=_vbs_seed_search_tiered_trigrams_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea vbs_seed_search_tiered_trigrams_confirm_seedsearch_3 --route filetypes/vbs  \
	...
	--learning-rate 0.025 --early-stopping-rounds 25 \
	--num-leaves 112 \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_vbs_seed_search_tiered_trigrams_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1851: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-15T01-51-29_20260615T015129-confirm-0fae7138a5f67d6a_vbs_seed_search_tiered_trigrams_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `0fae7138a5f67d6a` | `` |
| PR AUC | 0.9953 | 0.0000 |
| ROC AUC | 0.9836 | 0.0000 |
| Recall@3FPM | — | 0.0000 |
| verdict | — | FAIL |
