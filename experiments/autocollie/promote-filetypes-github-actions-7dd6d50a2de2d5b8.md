# Promote PASS — `7dd6d50a2de2d5b8` on `filetypes/github-actions`

Generated 2026-05-25T21:39:13Z

full-train holds — PR_AUC 0.0037 -> 0.0043, AUC 0.5000 -> 0.5000, Brier 0.0037 -> 0.0043

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.0037)
...
|---|---|---|---|
| key | `7dd6d50a2de2d5b8` | `3c9fb2016f5140f3` | `a2afca57413bbf71` |
| PR AUC | 0.0037 | 0.0043 | 0.0043 |
| ROC AUC | 0.5000 | 0.5000 | 0.5000 |
| F1 | 0.0074 | 0.0086 | 0.0086 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-github-actions-7dd6d50a2de2d5b8
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-github-actions-7dd6d50a2de2d5b8/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-github-actions-7dd6d50a2de2d5b8
```
