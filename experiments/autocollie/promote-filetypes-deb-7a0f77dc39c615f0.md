# Promote PASS — `7a0f77dc39c615f0` on `filetypes/deb`

Generated 2026-05-25T20:13:42Z
...
|---|---|---|---|
| key | `7a0f77dc39c615f0` | `43fb7f557dc31f57` | `f5cd92cb2eda0ebc` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-deb-7a0f77dc39c615f0
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-deb-7a0f77dc39c615f0/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-deb-7a0f77dc39c615f0
```
