# Promote PASS — `c3024981770ef433` on `filetypes/elf`

Generated 2026-05-26T16:50:32Z
...
|---|---|---|---|
| key | `c3024981770ef433` | `7c1f59d99860a6c3` | `4469a512960fe59f` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 1.0000 | 1.0000 | 1.0000 |
| F1 | 0.9840 | 0.9868 | 0.9874 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-elf-c3024981770ef433
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-elf-c3024981770ef433/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-elf-c3024981770ef433
```
