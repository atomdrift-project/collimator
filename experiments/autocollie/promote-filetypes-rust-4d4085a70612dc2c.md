# Promote PASS — `4d4085a70612dc2c` on `filetypes/rust`

Generated 2026-05-27T05:14:31Z

full-train holds — PR_AUC 0.8786 -> 0.8900, AUC 0.9826 -> 0.9874, Brier 0.0375 -> 0.0281

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.8786)
...
|---|---|---|---|
| key | `4d4085a70612dc2c` | `77ec220eb9848404` | `2e64b100977134aa` |
| PR AUC | 0.8786 | 0.8900 | 0.8900 |
| ROC AUC | 0.9826 | 0.9874 | 0.9874 |
| F1 | 0.7200 | 0.8125 | 0.8125 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-rust-4d4085a70612dc2c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-rust-4d4085a70612dc2c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-rust-4d4085a70612dc2c
```
