# Promote PASS — `2a519bbf2266f883` on `filetypes/java_class`

Generated 2026-05-26T19:20:36Z

full-train holds — PR_AUC 1.0000 -> 0.9961, AUC 1.0000 -> 0.9990, Brier 0.0026 -> 0.0090
...
|---|---|---|---|
| key | `2a519bbf2266f883` | `9cd351918bb1eb5e` | `f1536a2e1413065a` |
| PR AUC | 1.0000 | 0.9960 | 0.9961 |
| ROC AUC | 1.0000 | 0.9990 | 0.9990 |
| F1 | 0.9924 | 0.9770 | 0.9770 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-2a519bbf2266f883
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-2a519bbf2266f883/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-2a519bbf2266f883
```
