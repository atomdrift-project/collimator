# Promote PASS — `c1217b9525fd1b93` on `filetypes/go`

Generated 2026-05-25T18:57:56Z

full-train holds — PR_AUC 0.9666 -> 0.9674, AUC 0.9886 -> 0.9894, Brier 0.0393 -> 0.0357
...
|---|---|---|---|
| key | `c1217b9525fd1b93` | `5985403ab81f29bf` | `90fcb129bbfcb56f` |
| PR AUC | 0.9666 | 0.9681 | 0.9674 |
| ROC AUC | 0.9886 | 0.9895 | 0.9894 |
| F1 | 0.9036 | 0.8997 | 0.9096 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-c1217b9525fd1b93
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-c1217b9525fd1b93/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-c1217b9525fd1b93
```
