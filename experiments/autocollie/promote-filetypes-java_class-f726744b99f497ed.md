# Promote PASS — `f726744b99f497ed` on `filetypes/java_class`

Generated 2026-05-21T04:47:54Z
...
|---|---|---|---|
| key | `f726744b99f497ed` | `0668b877a066d8a8` | `4ac8c949ff3ee82b` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-f726744b99f497ed
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-f726744b99f497ed/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-f726744b99f497ed
```
