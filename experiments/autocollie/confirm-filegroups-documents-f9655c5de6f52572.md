# Confirm FAIL — f9655c5de6f52572 on `filegroups/documents`

Cycle `20260605T091400-confirm-f9655c5de6f52572` — 2026-06-05T09:14:00Z
...
COLLIMATOR_EXPERIMENT_TAG=_docs_kv_vocab_split_expansion_confirm_seedsearch_3 \
.venv/bin/python -u -m collimator experiment --db postgres://hopper@localhost:5432/hopper --output out/experiments/azoth --model-name azoth --learner azoth --workers 128 --seed 43 \
	--experiment-idea docs_kv_vocab_split_expansion_confirm_seedsearch_3 --route filegroups/documents  \
	...
	2>&1 | tee "out/experiments/azoth/logs/$(date +%Y-%m-%dT%H-%M-%S)-experiment_docs_kv_vocab_split_expansion_confirm_seedsearch_3.log"
make[2]: *** [Makefile:1791: experiment] Terminated
--- end log tail ---
full log: /home/t/collimator/out/autocollie/runs/2026-06-05T09-14-00_20260605T091400-confirm-f9655c5de6f52572_docs_kv_vocab_split_expansion_confirm_seedsearch_3.log

## Per-seed results (1 ran)

| | original | seed=43 | 
|---|---|---|
| key | `f9655c5de6f52572` | `` |
