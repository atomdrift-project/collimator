# Promote PASS — `d927d17cc3b11904` on `filetypes/macho`

Generated 2026-07-03T00:57:40Z

full-train holds — PR_AUC 0.9951 -> 0.9941, AUC 0.9989 -> 0.9989, Brier 0.0080 -> 0.0091

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9951)
...
|---|---|---|---|
| key | `d927d17cc3b11904` | `a693643b31e0fdf1` | `e2c18f52f0d487af` |
| PR AUC | 0.9951 | 0.9943 | 0.9941 |
| ROC AUC | 0.9989 | 0.9989 | 0.9989 |
| F1 | 0.9698 | 0.9719 | 0.9705 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-macho-d927d17cc3b11904
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-macho-d927d17cc3b11904/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-macho-d927d17cc3b11904
```
