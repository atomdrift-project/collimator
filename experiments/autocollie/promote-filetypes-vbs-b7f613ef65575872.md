# Promote PASS — `b7f613ef65575872` on `filetypes/vbs`

Generated 2026-06-28T16:42:43Z

full-train holds — PR_AUC 0.9963 -> 0.9966, AUC 0.9864 -> 0.9877, Brier 0.0617 -> 0.0611
...
|---|---|---|---|
| key | `b7f613ef65575872` | `3c87f672707de363` | `2e20f1447cd15e61` |
| PR AUC | 0.9963 | 0.9967 | 0.9966 |
| ROC AUC | 0.9864 | 0.9882 | 0.9877 |
| F1 | 0.9566 | 0.9551 | 0.9621 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-b7f613ef65575872
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-b7f613ef65575872/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-vbs-b7f613ef65575872
```
