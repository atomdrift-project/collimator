# Promote PASS — `f89b093cadeff6dc` on `filetypes/lnk`

Generated 2026-07-06T08:35:43Z

full-train holds — PR_AUC 0.9974 -> 0.9981, AUC 0.9876 -> 0.9909, Brier 0.1086 -> 0.0992
...
|---|---|---|---|
| key | `f89b093cadeff6dc` | `2a8c8edbcf62a323` | `782bb1e70d48f4e8` |
| PR AUC | 0.9974 | 0.9982 | 0.9981 |
| ROC AUC | 0.9876 | 0.9915 | 0.9909 |
| F1 | 0.9844 | 0.9774 | 0.9790 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-f89b093cadeff6dc
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-f89b093cadeff6dc/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-lnk-f89b093cadeff6dc
```
