# Promote PASS — `b8f9638ffe8a8e1b` on `filetypes/pptx`

Generated 2026-05-27T08:23:04Z

full-train holds — PR_AUC 0.9231 -> 0.9231, AUC 0.5000 -> 0.5000, Brier 0.0769 -> 0.0769

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9231)
...
|---|---|---|---|
| key | `b8f9638ffe8a8e1b` | `1a6884ddb87523a8` | `6705894a5e2f4ef0` |
| PR AUC | 0.9231 | 0.9231 | 0.9231 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pptx-b8f9638ffe8a8e1b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pptx-b8f9638ffe8a8e1b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pptx-b8f9638ffe8a8e1b
```
