# Promote PASS — `ba5cfc94357ff921` on `filetypes/kotlin`

Generated 2026-07-06T05:16:06Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 0.9989 -> 0.9989, Brier 0.0094 -> 0.0093
...
|---|---|---|---|
| key | `ba5cfc94357ff921` | `03344a3b4c576655` | `f456a5b771809771` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 0.9989 | 0.9989 | 0.9989 |
| F1 | 0.9978 | 0.9982 | 0.9984 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-ba5cfc94357ff921
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-ba5cfc94357ff921/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-kotlin-ba5cfc94357ff921
```
