# Promote PASS — `3d27f2362f791915` on `filegroups/media`

Generated 2026-06-28T11:00:41Z

full-train holds — PR_AUC 0.9870 -> 0.9872, AUC 0.9858 -> 0.9862, Brier 0.0607 -> 0.0599

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9870)
...
|---|---|---|---|
| key | `3d27f2362f791915` | `f0980c102926b45f` | `c3ef584eec6d8d77` |
| PR AUC | 0.9870 | 0.9864 | 0.9872 |
| ROC AUC | 0.9858 | 0.9850 | 0.9862 |
| F1 | 0.9315 | 0.9610 | 0.9652 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-media-3d27f2362f791915
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-media-3d27f2362f791915/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-media-3d27f2362f791915
```
