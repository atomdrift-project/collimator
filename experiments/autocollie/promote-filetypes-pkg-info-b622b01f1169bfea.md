# Promote PASS — `b622b01f1169bfea` on `filetypes/pkg-info`

Generated 2026-05-25T20:08:49Z
...
|---|---|---|---|
| key | `b622b01f1169bfea` | `838ee6a94ae43a9e` | `a340a26b97255357` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pkg-info-b622b01f1169bfea
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pkg-info-b622b01f1169bfea/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pkg-info-b622b01f1169bfea
```
