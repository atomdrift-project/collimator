# Promote PASS — `2649ea38c97bec6b` on `filegroups/documents`

Generated 2026-06-13T18:29:19Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 0.9997 -> 0.9992, Brier 0.0045 -> 0.0066
...
|---|---|---|---|
| key | `2649ea38c97bec6b` | `acc256d4c95fc087` | `630772687ac8f25a` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 0.9997 | 0.9991 | 0.9992 |
| F1 | 0.9977 | 0.9973 | 0.9973 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-documents-2649ea38c97bec6b
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-documents-2649ea38c97bec6b/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-documents-2649ea38c97bec6b
```
