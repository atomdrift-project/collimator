# Promote PASS — `f8cbfb3bb6b5a1ac` on `filetypes/perl`

Generated 2026-05-08T19:51:27Z

full-train holds — F1 0.9714 -> 0.9714, AUC 1.0000 -> 1.0000, recall@FP=0 0.0000 -> 0.0000

## Gates

- **Confirm** (different seed, original profile): **PASS** — F1 held across 3 seeds (orig 0.9714)
...
|---|---|---|---|
| key | `f8cbfb3bb6b5a1ac` | `02d18db91a7ecd88` | `7b4b435e1eabac7d` |
| F1 | 0.9714 | 1.0000 | 0.9714 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-perl-f8cbfb3bb6b5a1ac
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-perl-f8cbfb3bb6b5a1ac/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the validated bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-perl-f8cbfb3bb6b5a1ac
```
