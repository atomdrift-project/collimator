# Promote PASS — `88bd6ca1bafd0168` on `filetypes/python`

Generated 2026-07-06T06:45:22Z

full-train holds — PR_AUC 0.9758 -> 0.9804, AUC 0.9882 -> 0.9906, Brier 0.0311 -> 0.0273

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9758)
...
|---|---|---|---|
| key | `88bd6ca1bafd0168` | `333db9097d6103a5` | `8fc9a30c19510176` |
| PR AUC | 0.9758 | 0.9806 | 0.9804 |
| ROC AUC | 0.9882 | 0.9906 | 0.9906 |
| F1 | 0.9158 | 0.9322 | 0.9337 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-88bd6ca1bafd0168
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-88bd6ca1bafd0168/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-88bd6ca1bafd0168
```
