# Promote PASS — `3001dbf55d0017af` on `filetypes/java_class`

Generated 2026-07-15T07:35:57Z

full-train holds — PR_AUC 0.9884 -> 0.9895, AUC 0.9979 -> 0.9984, Brier 0.0109 -> 0.0101
...
|---|---|---|---|
| key | `3001dbf55d0017af` | `0351ce56f97ce362` | `fc06883b62d0f587` |
| PR AUC | 0.9884 | 0.9894 | 0.9895 |
| ROC AUC | 0.9979 | 0.9984 | 0.9984 |
| F1 | 0.9506 | 0.9425 | 0.9506 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-3001dbf55d0017af
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-3001dbf55d0017af/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-java_class-3001dbf55d0017af
```
