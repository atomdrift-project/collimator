# Promote PASS — `a0fca704de2f4c30` on `filetypes/c`

Generated 2026-06-01T15:07:41Z

full-train holds — PR_AUC 0.9915 -> 0.9895, AUC 0.9955 -> 0.9950, Brier 0.0241 -> 0.0247
...
|---|---|---|---|
| key | `a0fca704de2f4c30` | `739a14fe4458383a` | `cde99e561a546d20` |
| PR AUC | 0.9915 | 0.9889 | 0.9895 |
| ROC AUC | 0.9955 | 0.9947 | 0.9950 |
| F1 | 0.9501 | 0.9408 | 0.9437 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-a0fca704de2f4c30
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-a0fca704de2f4c30/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-a0fca704de2f4c30
```
