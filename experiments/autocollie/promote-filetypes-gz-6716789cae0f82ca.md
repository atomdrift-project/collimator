# Promote PASS — `6716789cae0f82ca` on `filetypes/gz`

Generated 2026-06-13T19:37:15Z

full-train holds — PR_AUC 0.7190 -> 0.7303, AUC 0.8396 -> 0.8963, Brier 0.0198 -> 0.0184

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.7190)
...
|---|---|---|---|
| key | `6716789cae0f82ca` | `6076212ead45d04f` | `34637ce702ee3ec9` |
| PR AUC | 0.7190 | 0.7327 | 0.7303 |
| ROC AUC | 0.8396 | 0.9085 | 0.8963 |
| F1 | 0.7952 | 0.7763 | 0.7776 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-gz-6716789cae0f82ca
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-gz-6716789cae0f82ca/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-gz-6716789cae0f82ca
```
