# Promote PASS — `12498240e9c38470` on `filetypes/zip`

Generated 2026-07-23T11:42:39Z

full-train holds — PR_AUC 0.9987 -> 0.9990, AUC 0.9942 -> 0.9955, Brier 0.0355 -> 0.0232
...
|---|---|---|---|
| key | `12498240e9c38470` | `ea75f9d0b0443c19` | `71395adc3e09f850` |
| PR AUC | 0.9987 | 0.9990 | 0.9990 |
| ROC AUC | 0.9942 | 0.9956 | 0.9955 |
| F1 | 0.9740 | 0.9864 | 0.9871 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-zip-12498240e9c38470
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-zip-12498240e9c38470/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-zip-12498240e9c38470
```
