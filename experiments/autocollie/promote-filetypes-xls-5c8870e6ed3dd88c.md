# Promote PASS — `5c8870e6ed3dd88c` on `filetypes/xls`

Generated 2026-06-09T00:44:20Z

full-train holds — PR_AUC 0.9998 -> 0.9998, AUC 0.9980 -> 0.9983, Brier 0.0126 -> 0.0125
...
|---|---|---|---|
| key | `5c8870e6ed3dd88c` | `a361b0d6820a426c` | `44e19135d664d20c` |
| PR AUC | 0.9998 | 0.9998 | 0.9998 |
| ROC AUC | 0.9980 | 0.9983 | 0.9983 |
| F1 | 0.9926 | 0.9950 | 0.9948 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xls-5c8870e6ed3dd88c
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xls-5c8870e6ed3dd88c/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xls-5c8870e6ed3dd88c
```
