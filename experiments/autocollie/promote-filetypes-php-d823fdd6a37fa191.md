# Promote PASS — `d823fdd6a37fa191` on `filetypes/php`

Generated 2026-06-14T02:44:58Z

full-train holds — PR_AUC 0.9921 -> 0.9951, AUC 0.9959 -> 0.9976, Brier 0.0120 -> 0.0107
...
|---|---|---|---|
| key | `d823fdd6a37fa191` | `3f3921bbab4026d6` | `3ab63cfd3e1e1c48` |
| PR AUC | 0.9921 | 0.9951 | 0.9951 |
| ROC AUC | 0.9959 | 0.9976 | 0.9976 |
| F1 | 0.9665 | 0.9720 | 0.9754 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-php-d823fdd6a37fa191
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-php-d823fdd6a37fa191/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-php-d823fdd6a37fa191
```
