# Promote PASS — `616baf33eb6111ea` on `filegroups/portable`

Generated 2026-06-09T00:26:58Z

full-train holds — PR_AUC 0.9885 -> 0.9907, AUC 0.9979 -> 0.9984, Brier 0.0112 -> 0.0106

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9885)
...
|---|---|---|---|
| key | `616baf33eb6111ea` | `e646a12ea3bb07dd` | `d8d037180b458fe5` |
| PR AUC | 0.9885 | 0.9906 | 0.9907 |
| ROC AUC | 0.9979 | 0.9983 | 0.9984 |
| F1 | 0.8977 | 0.9495 | 0.9541 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-portable-616baf33eb6111ea
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-portable-616baf33eb6111ea/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-portable-616baf33eb6111ea
```
