# Promote PASS — `5cae0220a5f33f5a` on `filegroups/config`

Generated 2026-07-06T05:50:24Z

full-train holds — PR_AUC 0.9972 -> 0.9974, AUC 0.9976 -> 0.9977, Brier 0.0074 -> 0.0070
...
|---|---|---|---|
| key | `5cae0220a5f33f5a` | `d9b7eaeb7b3c761f` | `706693cbc1046339` |
| PR AUC | 0.9972 | 0.9974 | 0.9974 |
| ROC AUC | 0.9976 | 0.9977 | 0.9977 |
| F1 | 0.9875 | 0.9898 | 0.9896 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-config-5cae0220a5f33f5a
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-config-5cae0220a5f33f5a/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-config-5cae0220a5f33f5a
```
