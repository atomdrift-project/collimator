# Promote PASS — `cd6fdd63d14dfec5` on `filetypes/ole`

Generated 2026-05-08T10:18:18Z

full-train holds — F1 0.9565 -> 0.9565, AUC 1.0000 -> 1.0000, recall@FP=0 0.0000 -> 0.0000

## Gates

- **Confirm** (different seed, original profile): **PASS** — F1 held across 3 seeds (orig 0.9565)
...
|---|---|---|---|
| key | `cd6fdd63d14dfec5` | `36aed436435a0da3` | `b4d7bce90e5c8386` |
| F1 | 0.9565 | 1.0000 | 0.9565 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-ole-cd6fdd63d14dfec5
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-ole-cd6fdd63d14dfec5/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the validated bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-ole-cd6fdd63d14dfec5
```
