# Promote REJECTED — `6d79099b0b4f72e4` on `filegroups/documents`

Generated 2026-05-26T22:20:24Z

azoth-validate failed: exit status 2 (log /home/t/collimator/out/autocollie/runs/2026-05-26T22-17-05_20260526T221638-promote-6d79099b0b4f72e4_azoth-validate.log; tail: 	--output-json /home/t/collimator/out/models/azoth-candidate-filegroups-documents-6d79099b0b4f72e4/route_policy_eval_oof.json
wrote /home/t/collimator/out/models/azoth-candidate-filegroups-documents-6d79099b0b4f72e4/route_policy_eval_oof.json
wrote /home/t/collimator/out/models/azoth-candidate-filegroups-documents-6d79099b0b4f72e4/route_policy_eval_oof.md
.venv/bin/python scripts/write_azoth_readmes.py --azoth-root /home/t/collimator/out/models/azoth-candidate-filegroups-documents-6d79099b0b4f72e4
staged runtime azoth bundle: /tmp/tmp.wgxBeVvgna
azoth bundle ok: /tmp/tmp.wgxBeVvgna
--source-bundle out/models/azoth: 1 routes changed → 9 filetypes impacted, 57 unimpacted (drift treated as pre-existing)

ensemble improvements (≥0.10pp):
  pdf: L3 hostile ensemble recall +13.70pp (7.50% → 21.20%)
...
per-route improvements (≥0.10pp, informational):
  ...
  pdf :: filegroups/documents recall@3FP/M +75.33pp (8.41% → 83.74%)
...
16 low-water-mark improvement(s) (>0.90pp above LWM, informational):
  ...
  + pdf: L3 hostile ensemble recall +14.79pp above LWM (6.41% → 21.20%)
...
1 LOW-WATER-MARK regression(s) (pinned reference: out/models/azoth_low_water_mark/route_policy_eval_oof.json):
  - doc: L3 hostile ENSEMBLE recall dropped 18.10pp BELOW LOW-WATER-MARK (90.99% → 72.88%; LWM tolerance 0.90pp)
...
|---|---|---|---|
| key | `6d79099b0b4f72e4` | `15c365716b800a1b` | `286ad4c37f8fce39` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 0.9990 | 0.9997 | 0.9997 |
| F1 | 0.9960 | 0.9978 | 0.9981 |
