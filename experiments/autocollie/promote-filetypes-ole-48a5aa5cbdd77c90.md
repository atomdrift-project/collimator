# Promote PASS — `48a5aa5cbdd77c90` on `filetypes/ole`

Generated 2026-06-09T08:13:13Z

full-train holds — PR_AUC 0.9947 -> 0.9952, AUC 0.9936 -> 0.9940, Brier 0.1002 -> 0.0989
...
|---|---|---|---|
| key | `48a5aa5cbdd77c90` | `8d1344dcd23b114f` | `7de99cd2e4dcacd2` |
| PR AUC | 0.9947 | 0.9946 | 0.9952 |
| ROC AUC | 0.9936 | 0.9933 | 0.9940 |
| F1 | 0.8967 | 0.9790 | 0.9795 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-ole-48a5aa5cbdd77c90
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-ole-48a5aa5cbdd77c90/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-ole-48a5aa5cbdd77c90
```
