# Promote PASS — `035678d0464eeef5` on `filetypes/pdf`

Generated 2026-05-25T19:46:55Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 1.0000 -> 0.9998, Brier 0.0039 -> 0.0034
...
|---|---|---|---|
| key | `035678d0464eeef5` | `243ef4e7f888dff1` | `08fd43faeb57edfe` |
| PR AUC | 1.0000 | 1.0000 | 1.0000 |
| ROC AUC | 1.0000 | 0.9997 | 0.9998 |
| F1 | 1.0000 | 0.9980 | 0.9985 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-035678d0464eeef5
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-035678d0464eeef5/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-035678d0464eeef5
```
