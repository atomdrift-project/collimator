# Promote PASS — `3afaf938ee754d75` on `filetypes/ole`

Generated 2026-08-25T21:46:19Z

full-train holds — PR_AUC 0.9997 -> 0.9997, AUC 0.9991 -> 0.9991, Brier 0.0118 -> 0.0086
...
|---|---|---|---|
| key | `3afaf938ee754d75` | `6e86a01c2569b817` | `e1ef7e4b20d1ddbb` |
| PR AUC | 0.9997 | 0.9997 | 0.9997 |
| ROC AUC | 0.9991 | 0.9991 | 0.9991 |
| F1 | 0.9905 | 0.9948 | 0.9949 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3afaf938ee754d75
```
...
EXP_DISABLE_FEATURE_GROUPS=clusters,kv,symbols
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3afaf938ee754d75/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-ole-3afaf938ee754d75
```
