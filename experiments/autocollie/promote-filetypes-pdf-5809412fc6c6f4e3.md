# Promote PASS — `5809412fc6c6f4e3` on `filetypes/pdf`

Generated 2026-07-21T08:02:44Z

full-train holds — PR_AUC 1.0000 -> 1.0000, AUC 0.9991 -> 0.9992, Brier 0.0088 -> 0.0084
...
|---|---|---|---|
| key | `5809412fc6c6f4e3` | `f82ebfbc3990abd4` | `ee41460cb4fbf63f` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-5809412fc6c6f4e3
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-5809412fc6c6f4e3/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-pdf-5809412fc6c6f4e3
```
