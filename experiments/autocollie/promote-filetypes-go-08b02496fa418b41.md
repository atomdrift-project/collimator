# Promote PASS — `08b02496fa418b41` on `filetypes/go`

Generated 2026-05-26T08:18:49Z

full-train holds — PR_AUC 0.9596 -> 0.9713, AUC 0.9869 -> 0.9906, Brier 0.0398 -> 0.0343

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9596)
...
|---|---|---|---|
| key | `08b02496fa418b41` | `048607c308ee38eb` | `be5e66ed4a91eace` |
| PR AUC | 0.9596 | 0.9730 | 0.9713 |
| ROC AUC | 0.9869 | 0.9911 | 0.9906 |
| F1 | 0.8889 | 0.9121 | 0.9071 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-go-08b02496fa418b41
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-go-08b02496fa418b41/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-go-08b02496fa418b41
```
