# Promote PASS — `34f05bed5ca9c322` on `filetypes/python`

Generated 2026-07-11T10:14:07Z

full-train holds — PR_AUC 0.9750 -> 0.9789, AUC 0.9883 -> 0.9900, Brier 0.0291 -> 0.0259

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9750)
...
|---|---|---|---|
| key | `34f05bed5ca9c322` | `6ba0202f84604188` | `7e844986364285cc` |
| PR AUC | 0.9750 | 0.9789 | 0.9789 |
| ROC AUC | 0.9883 | 0.9900 | 0.9900 |
| F1 | 0.9194 | 0.9264 | 0.9281 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-python-34f05bed5ca9c322
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-python-34f05bed5ca9c322/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-python-34f05bed5ca9c322
```
