# Promote PASS — `e7884ec9f83a209f` on `filetypes/xls`

Generated 2026-06-27T22:27:17Z

full-train holds — PR_AUC 0.9999 -> 1.0000, AUC 0.9989 -> 0.9991, Brier 0.0098 -> 0.0092
...
|---|---|---|---|
| key | `e7884ec9f83a209f` | `46efb97b2b8130d8` | `51f224465ab3d449` |
| PR AUC | 0.9999 | 1.0000 | 1.0000 |
| ROC AUC | 0.9989 | 0.9991 | 0.9991 |
| F1 | 0.9932 | 0.9971 | 0.9971 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xls-e7884ec9f83a209f
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xls-e7884ec9f83a209f/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xls-e7884ec9f83a209f
```
