# Promote PASS — `efdef5cc358a0cd7` on `filetypes/xls`

Generated 2026-05-26T18:02:30Z

full-train holds — PR_AUC 0.9999 -> 0.9999, AUC 0.9996 -> 0.9996, Brier 0.0061 -> 0.0067
...
|---|---|---|---|
| key | `efdef5cc358a0cd7` | `3c21ced56315c5fd` | `690d0c3195db8812` |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xls-efdef5cc358a0cd7
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xls-efdef5cc358a0cd7/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xls-efdef5cc358a0cd7
```
