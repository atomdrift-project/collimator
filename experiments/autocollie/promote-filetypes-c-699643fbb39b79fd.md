# Promote PASS — `699643fbb39b79fd` on `filetypes/c`

Generated 2026-05-26T04:11:01Z

full-train holds — PR_AUC 0.9918 -> 0.9930, AUC 0.9957 -> 0.9963, Brier 0.0232 -> 0.0217
...
|---|---|---|---|
| key | `699643fbb39b79fd` | `f648f66064d45745` | `2dc02d254acb6a82` |
| PR AUC | 0.9918 | 0.9929 | 0.9930 |
| ROC AUC | 0.9957 | 0.9963 | 0.9963 |
| F1 | 0.9483 | 0.9506 | 0.9527 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-c-699643fbb39b79fd
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-c-699643fbb39b79fd/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-c-699643fbb39b79fd
```
