# Promote PASS — `a00a88b19f61b1e2` on `filetypes/groovy`

Generated 2026-05-27T05:46:48Z

full-train holds — PR_AUC 0.0017 -> 0.9407, AUC 0.5000 -> 0.9672, Brier 0.0017 -> 0.0034

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.0017)
...
|---|---|---|---|
| key | `a00a88b19f61b1e2` | `dbfae746ba06f124` | `432a48b0d34fcd73` |
| PR AUC | 0.0017 | 0.9377 | 0.9407 |
| ROC AUC | 0.5000 | 0.9642 | 0.9672 |
| F1 | 0.0034 | 0.9189 | 0.9444 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-groovy-a00a88b19f61b1e2
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-groovy-a00a88b19f61b1e2/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-groovy-a00a88b19f61b1e2
```
