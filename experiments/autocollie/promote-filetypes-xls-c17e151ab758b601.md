# Promote PASS — `c17e151ab758b601` on `filetypes/xls`

Generated 2026-06-16T05:23:56Z

full-train holds — PR_AUC 0.9998 -> 0.9998, AUC 0.9979 -> 0.9983, Brier 0.0128 -> 0.0118
...
|---|---|---|---|
| key | `c17e151ab758b601` | `d9318ff027bd3599` | `a00cc90efd291a1e` |
| PR AUC | 0.9998 | 0.9998 | 0.9998 |
| ROC AUC | 0.9979 | 0.9981 | 0.9983 |
| F1 | 0.9886 | 0.9947 | 0.9951 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xls-c17e151ab758b601
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xls-c17e151ab758b601/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xls-c17e151ab758b601
```
