# Promote PASS — `cbe9c6a264122fd6` on `filegroups/documents`

Generated 2026-08-25T01:54:40Z

full-train holds — PR_AUC 0.9825 -> 0.9966, AUC 0.9795 -> 0.9914, Brier 0.1147 -> 0.1563

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9825)
...
|---|---|---|---|
| key | `cbe9c6a264122fd6` | `b8256851b9fcd660` | `5f592baab0752463` |
| PR AUC | 0.9825 | 0.9965 | 0.9966 |
| ROC AUC | 0.9795 | 0.9905 | 0.9914 |
| F1 | 0.8548 | 0.9788 | 0.9777 |
...
```
/home/t/collimator/out/models/azoth-candidate-filegroups-documents-cbe9c6a264122fd6
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filegroups-documents-cbe9c6a264122fd6/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filegroups-documents-cbe9c6a264122fd6
```
