# Promote PASS — `05d1d634e1160aab` on `filetypes/xls`

Generated 2026-07-05T17:25:20Z

full-train holds — PR_AUC 0.9969 -> 0.9975, AUC 0.9910 -> 0.9920, Brier 0.0440 -> 0.0463
...
|---|---|---|---|
| key | `05d1d634e1160aab` | `2150cec0e3f74b61` | `af530e0ee46b7120` |
| PR AUC | 0.9969 | 0.9974 | 0.9975 |
| ROC AUC | 0.9910 | 0.9915 | 0.9920 |
| F1 | 0.9676 | 0.9661 | 0.9674 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-xls-05d1d634e1160aab
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-xls-05d1d634e1160aab/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-xls-05d1d634e1160aab
```
