# Promote PASS — `fea322ad74d5a3ef` on `filetypes/jar`

Generated 2026-06-13T02:40:10Z

full-train holds — PR_AUC 0.9896 -> 0.9922, AUC 0.9771 -> 0.9832, Brier 0.0782 -> 0.0701

## Gates

- **Confirm** (different seed, original profile): **PASS** — PR_AUC held across 3 seeds (orig 0.9896)
...
|---|---|---|---|
| key | `fea322ad74d5a3ef` | `e3945b9c03bb9218` | `f38b2efa69c5afd5` |
| PR AUC | 0.9896 | 0.9923 | 0.9922 |
| ROC AUC | 0.9771 | 0.9835 | 0.9832 |
| F1 | 0.9407 | 0.9457 | 0.9506 |
...
```
/home/t/collimator/out/models/azoth-candidate-filetypes-jar-fea322ad74d5a3ef
```
...
Read `/home/t/collimator/out/models/azoth-candidate-filetypes-jar-fea322ad74d5a3ef/global_policy_metrics.md` and `route_policies.md` first. If you're convinced, ship the candidate bundle:

```
make azoth-deploy AZOTH_ROOT=/home/t/collimator/out/models/azoth-candidate-filetypes-jar-fea322ad74d5a3ef
```
